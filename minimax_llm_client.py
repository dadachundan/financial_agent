            ...
            if role == "system" and response_model is not None:
                ...
                if response_model.__name__ == "ExtractedEntities":
                    ...
                    extra += (
                        ...
                        "\nNEVER EXTRACT HUMAN PERSON NAMES. EVER."
                        "\n════════════════════════════════════════"
                        "\nBefore adding any entity, ask yourself:"
                        "\n  'Is this a real human person — CEO, CFO, analyst, author, lawyer, investor?'"
                        "\nIf YES → DISCARD IT. Do not include it. Not even once."
                        "\nExamples of names you must NEVER extract:"
                        "\n  Jensen Huang, Tim Cook, Satya Nadella, Colette Kress, Colette M. Kress,"
                        "\n  Simona Jankowski, Lisa Su, Pat Gelsinger, Lachlan Shaw, Fintan Collins,"
                        "\n  Daniel Fleming, Ralph Liebert, Severin Hacker, Wei Zhang, Li Ming,"
                        "\n  John Smith, James Anderson, Robert Williams — ANY first-name + last-name."
                        "\nThis rule has NO exceptions. Even if a person is the CEO or is quoted"
                        "\ndirectly — extract the COMPANY they represent, not their name."
                        "\n════════════════════════════════════════"
                        ...
                        "\n- *** HUMAN PERSON NAMES *** (see ABSOLUTE RULE #1 above)"
                        ...
                        "\n- Transaction or deal names: 'OxyChem Transaction', 'Merger Agreement',"
                        "\n  'Purchase Agreement', 'Acquisition Agreement', '[X] Transaction'."
                        "\n  These name a deal, not a company — skip them entirely."
                        "\n- Intergovernmental or trade-body organisations: OPEC, WTO, IMF, World Bank,"
                        "\n  NATO, IAEA, G7, G20. These are not companies subject to financial analysis."
                        ...
                        "\n\nPATTERN ALERT — person names in these document patterns must NEVER be extracted:"
                        "\n  'said [Name], [Title]'  →  [Name] is a person, skip"
                        "\n  'commentary by [Name]'  →  [Name] is a person, skip"
                        "\n  '[Name], CEO/CFO/EVP/President/Vice President'  →  [Name] is a person, skip"
                        "\n  '[Name] said' / '[Name] noted' / '[Name] stated'  →  [Name] is a person, skip"
                        "\n  'authored by [Name]' / 'prepared by [Name]'  →  [Name] is a person, skip"
                        "\n\nFINAL CHECK (mandatory before responding):"
                        "\nScan your entity list one last time. Remove any entry that:"
                        "\n  (a) looks like FirstName LastName or First MI Last,"
                        "\n  (b) is a person's title (CEO, CFO, President, analyst, author),"
                        "\n  (c) appears after 'said', 'by', 'noted', 'stated', or before a job title."
                        "\nRemember: Colette Kress, Jensen Huang, Lisa Su, Tim Cook, Simona Jankowski"
