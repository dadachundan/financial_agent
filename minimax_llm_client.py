            ...
            if role == "system" and response_model is not None:
                ...
                if response_model.__name__ == "ExtractedEntities":
                    extra += (
                        ...
                        "\n- Human personal names of any kind (executives, analysts, CEOs, lawyers,"
                        "  authors, investors, plaintiffs, defendants)"
                        "\n  Examples: Jensen Huang, Tim Cook, Timothy S. Teter, Debora Shoquist"
                        "\n- Legal cases and litigation: any case name containing 'v.', 'In re',"
                        "  'Consolidated', 'Derivative Litigation', 'Class Action', lawsuit names"
                        "\n  Examples: In re NVIDIA Corporation Consolidated Derivative Litigation,"
                        "  Lipchitz v. Huang et al."
                        "\n- SEC rules and rule numbers: SEC Rule, Rule 10b-5, Rule 144, Regulation S-K,"
                        "  any numbered rule or regulation"
