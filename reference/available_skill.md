...
| [theme-research](../.claude/skills/theme-research/SKILL.md) | Tracked thematic baskets — registry.yaml + research note per theme under `reports/themes/<slug>/`; create / refresh / mutate / list modes; drift detection on theme-membership stability. **English default; Chinese opt-in** |
