...
timeline
    title 智平方科技 — 关键里程碑
    2023 Apr : 由郭彦东在深圳创立
    2023 H2  : 完成种子轮与天使轮融资；从OPPO / 小鹏 / 微软 / 谷歌等公司招募团队
    2024     : 第一代AlphaBot 1单臂移动操作机器人完成原型并向工业客户展示
    2025 H1  : 完成七轮融资（种子延伸轮 / Pre-A / Pre-A+）
    2025 03  : Pre-A+轮以"数亿"人民币完成；据报道创始人郭彦东保留69%控股权
    2025 04  : AlphaBot 2发布 — 34自由度双臂人形；宣布2028年万台部署目标
    2025 09  : 自建产线投产，铭牌年产能1,000台
    2025 H2  : 再完成五轮融资；惠科（HKC）1,000台、约人民币5亿元三年合同公布
    2026 02  : B轮完成，融资超人民币10亿元，投后估值超人民币100亿元 — 百度、中车、宇信、森麒麟、国泰海通参投
```
...
```mermaid
graph TD
    AI2[智平方科技] --> Brain[Alpha Brain / GOVLA 基础模型]
    AI2 --> Bodies[机器人硬件平台]
    AI2 --> Services[部署与服务]
    Brain --> GOVLA[GOVLA：全域全身VLA模型]
    Brain --> FastSlow["快+慢双系统架构<br/>（实时运动+深度推理）"]
    Bodies --> AB1[AlphaBot 1<br/>单臂轮式移动操作机器人]
    Bodies --> AB2[AlphaBot 2<br/>34自由度双臂人形平台]
    Bodies --> ZMF[智魔方 / Smart Cube<br/>模块化服务站演示]
    Services --> SI[现场系统集成]
    Services --> FT[客户数据微调]
    Services --> SLA[运行时间与维护SLA]
```
...
```mermaid
pie title 智平方科技 — 已披露客户收入集中度（定性，2025）
    "惠科 (HKC) — 3年约人民币5亿合同" : 60
    "奔驰及汽车OEM试点" : 15
    "晶能微电子" : 10
    "生物科技 / 实验室自动化试点" : 8
    "其他 / 智魔方 / 公共服务" : 7
...
```mermaid
quadrantChart
    title 中国与全球具身智能同业（定性定位，2026年5月）
    x-axis "硬件优先" --> "基础模型优先"
    y-axis "较低估值 / 较小轮次" --> "较高估值 / 较大轮次"
    quadrant-1 "大脑驱动 / 资金充裕"
    quadrant-2 "硬件驱动 / 资金充裕"
    quadrant-3 "硬件驱动 / 早期阶段"
    quadrant-4 "大脑驱动 / 早期阶段"
