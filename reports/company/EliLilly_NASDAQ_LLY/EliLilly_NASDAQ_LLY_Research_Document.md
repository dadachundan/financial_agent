...
![Revenue, Net Income and R&D, FY2022–FY2025](../../charts/lly_revenue_margin.png)
...
```mermaid
timeline
title Eli Lilly — Founding to 2026 (selected milestones)
1876 : Founded by Colonel Eli Lilly in Indianapolis
1901 : Incorporated in Indiana
1923 : Iletin — first commercial insulin (w/ U. Toronto)
1982 : Humulin — first recombinant DNA human insulin
1987 : Prozac launched (first major SSRI)
1996 : Humalog — first analog insulin
2014 : Trulicity (dulaglutide GLP-1) launched
2022 : Mounjaro (tirzepatide) approved for T2D in U.S.
2023 : Zepbound (tirzepatide) approved for obesity in U.S.
2024 : Kisunla (donanemab) approved for early Alzheimer's
2025 : Inluriyo (imlunestrant) approved Q4; Revenue reaches $65.2B
2026 : 150th anniversary; orforglipron / efsitora alfa submissions; FY26 guide $80–83B
```
...
![FY2025 Revenue Mix by Product](../../charts/lly_product_mix.png)
...
```mermaid
graph TD
A[Incretin platform 1990s] --> B[Trulicity 2014 - GLP-1 weekly]
B --> C[Mounjaro / Zepbound 2022-23 - dual GIP/GLP-1]
C --> D1[Orforglipron - oral GLP-1, sub 2026]
C --> D2[Retatrutide - triple agonist Ph3]
C --> D3[Eloralintide - amylin Ph3]
D1 --> E[Eight Ph3 orforglipron indications]
D2 --> E
D3 --> E
E[Multi-mechanism obesity / metabolic franchise 2026-2030]
```
...
```mermaid
quadrantChart
    title GLP-1 / Obesity Competitive Map (2026)
    x-axis Lower Efficacy --> Higher Efficacy
    y-axis Narrow Pipeline --> Broad Pipeline
    quadrant-1 Multi-asset leaders
    quadrant-2 Pipeline-rich, mid-tier
    quadrant-3 Niche / declining
    quadrant-4 Single-asset leaders
    Lilly tirzepatide+pipeline: [0.92, 0.95]
    Novo semaglutide+CagriSema: [0.75, 0.78]
    Roche oral GLP-1: [0.45, 0.42]
    Pfizer (post-danuglipron): [0.25, 0.18]
