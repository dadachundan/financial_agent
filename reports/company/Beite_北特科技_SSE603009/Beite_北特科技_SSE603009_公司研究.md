...
```mermaid
xychart-beta
    title "北特科技营收 & 归母净利润 2023-2025 (RMB 亿)"
    x-axis ["FY2023", "FY2024", "FY2025"]
    y-axis "金额 (RMB 亿)" 0 --> 25
    bar [18.81, 20.24, 23.23]
    line [0.51, 0.71, 1.20]
```
...
```mermaid
timeline
    title 北特科技关键里程碑 (2002–2026)
    2002 : 上海北特金属制品有限公司成立 (靳坤创建)
         : 主营转向器齿条 + 减振器活塞杆
    2014 : SSE 主板 IPO (2014-07-18)
         : 发行价 RMB 7.01 / 募集 2,667 万股
    2018 : 收购上海光裕 (现上海北特光裕)
         : 进入空调压缩机赛道
    2020 : 启动新能源电动压缩机量产
         : 27/34/46/50/80CC 系列
    2023 : 主导起草《乘用车转向器齿条》行业标准 QC/T 1191-2023
    2024 : 设立上海 / 江苏机器人科技子公司
         : 启动行星滚柱丝杠 (PRS) 业务
         : 2024-10-14 公告昆山 RMB 18.5 亿 PRS 基地
    2025 : 设立新加坡投资公司 + 北特科技(泰国)
         : 泰国一期建设启动
         : 完成 RMB 2.99 亿简易程序定增
         : 昆山主体厂房 2025-11-24 封顶
    2026 : 昆山 PRS 基地预计正式投产
         : 设计产能 260 万套/年
```
...
```mermaid
graph TD
    BeiteTech[北特科技 三大业务板块]
    BeiteTech --> Chassis[底盘零部件业务<br/>FY2025 营收 RMB 14.34 亿 / 毛利率 23.41%]
    BeiteTech --> Aluminum[铝合金轻量化业务<br/>FY2025 营收 RMB 1.95 亿 / 毛利率 19.22%]
    BeiteTech --> HVAC[空调压缩机业务<br/>FY2025 营收 RMB 6.62 亿 / 毛利率 11.62%]

    Chassis --> Steering[转向器类<br/>齿条 / 齿轮 / 扭力杆 / 蜗杆 / 输入输出轴 / IPA 总成]
    Chassis --> Damper[减振器类<br/>活塞杆 / CDC-evo 控制阀壳体 / CDC-ivo 控制阀零部件]
    Chassis --> Brake[高精密类<br/>IPB Flange / IPB Piston / 柴油喷油器体 / 柴油泵体]
    Chassis --> Diff[差速器类<br/>输出轴]

    Aluminum --> AlForge[铝合金锻造件<br/>集成阀岛 / Yoke 类件 / 控制臂 两点臂三点臂U型臂]

    HVAC --> CompICE[传统燃油车压缩机]
    HVAC --> CompEV[新能源电动压缩机<br/>27/34/46/50/80CC 系列]
    HVAC --> ThermalMgmt[整车集成式热管理系统]

    BeiteTech -.->|新业务在研| Screw[行星滚柱丝杠 / Planetary Roller Screw<br/>滚珠丝杠 / 梯形丝杠 + 微型丝杠<br/>昆山 260 万套 + 泰国 80 万套 设计产能 - 量产中]
```
...
```mermaid
graph LR
    Material[材料工艺平台<br/>中高碳合金钢棒材<br/>中频调质 / 中频消应力<br/>拉拔 / 连拔 / 高速旋风车削]
    Machining[加工工艺平台<br/>高频淬回火 / 多轴加工<br/>铣齿 / 滚齿 / 磨齿 / 磨外圆<br/>磨螺纹 / 球头柔性装配]
    Aluminum[铝合金锻造平台<br/>热模锻压力机<br/>辊底式自动热处理<br/>T6 + 荧光渗透探伤]

    Material --> Rack[转向器齿条]
    Material --> Piston[减振器活塞杆]
    Material --> Brake[IPB 法兰 / 活塞]
    Material --> Diesel[柴油喷油器 / 泵体]

    Machining --> CDC[CDC 控制阀件]
    Machining --> IPA[IPA 总成]
    Machining --> PRSshaft[PRS 丝杆 / 滚柱]
    Machining --> ScrollComp[涡旋压缩机型线]

    Aluminum --> ControlArm[控制臂总成]
    Aluminum --> Yoke[Yoke 类件]
    Aluminum --> ValveBlock[集成阀岛]
```
...
```mermaid
pie title 2025 年前五大客户合计 36.85% / 销售总额 RMB 22.91 亿
    "Top-5 客户合计" : 36.85
    "其他客户" : 63.15
```
...
quadrantChart
    ...
    quadrant-3 长尾
    quadrant-4 横向广度
    "北特科技 SSE:603009": [0.8, 0.85]
    "博世华域 UAES": [0.6, 0.7]
    "豫北机械 (非上市)": [0.35, 0.3]
    "浙江世宝 SZSE:002703": [0.4, 0.5]
    "蜂巢易创 (长城旗下)": [0.45, 0.4]
    "湖北恒隆 (非上市)": [0.3, 0.35]
```
