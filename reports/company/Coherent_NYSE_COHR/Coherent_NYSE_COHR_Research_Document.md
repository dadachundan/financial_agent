...
```mermaid
timeline
    title Coherent Corp. — major milestones
    1971 : II-VI Incorporated founded in Saxonburg, PA by Carl Johnson & James Hawkey
    1987 : II-VI initial public offering on NASDAQ
    2010 : Carl Johnson retires from day-to-day operations after ~40 years
    2013 : II-VI acquires Oclaro (later) and grows optical-communications footprint
    2019 : Acquires Finisar for $3.2B — adds VCSELs, datacom transceivers, 3D-sensing optoelectronics
    2021 : Bain Capital invests $750M in Series B-1 preferred stock at $85 conv. price (Mar 2021)
    2022 : Closes $7B acquisition of Coherent Inc. on July 1; renamed Coherent Corp.; ticker → COHR
    2023 : Sells 25% of Silicon Carbide LLC to Denso + Mitsubishi Electric for $1B
    2024 : Jim Anderson (ex-Lattice Semi CEO) appointed CEO on June 3
    2025 : Realigns to two segments (Datacenter & Communications; Industrial) effective July 1
    2025 : Sells aerospace & defense business for ~$400M (Sep 2025)
    2025 : Bain Capital Series B preferred converted to 30.1M common shares (Q2 FY26)
    2026 : Completes $2.0B follow-on equity offering; net leverage drops below 1x
    2026 : Q3 FY26 prints $1.81B revenue, +20.5% YoY; raises FY26 outlook trajectory
```
...
```mermaid
graph TD
    COHR[Coherent Corp.] --> DC[Datacenter & Communications]
    COHR --> IND[Industrial]
    DC --> DC1[Datacom transceivers<br/>400G / 800G / 1.6T]
    DC --> DC2[Coherent / ZR transceivers<br/>100G / 400G ZR/ZR+ / 800G ZR]
    DC --> DC3[Optical components<br/>EML, VCSEL, DML, InP CW lasers]
    DC --> DC4[ROADM / WSS / pump lasers<br/>980 nm, 14xx nm]
    DC --> DC5[ICs: drivers / TIAs / DSPs<br/>CHR2075, CHR1094, CHR2094]
    DC --> DC6[Optical Circuit Switch OCS<br/>AI/ML interconnect]
    IND --> IND1[Semiconductor cap equipment<br/>excimer / CO₂ / ultrafast]
    IND --> IND2[Display cap equipment<br/>LTPS OLED annealing]
    IND --> IND3[Precision manufacturing<br/>EV battery welding, additive]
    IND --> IND4[SiC substrates<br/>150 mm + 200 mm, EV power]
    IND --> IND5[Engineered materials<br/>ZnSe, ZnS, GaAs, InP, Bi₂Te₃]
    IND --> IND6[Life sciences / scientific<br/>microscopy, flow cytometry, LASIK]
    IND --> IND7[VCSELs / consumer<br/>3D sensing, AR/VR, automotive LiDAR]
```
...
```mermaid
pie title FY2025 Customer Concentration (% of $5,810M revenue)
    "Largest customer (datacom)" : 12
    "Second customer (datacom)" : 10
    "All other customers" : 78
```
...
```mermaid
quadrantChart
    title Photonics peer positioning — vertical integration (x) vs. AI-datacom exposure (y)
    x-axis "Less vertically integrated" --> "Highly vertically integrated"
    y-axis "Low AI-datacom exposure" --> "High AI-datacom exposure"
    quadrant-1 "Direct AI photonics winners"
    quadrant-2 "AI exposed, but supply-chain dependent"
    quadrant-3 "Industrial / mature"
    quadrant-4 "Vertically integrated, lower AI exposure"
    "COHR": [0.85, 0.78]
    "LITE": [0.80, 0.85]
    "FN": [0.30, 0.78]
    "Innolight": [0.40, 0.82]
