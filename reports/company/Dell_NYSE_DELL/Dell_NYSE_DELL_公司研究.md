...
**分析师注解:** 所有财务数据来自一级文件 (SEC EDGAR)。Dell 财年截止日为 1 月底/2 月初; 本报告"2026 财年 (FY2026)"指截至 **2026 年 1 月 30 日**的 52 周财政年度。

> **更新——2027 财年指引发布 (2026-02-26):** Dell 指引全年 2027 财年营业收入为 **1,380 亿至 1,420 亿美元** (按 1,400 亿美元中值计同比增长约 23%), 全年 **AI 优化服务器 (AI-Optimized Server) 营业收入"约 500 亿美元"** (相较 2026 财年 247 亿美元同比增长约 103%)。Non-GAAP 摊薄每股收益 (diluted EPS) 指引中值为 **12.90 美元 (同比增长 25%)**, GAAP 摊薄 EPS 中值为 11.52 美元 (同比增长 33%)。驱动因素: 进入 2027 财年时的**积压订单 (backlog) 达 430 亿美元** (相比 2025 财年末退出时的 90 亿美元), 加上管理层描述为"积压订单数倍"的五季度滚动管线。来源: [Dell Q4 FY26 8-K, 2026-02-26](https://www.sec.gov/Archives/edgar/data/1571996/000157199626000003/exhibit991earnings8kq4fy26.htm)。
...
![营业收入与毛利率趋势 FY22–FY26](charts/dell_revenue_margin.png)
...
```mermaid
timeline
    title Dell Technologies——重大里程碑 (1984–2026)
    1984 : 迈克尔·戴尔在德州大学奥斯汀分校创立 PC's Limited
    1988 : 以 Dell Computer Corporation 名义在纳斯达克 IPO
    2003 : 更名为"Dell Inc."; 全球 PC 厂商出货第一
    2013 : 迈克尔·戴尔 + 银湖完成约 249 亿美元 EV 的私有化 LBO
    2016 : 以约 670 亿美元收购 EMC + VMware — 当时科技史上最大并购
    2018 : 通过 Class V 跟踪股置换重返纽交所
    2021 : 将 VMware 分拆给 Dell 股东 (2021 年 11 月 1 日)
    2023 : 裁员约 5%; 首批 AI 服务器订单 (xAI、Meta) 落地
    2024 : AI 服务器营业收入 93 亿美元; PowerEdge XE9680 搭载 H100 放量
    2025 : 至 2026 财年 Q3, AI 服务器年度累计订单突破 300 亿美元
    2026 : 录得 1,135 亿美元营业收入、430 亿美元 AI 积压订单, 指引 2027 财年 1,400 亿美元
```
...
graph TD
    ...
    Dell --> ISG[基础设施解决方案集团 ISG<br/>2026 财年 608 亿美元]
    Dell --> CSG[客户端解决方案集团 CSG<br/>2026 财年 510 亿美元]
    ISG --> AI[AI 优化服务器<br/>2026 财年 247 亿美元]
    ISG --> TRAD[传统服务器与网络<br/>2026 财年 195 亿美元]
    ISG --> STO[存储<br/>2026 财年 166 亿美元]
    AI --> XE9680[PowerEdge XE9680 — 英伟达 HGX H100/H200]
    AI --> XE9712[PowerEdge XE9712 — 英伟达 GB200 NVL72]
    AI --> XE9785[PowerEdge XE9785 — AMD MI300X]
    AI --> XE8640[PowerEdge XE8640 — 风冷 H100]
    TRAD --> R760[PowerEdge R 系列<br/>Intel Xeon / AMD EPYC]
    TRAD --> NW[PowerSwitch 网络 + SmartFabric]
    STO --> PS[PowerStore]
    STO --> PM[PowerMax]
    STO --> PSc[PowerScale]
    STO --> PF[PowerFlex]
    ...
    CSG --> DT[OptiPlex / Dell Pro 台式机]
    CSG --> WS[Precision 工作站<br/>固定 + 移动]
    CSG --> AW[Alienware 游戏]
    CSG --> CONS[Inspiron 消费]
    CSG --> PERIPH[显示器、扩展坞、音频]
```
...
![分部营业收入构成 FY24–FY26](charts/dell_segment_mix.png)
...
```mermaid
pie title 2026 财年净营业收入按主要客户群拆分 (估算)
    "大型企业" : 50
    "中小企业" : 20
    "公共部门与主权" : 12
    "Neocloud 与 GPU 即服务" : 10
    "消费" : 6
    "OEM / 其他" : 2
```
...
![ISG 经营利润率 vs AI 占比](charts/dell_ai_mix_margin.png)
...
![Dell AI 服务器爬坡 (订单 / 出货 / 积压)](charts/dell_ai_backlog.png)
...
![现金生成与资本回报 FY22–FY26](charts/dell_fcf_capreturn.png)
...
![同业估值比较](charts/dell_peer_valuation.png)
