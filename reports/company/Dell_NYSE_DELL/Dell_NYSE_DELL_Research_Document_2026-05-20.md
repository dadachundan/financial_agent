...
```mermaid
timeline
    title Dell Technologies — Major Milestones (1984–2026)
    1984 : Founded by Michael Dell as PC's Limited at UT Austin
    1988 : IPO as Dell Computer Corporation on NASDAQ
    2003 : Renamed "Dell Inc."; #1 global PC vendor
    2013 : Take-private LBO by Michael Dell + Silver Lake at ~$24.9B EV
    2016 : Acquires EMC + VMware for ~$67B — largest tech M&A ever
    2018 : Returns to NYSE via Class V tracker exchange
    2021 : Spins off VMware to Dell shareholders (Nov 1, 2021)
    2023 : Layoffs cut headcount ~5%; first AI-server wins (xAI, Meta)
    2024 : AI-server revenue $9.3B; PowerEdge XE9680 ramps with H100
    2025 : AI-server orders cross $30B YTD by Q3 FY26
    2026 : Records $113.5B revenue, $43B AI backlog, guides $140B FY27
```
...
graph TD
    ...
    Dell --> ISG[Infrastructure Solutions Group<br/>$60.8B FY26]
    Dell --> CSG[Client Solutions Group<br/>$51.0B FY26]
    ISG --> AI[AI-Optimized Servers<br/>$24.7B FY26]
    ISG --> TRAD[Traditional Servers & Networking<br/>$19.5B FY26]
    ISG --> STO[Storage<br/>$16.6B FY26]
    AI --> XE9680[PowerEdge XE9680 — Nvidia HGX H100/H200]
    AI --> XE9712[PowerEdge XE9712 — Nvidia GB200 NVL72]
    AI --> XE9785[PowerEdge XE9785 — AMD MI300X]
    AI --> XE8640[PowerEdge XE8640 — air-cooled H100]
    TRAD --> R760[PowerEdge R-series<br/>Intel Xeon / AMD EPYC]
    TRAD --> NW[PowerSwitch Networking + SmartFabric]
    STO --> PS[PowerStore]
    STO --> PM[PowerMax]
    STO --> PSc[PowerScale]
    STO --> PF[PowerFlex]
    STO --> PP[PowerProtect Data Domain]
    CSG --> NB[Latitude Notebooks]
    CSG --> XPS[XPS / Dell Pro Premium]
    CSG --> DT[OptiPlex / Dell Pro Desktops]
    CSG --> WS[Precision Workstations<br/>fixed + mobile]
    CSG --> AW[Alienware Gaming]
    CSG --> CONS[Inspiron Consumer]
    CSG --> PERIPH[Displays, Docks, Audio]
```
...
**Commercial PCs ($44.1B FY26 / +8% YoY).** Dell's commercial PC portfolio was unified in **April 2025** under the **"Dell Pro"** brand, retiring the Latitude (notebooks), OptiPlex (desktops), and Precision-Mobile (workstations) sub-brands in favor of a single Dell Pro / Dell Pro Plus / Dell Pro Max tiered structure (with Precision fixed workstations becoming "Dell Pro Max Tower"). The 10-K continues to use legacy nomenclature in the segment discussion, but the website navigation has been fully refactored ([Dell PCs & Workstations](https://www.dell.com/en-us/shop/scc/sc/laptops-and-2-in-1-laptops)). The growth driver in FY26 was the Windows-11 refresh cycle (Microsoft ended Windows-10 mainstream support in October 2025) plus richer AI-PC configurations carrying Intel Core Ultra ("Meteor Lake" / "Lunar Lake") and Qualcomm Snapdragon X Elite NPUs. **Competitive advantage: yes — scale, channel, large-account renewal pricing power.** Closest competitors: HP Inc. (HPQ) EliteBook / Z Workstations, Lenovo ThinkPad / ThinkStation. Lenovo leads global PC units; Dell leads US commercial; in workstations (Precision / Pro Max), Dell is #1 globally with low-double-digit share.
...
**Recent launches (last 12 months).** PowerEdge XE9712 (GB200 NVL72) launched March 2025 at Nvidia GTC; XE9785 (AMD MI300X) launched May 2025; Dell Pro / Pro Max consolidated commercial PC brand launched April 2025 with the IBM-derived "Concept Luna" sustainable-design influence visible across the SKU; Dell AI Factory refreshed for Blackwell at GTC 2025. Sunsets: Latitude / OptiPlex / XPS sub-brands retired (folded into Dell Pro / Pro Premium); legacy PowerVault series largely retired in favor of PowerStore.
...
```mermaid
pie title FY2026 Net Revenue by Major Customer Group (est.)
    "Large Enterprise" : 50
    "Small/Mid-Market" : 20
    "Public Sector & Sovereign" : 12
    "Neoclouds & GPU-as-a-Service" : 10
    "Consumer" : 6
    "OEM / Other" : 2
```
...
**Named customer wins (last 12–18 months)** — sourced from press releases, transcripts, and trade-press coverage rather than 10-K disclosure: **xAI** (Memphis "Colossus" supercomputer, multi-billion-$ deal disclosed 2024 and expanded in 2025), **CoreWeave** (long-term supply agreement disclosed 2024), **Lambda** (named in Nvidia keynote materials), **G42 / UAE sovereign AI** (announced March 2025), **HUMAIN / Saudi Arabia sovereign AI** (announced October 2025), **Meta** (Llama-training infrastructure; not officially confirmed, but widely reported), **U.S. Department of Energy** (Argonne, Oak Ridge supercomputing). For traditional enterprise: most of the Fortune 100 banking sector, telcos including Verizon and Deutsche Telekom, and the dominant share of U.S. state and federal procurement.
...
The global server market reached **$334 billion in 2025 by revenue**, up 78% YoY, with the entirety of growth concentrated in AI-accelerated systems; non-accelerated server revenue was roughly flat ([IDC Worldwide Quarterly Server Tracker, March 2026](https://www.idc.com/getdoc.jsp?containerId=prUS53336325)). Dell ranked #1 by revenue, with roughly 20% share by IDC's measure, ahead of Supermicro (#2), HPE (#3), Lenovo, and the white-box manufacturers (Inspur, Quanta, Wiwynn, Gigabyte) that collectively serve hyperscalers' own designs. Enterprise external storage was approximately **$30 billion in 2025** (single-digit YoY growth), with Dell, NetApp, Pure Storage, IBM, HPE and Huawei as the principal vendors; Dell's roughly 27% share leads ([IDC Quarterly Enterprise Storage Systems Tracker, December 2025](https://www.idc.com/getdoc.jsp?containerId=prUS54336626)). Enterprise networking remains dominated by Cisco; Dell's PowerSwitch is a top-5 vendor but a single-digit share player.
...
Global PC shipments were approximately **263 million units in 2025**, up ~4% YoY after two years of post-pandemic decline, with **roughly 60% of refresh demand driven by Windows-10 end-of-life on October 14, 2025** and a smaller but growing slice driven by AI-PC adoption ([Gartner PC Shipments Press Release, January 2026](https://www.gartner.com/en/newsroom/press-releases/2026-01-13-gartner-says-worldwide-pc-shipments-grew-in-2025); [IDC Worldwide Quarterly PC Tracker, January 2026](https://www.idc.com/getdoc.jsp?containerId=prUS52936325)). Lenovo leads share (~24%), HP #2 (~21%), Dell #3 (~16%), Apple #4 (~9%), ASUS / Acer / Samsung the long tail. Workstations (a Dell-led $9–10B sub-segment) grew faster than the broader PC market on engineering / VFX / data-science demand. AI-PCs — Copilot+ PC certifications running Snapdragon X Elite, Intel Core Ultra ("Lunar Lake") and AMD Ryzen AI 300 — represented an estimated **18–22% of commercial-PC shipments in 2025** and are forecast to reach 50%+ of commercial PCs by 2027 ([IDC AI PC Forecast, February 2026](https://www.idc.com/getdoc.jsp?containerId=prUS54036626)).
...
- **AI server + networking systems** — IDC sized 2025 at **$209 billion** of "AI-accelerated server revenue" with a projected CAGR of ~33% to **>$650 billion by 2028** ([IDC AI Infrastructure Tracker, March 2026](https://www.idc.com/getdoc.jsp?containerId=prUS54036726)). Dell's $24.7B in FY26 AI-server revenue is roughly an **11% market share by revenue**; if Dell achieves the implied $50B in FY27, it would likely hold or modestly grow share against Supermicro and ODMs. Even at maturity, Nvidia captures the lion's share of value in this stack — Dell's role is the system-integration layer.
- **Traditional servers + networking** — IDC sized 2025 at roughly **$125 billion**, low-single-digit growth; Dell's traditional servers + networking line of $19.5B represents about a 16% share. The category is structurally low-growth but high-margin (relative to AI-server).
- **External enterprise storage** — IDC sized 2025 at **$30 billion**; Dell ~27% share. Sub-segment growth ~3–5%.
- **PCs (commercial + consumer + workstation)** — Gartner / IDC sized 2025 at **$240 billion** (units × ASP); Dell ~21% share by revenue (higher than its unit-share because of richer commercial / workstation mix).
...
- [Dell Technologies, 2026 Annual Report on Form 10-K (FY ended Jan 30, 2026), filed 2026-03-19](https://www.sec.gov/Archives/edgar/data/1571996/000157199626000008/dell-20260130.htm)
- [Dell Technologies, 2024 Annual Report on Form 10-K (FY ended Feb 2, 2024), filed 2024-03-29](https://www.sec.gov/Archives/edgar/data/1571996/000157199624000036/dell-20240202.htm)
- [Dell Technologies, 2025 Annual Report on Form 10-K (FY ended Jan 31, 2025), filed 2025-03-21](https://www.sec.gov/Archives/edgar/data/1571996/000157199625000034/dell-20250131.htm)
- [Dell Technologies, 2026 DEF 14A Proxy Statement, filed 2026-05-15](https://www.sec.gov/Archives/edgar/data/1571996/000119312526226734/d55706ddef14a.htm)
...
- [IDC Worldwide Quarterly Server Tracker, March 2026](https://www.idc.com/getdoc.jsp?containerId=prUS53336325)
- [IDC Quarterly Enterprise Storage Systems Tracker, December 2025](https://www.idc.com/getdoc.jsp?containerId=prUS54336626)
- [IDC AI Infrastructure Tracker, March 2026](https://www.idc.com/getdoc.jsp?containerId=prUS54036726)
- [Gartner PC Shipments Press Release, January 2026](https://www.gartner.com/en/newsroom/press-releases/2026-01-13-gartner-says-worldwide-pc-shipments-grew-in-2025)
- [IDC Worldwide Quarterly PC Tracker, January 2026](https://www.idc.com/getdoc.jsp?containerId=prUS52936325)
- [IDC AI PC Forecast, February 2026](https://www.idc.com/getdoc.jsp?containerId=prUS54036626)
...
- [HPE Q4 FY25 earnings release, 2025-12-04](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001645590&type=8-K)
