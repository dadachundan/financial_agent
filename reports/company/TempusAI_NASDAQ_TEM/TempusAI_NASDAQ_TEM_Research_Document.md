...
**Date:** 2026-05-29 (initiation of coverage — same day as Tempus's inaugural Investor Day)
...
![Revenue by Product Line FY23–Q1 2026](charts/tem_revenue_trend.png)
...
```mermaid
timeline
    title Tempus AI — Major Milestones (2015–2026)
    2015 : Founded by Eric Lefkofsky in Chicago after wife's breast-cancer diagnosis
    2017 : Tempus xT (large-panel oncology NGS) commercial launch
    2018 : First major pharma data partnership (NCD for NGS by CMS, Medicare framework established)
    2019 : Series F at $3.1 bn post-money (Baillie Gifford led)
    2021 : AstraZeneca initial multi-year data partnership signed
    2022 : Launches Tempus Next (AI care-gap engine)
    2023 : xT CDX FDA approval (April); SB Tempus joint venture in Japan signed with SoftBank
    2024 : IPO at NASDAQ on 14-Jun-2024, ticker TEM, raised $410 m at $6.2 bn IPO valuation
    2024 : Paige.AI digital-pathology acquisition (mid-2024)
    2025 : Ambry Genetics acquisition closes (February) — adds hereditary testing
    2025 : xT CDX awarded ADLT status by CMS (1 July 2024 effective date confirmed in 10-K)
    2025 : Expanded AstraZeneca + Pathos strategic agreements (~$200 m, multi-year)
    2025 : GSK expansion (~$70 m upfront, 3-year)
    2025 : OneOme pharmacogenetics acquisition (November)
    2025 : $750 m convertible-notes offering closed (July)
    2026 : Merck strategic biomarker-discovery collaboration (Q1 2026)
    2026 : Gilead expanded Lens-platform access (Q1 2026)
    2026 : Q1 2026 — MRD volume up ~500% YoY to ~6,500 tests
    2026 : $400 m 0.00% convertibles due 2032 priced (May 7–12) — pays off senior secured loans
    2026 : Inaugural Investor Day, Chicago, 29-May-2026
```
...
**(c) Medical-device companies and disease registries** — a smaller but strategically important category. **Medtronic / ALERT trial** is the flagship example here (covered in §4.3), and Q1 2026 also adds **Blood Cancer United** for a pediatric-AML registry ([Tempus Q1 2026 8-K — EX-99.1](https://www.sec.gov/Archives/edgar/data/1717115/000119312526206317/tem-ex99_1.htm)).
...
```mermaid
pie title FY25 Revenue mix (consolidated, ~$1,271.8m)
    "Diagnostics — Oncology" : 466
    "Diagnostics — Hereditary (Ambry-led)" : 363
    "Diagnostics — Other (incl. pharmacogenetics)" : 126
    "Data and applications — Insights" : 220
    "Data and applications — Trials + Next + Algos" : 96
```
...
```mermaid
quadrantChart
    title Competitive positioning — Multimodal-Data Depth vs. Diagnostics Scale
    x-axis "Narrow diagnostics footprint" --> "Broad clinical-lab footprint"
    y-axis "Single-modality data" --> "Multimodal data + AI"
    quadrant-1 "Vertically integrated"
    quadrant-2 "Pure data platforms"
    quadrant-3 "Pure CRO / data brokers"
    quadrant-4 "Pure diagnostics"
    "Tempus AI": [0.78, 0.85]
...
![US Precision-Medicine TAM build (analyst-consolidated)](charts/tem_tam_build.png)
...
<details>
<summary>Verification log (Step 10) — 2026-05-29</summary>
