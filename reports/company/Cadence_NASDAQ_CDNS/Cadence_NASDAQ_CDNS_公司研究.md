...
![营业收入与营业利润率趋势](charts/cdns_revenue_margin.png)
...
```mermaid
timeline
    title Cadence Design Systems — 关键里程碑
    1983 : SDA Systems 成立 (Solomon, Newton, Sangiovanni-Vincentelli)
    1988 : SDA + ECAD 合并组成 Cadence Design Systems
    1990 : 以 CDNS 代码登陆纳斯达克 IPO
    2005 : 收购 Verisity——Specman / SystemVerilog 验证 IP
    2009 : Lip-Bu Tang 任 CEO; 启动可循环收入模式转型
    2011 : 收购 Denali Software (3.15 亿美元)——存储 IP / 验证
    2016 : Palladium Z1 仿真平台推出
    2017 : Anirudh Devgan 任总裁
    2021 : 12 月 Devgan 升任 CEO
    2022 : 收购 Future Facilities、OpenEye Scientific (制药 AI)、AWR
    2024 : 收购 BETA CAE Systems (12.4 亿美元); ChipStack 智能体 AI 进入开发
    2025 : 收购 Secure-IC、VLAB Works; 智能体 AI 产品线扩张
    2025 : BIS/DOJ 出口管制和解 (净罚款 1.406 亿美元)
    2026 : 完成 Hexagon D&E (MSC Software) 收购, 对价 27 亿欧元——切入物理 AI
    2026 : 推出 ChipStack、ViraStack、InnoStack AI 超级智能体 + AgentStack
```
...
```mermaid
graph TD
    A[Cadence Design Systems] --> B[核心 EDA]
    A --> C[系统设计与分析]
    A --> D[半导体 IP]
    A --> S[服务]
    B --> B1[定制 / 模拟<br/>Virtuoso 平台]
    B --> B2[数字实现<br/>Innovus / Genus / Tempus<br/>Voltus / Quantus]
    B --> B3[验证软件<br/>Xcelium / Jasper / Verisium<br/>Conformal AI Studio]
    B --> B4[硬件加速<br/>Palladium Z3 / Protium X3]
    B --> B5[AI 超级智能体<br/>ChipStack / ViraStack /<br/>InnoStack / AgentStack]
    B --> B6[Cerebrus<br/>AI 芯片探索器]
    C --> C1[PCB 与封装<br/>Allegro X / OrCAD X /<br/>Sigrity X]
    C --> C2[多物理场<br/>Celsius / Clarity / AWR /<br/>Fidelity CFD / Integrity 3D-IC]
    C --> C3[结构 / 机械<br/>BETA CAE / MSC Nastran /<br/>Adams 多体动力学]
    C --> C4[AI 优化<br/>Optimality / Reality DT /<br/>Millennium 多物理场]
    D --> D1[接口 IP<br/>PCIe / CXL / UCIe / HBM /<br/>DDR / LPDDR / USB / SerDes]
    D --> D2[Tensilica DSP<br/>音频 / 视觉 / AI / 基带]
    D --> D3[验证 IP<br/>用于 Xcelium / Palladium 的 VIP]
    D --> D4[安全 IP<br/>Secure-IC]
    S --> S1[方法学服务]
    S --> S2[培训 / Cadence Academy]
    S --> S3[Cadence OnCloud<br/>云端托管 EDA]
```
...
![EDA TAM 增长](charts/cdns_eda_tam.png)
...
![同业估值](charts/cdns_peer_valuation.png)
...
![Cadence 季度营收](charts/cdns_quarterly.png)
