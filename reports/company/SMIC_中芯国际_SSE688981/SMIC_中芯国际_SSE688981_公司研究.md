...
```mermaid
xychart-beta
    title "中芯国际：营业收入 (RMB bn) 与毛利率 (%) 2021–2025"
    x-axis ["FY2021","FY2022","FY2023","FY2024","FY2025"]
    y-axis "RMB bn / %" 0 --> 75
    bar [35.6, 49.5, 45.3, 57.8, 67.3]
    line [29.3, 38.3, 21.9, 18.7, 21.0]
```
...
```mermaid
timeline
    title 中芯国际关键里程碑 (2000–2026)
    2000 : 张汝京在 Cayman 注册成立 SMIC，上海张江开建首座 8 英寸 fab
    2004 : NYSE + HKEX 双重 IPO；推出 0.18μm 工艺量产
    2009 : 创始人张汝京因 TSMC 知识产权诉讼和解后离任；王宁国接任 CEO
    2011 : 邱慈云博士接任 CEO；公司重启战略聚焦
    2017 : 赵海军 (Zhao Haijun) 与梁孟松 (Liang Mong Song) 出任联合 CEO；启动 14 nm FinFET 研发
    2018 : 向 ASML 订购首台 EUV 光刻机 (USD 150 mn) — 美国施压荷兰，许可证未获续签
    2019 : 14 nm FinFET 量产；从 NYSE 退市
    2020 : 7 月 A 股科创板 IPO 募资 RMB 53.2 bn；12 月被列入美国 BIS 实体清单
    2023 : 华为 Mate 60 Pro 搭载 SMIC 制造 Kirin 9000s (7 nm N+2)
    2024 : 全年营收首次突破 USD 8 bn；12 月美国 BIS 加入 Footnote 5 限制
    2025 : 全年营收 USD 9.33 bn (+16.2%)；月产能突破 100 万片 8 英寸当量
```
...
```mermaid
graph TD
    A[Foundry Service 晶圆代工] --> B[Advanced Logic 先进逻辑]
    A --> C[Mature Logic 成熟逻辑]
    A --> D[Specialty 特色工艺]
    A --> E[Other Services 配套服务]
    B --> B1[7 nm N+1/N+2 FinFET]
    B --> B2[14 nm FinFET]
    C --> C1[28 nm HKMG/ULP/HV]
    C --> C2[55/65 nm]
    C --> C3[90/130 nm]
    D --> D1[RF SOI - 射频]
    D --> D2[BCD - PMIC/工业/车规]
    D --> D3[HV Display Driver - OLED/LCD]
    D --> D4[eNVM - 嵌入式存储]
    D --> D5[CIS - 图像传感器]
    E --> E1[Mask 光掩模制造]
    E --> E2[IP 与设计服务]
    E --> E3[Wafer-level Packaging - 晶圆级封装]
```
...
```mermaid
pie title FY2024 SMIC 客户集中度 (consolidated 口径)
    "第一名客户" : 8.1
    "第二至第五名客户合计" : 27.9
    "其他所有客户合计" : 64.0
```
...
```mermaid
xychart-beta
    title "2025 Q2 全球纯晶圆代工市场份额 (%)"
    x-axis ["TSMC","Samsung","SMIC","UMC","GF","HuaHong","其他"]
    y-axis "市场份额 (%)" 0 --> 80
    bar [70.2, 7.3, 5.1, 4.4, 3.9, 2.5, 6.6]
```
