...
![Qualcomm — 总营业收入与 GAAP 毛利率, 2021–2025 财年](charts/qcom_revenue_gm.png)
...
```mermaid
timeline
    title Qualcomm — 关键里程碑 1985–2026
    1985 : 由 Irwin Jacobs、Andrew Viterbi 等 7 人于圣迭戈创立
    1991 : NASDAQ 上市; 重新于特拉华州注册
    1995 : 首次商用 CDMA 部署 (和记电讯, 香港)
    1999 : 出售手机及基础设施业务; 转型为纯 IP+芯片公司
    2007 : 骁龙品牌发布 (面向智能手机的 CPU+GPU+modem SoC)
    2014 : 中国发改委 (NDRC) 和解 — 9.75 亿美元罚款; 专利费基数重置
    2018 : Cristiano Amon 担任总裁
    2019 : 与苹果和解, 签署 6 年专利授权及芯片供应协议
    2021 : Amon 升任 CEO; 收购 Nuvia → 自研 Oryon CPU
    2022 : 收购 Veoneer 旗下 Arriver ADAS 软件业务 (47 亿美元)
    2024 : 苹果 iPhone 16e 搭载苹果首款自研调制解调器 (C1); 华为授权到期; 骁龙 X Elite 发布开启 PC 业务
    2025 : 完成对 Alphawave Semi 的收购 (24 亿美元) → 切入数据中心
    2026 : 批准 200 亿美元股票回购; 超大规模客户定制硅片放量
```
...
graph TD
    ...
    HND --> S8E[骁龙 8 Elite — 高端 Android]
    HND --> S7G[骁龙 7 系列 — 高阶档位]
    HND --> SLT[骁龙 6/4 系列 — 中端/入门]
    HND --> MDM[MDM 薄型调制解调器 — 苹果 iPhone]

    AUTO --> SDC[骁龙座舱平台]
    AUTO --> SDR[骁龙 Ride / Ride Elite — ADAS/AD]
    AUTO --> ARV[Arriver 软件栈 — 感知/驾驶策略]
    AUTO --> SDA[骁龙汽车连接 — 5G/Wi-Fi/V2X]

    IOT --> SPC[骁龙 X2 Elite / X2 Plus — Copilot+ PC]
    IOT --> XR2[骁龙 AR1/XR2 Gen 2 — Meta Quest 与智能眼镜]
    IOT --> DRG[龙翼 Dragonwing — 工业机器人/零售/物流]
    IOT --> NET[Networking Pro — Wi-Fi 7 接入点与宽带]

    DC --> AW[Alphawave SerDes/PCIe IP]
    DC --> HCS[超大规模客户定制 AI 硅片 — 2026 日历年]

    QTL --> SEP[蜂窝 SEP — 3G/4G/5G/5G-Advanced]
    QTL --> NSP[非蜂窝专利 — Wi-Fi, 视频编解码, UWB]
```
...
![QCT 手机业务营业收入与同比增速, 2023–2025 财年](charts/qcom_handset_growth.png)
...
![QCT 汽车业务季度营业收入爬坡](charts/qcom_auto_ramp.png)
...
![QTL 专利授权营业收入与 EBT 利润率, 2021–2025 财年](charts/qcom_qtl.png)
...
```mermaid
pie title 2025 财年营业收入集中度 — 前三大客户/授权对象
    "苹果 (客户 x) 21%" : 21
    "三星 (客户 y) 20%" : 20
    "小米 (客户 z) 13%" : 13
    "所有其他客户 / 授权对象" : 46
...
![同业估值快照 — TTM P/E 与 P/S (2026 年 5 月)](charts/qcom_peer_valuation.png)
