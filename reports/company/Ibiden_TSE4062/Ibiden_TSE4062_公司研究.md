...
```mermaid
xychart-beta
    title "Ibiden 11 年净销售与 OPM 趋势 (¥B / %)"
    x-axis [FY2014, FY2015, FY2016, FY2017, FY2018, FY2019, FY2020, FY2021, FY2022, FY2023, FY2024]
    y-axis "Net Sales (¥B)" 0 --> 450
    bar [318, 314, 266, 300, 291, 296, 323, 401, 418, 371, 369]
    line [8.2, 7.2, 2.7, 5.6, 3.5, 6.7, 11.9, 17.7, 17.3, 12.8, 12.9]
```
...
```mermaid
timeline
    title Ibiden 公司演进 1912-2026
    1912 : 在岐阜县大垣市成立 Ibigawa Electric Power 揖斐川电力 (创始人 Yujiro Tachikawa 立川勇次郎)
    1951 : 战后转型为制造业，扩展电炉业务，为日后碳产品业务打下基础
    1974 : 石油危机期间进入电子电路业务 — 建立首座印刷电路板工厂
    1995 : 与全球最大半导体厂商建立交易关系（Intel）— Electronics 业务规模化起点
    2000 : Ceramics 业务因 SiC-DPF 被全球大型汽车厂商采用而起飞
    2003-2010 : Ibiden 成为 Intel 处理器 FC-BGA 载板的主供应商（最高占其载板业务 70-80%）
    2016 : Intel 14nm 周期与 PC 需求暴跌导致 -¥62.8B 净亏损
    2017 : Takeshi Aoki 青木武志 出任 President & CEO，启动业务复兴
    2023-2024 : 大野工厂 Ono Plant 一期投建启动，¥146-157B 年度 capex 高峰
    2024 : Koji Kawashima 川岛宏二 (June) 接任 President & CEO；Aoki 转任董事会主席
    2025 : Ono Plant 进入量产爬坡；与 NVIDIA Blackwell / 主要 ASIC 客户深化合作
    2026 : FY2027 中期目标上修：营业利润 ¥90B → ¥150B；FY2030 营收 ¥1 万亿目标确立
```
...
graph LR
    A[味之素 ABF 膜] --> B
    B1[生益/Kingboard CCL 铜箔] --> B
    B[Ibiden 4062 SAP 工艺 IC 载板] --> C[ASE/Amkor OSAT 封装]
    C --> D[Foxconn/Quanta 服务器整机]
    D --> E[Azure/AWS/Google/Meta 数据中心]
    F[NVIDIA wafer fab TSMC N4P/N3] --> C
```
...
```mermaid
pie title 估算 Ibiden Electronics 营收客户结构 (FY2025) — 分析师拼图 (segment-level not group-level)
    "NVIDIA (AI GPU)" : 30
    "Intel (CPU)" : 20
    "AMD (CPU + GPU)" : 12
    "Hyperscaler ASIC (Google/AWS/Meta)" : 10
    "Switching / Network IC (Broadcom 等)" : 5
    "其他 PC OEM + Mobile" : 13
    "未明确披露" : 10
```
...
```mermaid
quadrantChart
    title FC-BGA / AICS 厂商竞争定位
    x-axis "成本竞争性 (高 → 低)" --> "规模与垂直整合 (低 → 高)"
    y-axis "技术领先性 (低 → 高)" --> 
    quadrant-1 "技术领跑 + 大规模"
    quadrant-2 "技术领跑 + 中小规模"
    quadrant-3 "传统 PC 载板基地"
    quadrant-4 "规模 + 通用产品"
    Ibiden: [0.85, 0.92]
    Unimicron: [0.75, 0.78]
    AT&S: [0.7, 0.55]
    NanYaPCB: [0.55, 0.5]
    ShinkoElectric: [0.7, 0.45]
    SamsungEM: [0.5, 0.65]
    Kinsus: [0.6, 0.45]
```
...
```mermaid
xychart-beta
    title "Ibiden FY2024-FY2030 营收路径 (¥B)"
    x-axis [FY2024, FY2025, FY2026, FY2027, FY2030]
    y-axis "Net Sales (¥B)" 0 --> 1100
    bar [369, 416, 470, 600, 1000]
```
