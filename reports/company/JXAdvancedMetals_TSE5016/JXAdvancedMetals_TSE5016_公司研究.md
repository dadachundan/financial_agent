...
![JX Advanced Metals 营收与营业利润率走势 (FY23–FY25)](../../charts/jxadvanced_revenue_margin.png)
...
![JX Advanced Metals FY25 分部营收构成](../../charts/jxadvanced_segment_mix.png)
...
```mermaid
timeline
    title JX Advanced Metals 关键里程碑, 1905–2025
    1905 : 日立矿山开采 (久原房之助, 茨城)
    1916 : 佐贺关铜冶炼厂投产 (大分)
    1929 : 日本鉱業株式会社成立 (从日产剥离)
    1985 : 矶原工厂开业 — 电子材料基地
    2002 : 新日鉱ホールディングス设立 (即今 TSE 5016 法人)
    2010 : 更名为 JX 日鉱日石金属 (JX 控股集团下)
    2014 : 智利 Caserones 铜矿启动
    2016 : 更名为 JX 金属 (JX Metals)
    2018 : 收购东邦钛 (50.4%); 收购 H.C. Starck Ta/Nb (TANIOBIS)
    2022 : 收购 eCycle Solutions (加拿大电子废料回收商)
    2024 : 英文商号改为 JX Advanced Metals; Tatsuta 电线全资合并; 与三菱组建 JX Circular Solutions 合资公司
    2025 : TSE Prime IPO ¥820 — ENEOS 持股降至 42.4%
```
...
![JX Advanced Metals 分部产品矩阵 — 直引自 2025 Yuho 第 7 页](../../charts/jxadvanced_segment_table_yuho_p7.png)
...
```mermaid
graph LR
    A["铜矿权益<br/>Caserones 30%<br/>Los Pelambres 25%<br/>Escondida 20%"] -->|铜精矿| B["佐贺关 / 日立<br/>冶炼厂 → 4N Cu"]
    B -->|4N Cu 阴极| C["Functional Materials<br/>进一步精炼 → 6N / 9N Cu"]
    B -->|4N Cu 阴极| D["ICT Materials —<br/>日立工厂精密压延"]
    C -->|溅射靶坯锭| E["矶原工厂<br/>溅射靶<br/>Cu / Ta / Ti / Co / W"]
    E -->|靶材| F["客户晶圆厂<br/>TSMC / 三星 /<br/>英特尔 / SK 海力士 / 美光"]
    D -->|HA 压延铜箔 6μm| G["FCCL / FPC 厂<br/>(富士康等)"]
    G -->|智能手机、AI 服务器、EV| H[终端市场]
    I["电子废料 / 废铜<br/>(eCycle 加拿大,<br/>JX Circular Solutions)"] -->|回收| B
```
...
![Yuho 第 9 页溅射靶业务描述（直接复刻）](../../charts/jxadvanced_sputter_desc_yuho_p9.png)
...
![JX Advanced Metals FY25 资本开支按分部 (¥638 亿总额)](../../charts/jxadvanced_capex.png)
