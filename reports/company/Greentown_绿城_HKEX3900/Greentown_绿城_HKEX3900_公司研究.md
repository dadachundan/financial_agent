...
```mermaid
xychart-beta
    title "绿城中国 — 营业收入与归母净利润（FY23-FY25, RMB 亿）"
    x-axis ["FY23", "FY24", "FY25"]
    y-axis "RMB 亿" 0 --> 2000
    bar [1314, 1585, 1550]
    line [31.18, 15.96, 0.71]
```
...
timeline
    title 绿城中国 — 关键里程碑
    1995 : 由宋卫平、寿柏年、夏一波在杭州创立
    2006 : 港交所主板上市，发行价 HKD 8.22（股票代码 03900）
    2010 : 子公司绿城管理成立（轻资产代建模式起航）
    2014 : 2013-14 周期接近破产；中国交建以 HKD 60.13 亿获 24.288% 股权
    2015 : 中国交建增持至 28.9%，成为单一最大股东
    2018 : 宋卫平卸任董事会主席
    2020 : 绿城管理（09979）拆分港股上市
    2024 : FY24 营收 RMB 1,585 亿（历史新高），总合同销售排名行业第三
    2025 : 中国交建副总经理刘成云接任非执行董事会主席；FY25 取消末期股息
```
...
```mermaid
graph LR
    A[拿地] --> B[绿城物业开发主业, 95% 收入]
    A --> C[绿城管理 9979, 轻资产 2% 收入, 17% 利润率]
    B --> D[预售与去化]
    C --> E[地主方借力绿城品牌完成销售]
    D --> F[交付 2,269万平方米 11.9万户 2025]
    E --> F
    F --> G[绿城+ 集群: 酒店, 养生, 社区运营]
    G --> B
    G --> C
```
...
```mermaid
pie title FY2025 物业销售收入按地区构成（占物业销售收入百分比）
    "浙江（含杭州、宁波）" : 49.1
    "上海" : 17.9
    "江苏（含苏州、南京）" : 6.8
    "其他地区" : 26.2
...
```mermaid
xychart-beta
    title "PRC 全国商品房销售（RMB 万亿）"
    x-axis [2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025E]
    y-axis "RMB 万亿" 0 --> 20
    bar [13.4, 15.0, 16.0, 17.4, 18.2, 13.3, 11.7, 9.5, 8.7]
```
...
```mermaid
xychart-beta
    title "TAM 增长 — PRC 住宅销售（RMB 万亿）+ 代建费 (RMB 十亿, 缩放至同一坐标)"
    x-axis [2021, 2022, 2023, 2024, 2025E, 2028E, 2030E]
    y-axis "RMB 万亿 / 十亿" 0 --> 22
    line [18.2, 13.3, 11.7, 9.5, 8.7, 9.0, 10.0]
    bar [3, 5, 7, 8, 9, 25, 45]
```
...
<details>
<summary>验证日志（步骤 10）— 2026-06-03</summary>
