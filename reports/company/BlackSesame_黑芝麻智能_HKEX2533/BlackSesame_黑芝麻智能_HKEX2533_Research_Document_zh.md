...
timeline
    title 黑芝麻智能关键里程碑
    2016 : 公司由单记章与刘卫红创立 (7 月在开曼注册)
    2018 : 推出首颗自研 SoC「华山一号」(A500)
    2020 : 「华山二号」A1000 系列正式发布<br/>16nm
    2021 : A1000 通过 ISO 26262 ASIL-B 功能安全认证
    2022 : 武当 C1200 跨域融合系列对外亮相
    2023 : 完成 C+ 轮，投后估值约 22.3 亿美元
    2024 : 8 月 8 日依据上市规则 18C 章登陆港交所主板<br/>同年 12 月发布华山 A2000 家族
    2025 : 2 月配售净筹约 11.42 亿港元 (RMB)<br/>SesameX 具身智能平台发布、首年贡献 0.96 亿元<br/>年末签署收购亿智电子协议
    2026 : A2000 (7nm) 拟量产、推进与 Apollo Go 的 L4 量产合作<br/>拟完成亿智电子收购
```
...
graph TD
  ...
  BSI --> SX[SesameX 平台<br/>具身智能全栈算力]
  BSI --> IMG[智能影像解决方案<br/>ISP IP + 算法授权]

  HS --> A1000["华山 A1000 系列<br/>16nm, ISO26262 ASIL-B<br/>已大规模量产, 主力收入"]
  HS --> A2000["华山 A2000 家族<br/>7nm, 全场景通用高算力<br/>FP16/FP8, 2026 拟量产"]

  WD --> C1200["武当 C1200 系列<br/>舱驾一体, 单芯片覆盖<br/>座舱+智驾+泊车+车身"]

  SX --> KALOS["Kalos / Aura / Liora<br/>从基础控制到高级认知"]

  IMG --> ISPIP["自研 ISP IP 授权<br/>GM 84.7%"]
```
...
```mermaid
pie title FY2025 收入按客户集中度 (占合并总收入)
  "最大客户 (单一)" : 9.1
  "五大客户中其他 4 家" : 29.0
  "其他客户合计" : 61.9
```
...
quadrantChart
  ...
  x-axis 价格性价比导向 --> 高端算力旗舰
  y-axis 国产本土生态 --> 全球品牌跨域生态
  quadrant-1 全球高端
  quadrant-2 全球普惠
  quadrant-3 国产普惠
  quadrant-4 国产高端
  ...
  Qualcomm Ride: [0.55, 0.78]
  Horizon J6P: [0.75, 0.20]
  Horizon J5/J6E: [0.35, 0.20]
  BSI A2000: [0.75, 0.18]
  BSI A1000: [0.30, 0.15]
  BSI Wudang C1200: [0.55, 0.15]
  Huawei Ascend: [0.70, 0.10]
```
...
```mermaid
xychart-beta
  title "中国智能驾驶解决方案市场规模 (RMB 亿元)"
  x-axis [2020, 2024, 2030E]
  y-axis "市场规模 (RMB 亿元)" 0 --> 4500
  bar [216, 912, 4300]
```
