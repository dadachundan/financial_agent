...
![Six-year financial trend chart](charts/leadshine_5yr_chart.png)
...
```mermaid
timeline
    title Leadshine Intelligent Control — Key Milestones
    1997 : Founded in Shenzhen by Dr. Li Weiping (MIT robotics PhD)
    2001-2007 : Digital stepper driver platform reaches #1 position in China stepper segment
    2010 : Expansion into AC servo systems and motion controllers
    2018 : Begins R&D into robotics core components (AGV / AMR / collaborative)
    2020 : IPO on SZSE Main Board (April 8, 2020) under ticker 002979
    2022 : Shenzhen HQ relocated to Zhigu R&D Tower, Xili; restructures into "智能制造 + 移动机器人" two-track strategy
    2023 : Successfully develops high-density frameless torque motor, hollow-shaft encoder, hollow-cup servo system
    2024 : Establishes subsidiary 灵巧驱控 (Lingqiao Drive Control) for dexterous hands and humanoid components
    2025-Mar : Public release of DH-series dexterous hand (11 / 20 / 24 DoF variants)
    2025 : Frameless motor shipments cross 120,000 units (+20x YoY); named Agibot Outstanding Supplier Partner; Dongguan humanoid-component base announced (2M units/yr capacity)
    2026-Q1 : Revenue +34.6% YoY; cabinet-stage humanoid order flow accelerates
```
...
```mermaid
graph TD
    A[Leadshine 雷赛智能] --> B[Servo Systems]
    A --> C[Stepper Systems]
    A --> D[Control Technology]
    A --> E[Robotics Core Components]
    B --> B1["AC Servo Drives: L8 / L7 / L6 / L5 / L3"]
    B --> B2["AC Servo Motors: ACM2 / ACM1 / ACM0 / M7 / M6 / M5 / M3"]
    B --> B3["Low-voltage Servo Drives: LD3M / LD2 / 4LD3"]
    B --> B4["Low-voltage Servo Motors: LVM / 伺服滚筒"]
    B --> B5["Integrated Servo: iSV2 / iSV"]
    B --> B6["Encoders: 26-bit photo, split magnetic, etc."]
    C --> C1["Digital Stepper Drives: DM5 5-phase / pulse / bus / drive+control"]
    C --> C2["Digital Stepper Motors: CM std / brake / waterproof / hollow / 5-phase"]
    C --> C3["Closed-loop Stepper Drives & Motors"]
    C --> C4["Integrated Stepper: smart i-stepper"]
    D --> D1["Motion Controllers: 5000 / 3000 / 1000 series"]
    D --> D2["Motion Control Cards: DMC-S, I/O, encoder counter"]
    D --> D3["PLCs: S / SC / MC / LC series"]
    D --> D4["Remote I/O Modules: in-cabinet, out-of-cabinet"]
    E --> E1["FM1 / FM2 Frameless Torque Motors"]
    E --> E2["Hollow-shaft Encoders"]
    E --> E3["Hollow-cup Brushless Servo Motors: std / hi-speed / hi-torque"]
    E --> E4["Harmonic Joint Modules: HJ series"]
    E --> E5["Planetary Joint Modules: PJ series + iW wheeled"]
    E --> E6["Dexterous Hand: DH series 11 / 20 / 24 DoF"]
    E --> E7["Robot Motion 'Cerebellum' Controllers (in development)"]
```
...
```mermaid
pie
    title FY2025 revenue mix by customer (top-5 disclosed; remainder "All other")
    "All other customers (91.63%)" : 91.63
    "Top customer #1 (1.82%)" : 1.82
    "Top customer #2 (1.66%)" : 1.66
    "Top customer #3 (1.65%)" : 1.65
    "Top customer #4 (1.64%)" : 1.64
    "Top customer #5 (1.59%)" : 1.59
```
...
```mermaid
quadrantChart
    title Motion-Control Positioning — Price vs. Feature Breadth (China market)
    x-axis "Lower price" --> "Higher price"
    y-axis "Narrow product" --> "Full-stack motion control"
    quadrant-1 "Full-stack premium"
    quadrant-2 "Full-stack value"
    quadrant-3 "Niche commodity"
    quadrant-4 "Niche premium"
    Leadshine: [0.35, 0.80]
    Inovance: [0.45, 0.92]
    Yaskawa: [0.85, 0.85]
    Moons': [0.40, 0.65]
    Estun: [0.55, 0.60]
    Step Electric: [0.30, 0.45]
    Beckhoff: [0.85, 0.70]
    Oriental Motor: [0.65, 0.35]
```
...
- [雷赛智能 2024 年年度报告 (2025-04-24)](https://static.cninfo.com.cn/finalpage/2025-04-24/) (local cache: `cninfo_reports/SZSE/002979_雷赛智能/2025-04-24_年报_2024年年度报告.pdf`)
- [雷赛智能 2023 年年度报告 (2024-04-25)](https://static.cninfo.com.cn/finalpage/2024-04-25/) (local cache: `cninfo_reports/SZSE/002979_雷赛智能/2024-04-25_年报_2023年年度报告.pdf`)
- [雷赛智能 2022 年年度报告 (2023-04-24)](https://static.cninfo.com.cn/finalpage/2023-04-24/) (local cache: `cninfo_reports/SZSE/002979_雷赛智能/2023-04-24_年报_2022年年度报告.pdf`)
