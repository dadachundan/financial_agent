...
```mermaid
timeline
    title First Quantum Minerals 关键事件年表
    1996 : Philip Pascall 重组 Xenium 为 First Quantum<br/>赞比亚 Bwana Mkubwa 尾矿项目
    2000 : 收购 Mopani 项目 (Zambia, 后剥离)
    2001 : 取得 Kansanshi 矿权<br/>(Zambia)
    2004 : 收购 Guelb Moghrein (Mauritania) 进军毛里塔尼亚
    2005 : Kansanshi 投产 — 成为公司旗舰
    2009 : 收购 Ravensthorpe (Australia)<br/>USD 340 m
    2013 : Hostile takeover Inmet Mining<br/>CAD 5.1 bn — 取得 Cobre Panamá
    2016 : Sentinel (Zambia) 投产<br/>Enterprise 镍矿建设启动
    2019 : Cobre Panamá 商业化生产投产<br/>占公司营收约 40%
    2022 : Tristan Pascall 接任 CEO<br/>(2022-05, 二代传承)
    2023 : 11/28 巴拿马最高法院判 Law 406 违宪<br/>Cobre Panamá 进入 P&SM
    2024 : Sentinel 满产 +231 kt 铜<br/>Jiangxi Copper 持股 18.4%, Saudi Manara 谈判
    2025 : Kansanshi S3 扩建投产 (8月)<br/>Royal Gold USD 1 bn gold stream 完成
    2026 : 巴拿马 SGS 最终审计公布<br/>Mulino 政府 6 月作出 Cobre Panamá 决定
```
...
graph TD
    subgraph 在产现金牛
        K[Kansanshi 铜/金<br/>181 kt Cu, 旗舰] 
        S[Sentinel 铜精矿<br/>189 kt Cu]
        E[Enterprise 镍<br/>23 kt Ni]
        G[Guelb Moghrein<br/>铜/金/磁铁矿]
    end
    subgraph 暂停/重启期权
        CP[Cobre Panamá<br/>300 kt Cu 满产]
        R[Ravensthorpe Ni]
        LC[Las Cruces Cu]
    end
    subgraph 长期管线
        TT[Taca Taca Argentina<br/>275 kt Cu 设计]
        LG[La Granja Peru<br/>4.8 Bt 资源]
    end
    K --> Smelter[非洲铜冶炼厂]
    S --> Smelter
    G --> Smelter
    Smelter --> Buyer[江西铜业 + 国际贸易商]
    E --> NiBuyer[镍买家 / Norilsk LME]
    CP -.重启决策待定.-> Future[潜在 +300 kt Cu/年]
    TT -.2030+.-> Future
    LG -.2032+.-> Future
```
...
```mermaid
pie title FQM 销售产品组合（按 2022 满产年口径，%）
    "Copper (铜)" : 86
    "Gold (黄金)" : 5
    "Nickel (镍)" : 6
    "其他 (磁铁矿/钼/银)" : 3
...
```mermaid
xychart-beta
    title "2024-2030E 精炼铜供需缺口预测 (千吨)"
    x-axis [2024, 2025, 2026E, 2027E, 2028E, 2029E, 2030E]
    y-axis "供需缺口 (kt, 负=短缺)" -1000 --> 200
    bar [50, -304, -400, -550, -700, -800, -950]
```
...
```mermaid
quadrantChart
    title 全球铜矿企业定位 (横轴 = 产量, 纵轴 = 地理多样化)
    x-axis "Low Production (200 kt/年)" --> "High Production (1500+ kt/年)"
    y-axis "Concentrated Geography" --> "Diversified Geography"
    quadrant-1 "巨头多区域"
    quadrant-2 "高产量集中区"
    quadrant-3 "区域专家"
    quadrant-4 "中产量多区域"
