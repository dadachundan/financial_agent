...
![Siltronic 5-year financial trend](../../charts/siltronic_5yr_financials.png)
...
![Siltronic peer valuation](../../charts/siltronic_peer_valuation.png)
...
```mermaid
timeline
    title Siltronic — 58-year corporate timeline (1968–2026)
    1968 : Wacker-Chemitronic GmbH founded in Burghausen
    1978 : Wacker Siltronic Corp. Portland (Oregon, US) opens
    1984 : First 200 mm wafers produced at Burghausen
    1990 : First R&D projects on 300 mm wafers
    1995 : Acquisition of Freiberg fab (former East-German Spurenelemente)
    1996 : Reorganized as Wacker Siltronic Gesellschaft für Halbleitermaterialien AG
    1997 : SSP — Wacker Siltronic Singapore founded
    1999 : Start of 200 mm production in Singapore
    2002 : First 200 mm float-zone (FZ) crystals
    2004 : Renamed Siltronic AG (Munich HQ); new 300 mm fab in Freiberg
    2006 : 50:50 JV with Samsung in Singapore (SSW) for 300 mm
    2014 : Siltronic raises SSW stake to 78%
    2015 : IPO on Frankfurt Prime Standard (June 2015)
    2016 : New crystal-pulling hall in Freiberg
    2017 : Wacker Chemie reduces stake to ~31% (sell-down January 2017)
    2019 : New crystal-pulling hall in Singapore
    2020 : GlobalWafers announces EUR 4.35 bn takeover (Dec 2020)
    2021 : Groundbreaking on new Singapore Fab S2
    2022 : GWC deal collapses; Germany misses 31 Jan deadline; EUR 50 m break fee paid
    2023 : Freiberg crystal-pulling extension inaugurated
    2024 : Inauguration of Singapore Fab S2; March announcement of SD-line shutdown
    2025 : Singapore Fab S2 customer qualifications complete; depreciation starts August; SD line fully shut
    2026 : FY26 guidance: EBITDA margin 20–24%, capex cut to EUR 180–220 m
```
...
```mermaid
graph LR
    A[Polysilicon<br/>from Wacker Chemie<br/>+ qualified alts] --> B[CZ crystal pulling<br/>Burghausen, Freiberg, Singapore]
    A --> C[FZ crystal pulling<br/>Burghausen]
    B --> D[300 mm wafer<br/>polished + epi<br/>Singapore + Freiberg]
    B --> E[200 mm wafer<br/>polished + epi<br/>Burghausen + Portland + Singapore]
    C --> F[200 mm FZ<br/>PowerFZ for IGBT]
    D --> G[Memory + Logic<br/>fabs: Samsung, SKH,<br/>Micron, TSMC, Intel]
    E --> H[Power discrete + MCU<br/>fabs: Infineon, STM,<br/>Nexperia, Bosch]
    F --> H
```
...
```mermaid
pie title FY2025 Sales by Customer Geography (% of EUR 1,346.7 m)
    "Taiwan + China (mainland) 36.4%" : 36.4
    "South Korea 25.4%" : 25.4
    "Asia ex TW/CN/KR 14.3%" : 14.3
    "United States 10.3%" : 10.3
    "Europe ex Germany 6.8%" : 6.8
    "Germany 5.1%" : 5.1
    "Consolidation / other 1.7%" : 1.7
```
...
![Siltronic FY24 vs FY25 sales by region](../../charts/siltronic_geographic_mix.png)
*Source: [Siltronic Annual Report 2025, p. 152, Note 18 Segment reporting](https://www.siltronic.com/fileadmin/investorrelations/2025/Q4/260420_Siltronic_Annual_Report_2025_safe.pdf).*
...
![Siltronic end-market wafer-area split](../../charts/siltronic_segment_mix.png)
