...
![Siltronic 五年财务趋势](../../charts/siltronic_5yr_financials.png)
...
```mermaid
timeline
    title Siltronic — 58 年企业演进时间线（1968–2026）
    1968 : Wacker-Chemitronic GmbH 于 Burghausen 成立
    1978 : 美国俄勒冈州 Portland 工厂落成
    1984 : Burghausen 首批 200 mm 硅片下线
    1990 : 启动 300 mm 硅片研发项目
    1995 : 并购 Freiberg 工厂（前东德 Spurenelemente 资产）
    1996 : 改组为 Wacker Siltronic Gesellschaft für Halbleitermaterialien AG
    1997 : 新加坡 SSP 子公司成立
    1999 : 新加坡 200 mm 生产投产
    2002 : 首批 200 mm 区熔 (FZ) 晶体
    2004 : 更名 Siltronic AG（慕尼黑总部）；Freiberg 新 300 mm 工厂
    2006 : 与 Samsung 在新加坡设立 50:50 合资公司 SSW（300 mm）
    2014 : Siltronic 增持 SSW 至 78%
    2015 : 法兰克福 Prime Standard 上市（2015 年 6 月）
    2016 : Freiberg 新长晶 (crystal-pulling) 车间
    2017 : Wacker Chemie 减持至 ~31%
    2019 : 新加坡新长晶车间
    2020 : GlobalWafers 宣布 EUR 43.5 亿收购要约（2020 年 12 月）
    2021 : 新加坡 Fab S2 破土动工
    2022 : GWC 收购案失效；德国错过 1 月 31 日截止日；支付 EUR 5,000 万分手费
    2023 : Freiberg 长晶车间扩建启用
    2024 : 新加坡 Fab S2 启用；3 月宣布 SD 小直径产线关闭
    2025 : 新加坡 Fab S2 客户认证完成；8 月起进入折旧；SD 产线全面关闭
    2026 : FY26 指引 EBITDA 利润率 20–24%，Capex 收缩至 EUR 1.80–2.20 亿
```
...
本章是整份报告分量最重的一节。Siltronic 的产品线在表面上极其集中——每一欧元收入都来自抛光、磊晶、或区熔三类硅片之一——但这条"单一产品"线内部的细分组合，恰恰决定了公司在 AI 周期中是处于结构性受益位还是被锁定在增速最低的传统细分。

### 4.1 Siltronic 产品矩阵

Siltronic 在年报中并未提供类似美股 10-K 的产品矩阵——其分部报告仅显示一个统一的"硅片"分部 ([Annual Report 2025, p. 152, Note 18](https://www.siltronic.com/fileadmin/investorrelations/2025/Q4/260420_Siltronic_Annual_Report_2025_safe.pdf))。下表为**分析师整理**——来源包括 [Siltronic Products page](https://www.siltronic.com/en/products.html)、[Special Products subpage](https://www.siltronic.com/en/products/special-products.html)，以及年报"Important products, business processes, and markets"章节（p. 19）的描述。

| 直径 | 抛光片 (Polished) | 磊晶片 (Epitaxial) | 区熔 (FZ) | 特种 / 品牌产品 |
|---|---|---|---|---|
| **300 mm** | ✓ — DRAM / NAND / Logic | ✓ — Logic / Power-discrete；"高度集成元件的卓越基底" | — （仅研发阶段） | **Ultimate Silicon™**（前沿 CMOS，200/300 mm 均有） |
| **200 mm** | ✓ — 模拟、汽车、MCU | ✓ — Power-MOS、IGBT 磊晶 | ✓ — 2002 年起 | **PowerFZ®**（PowerMOS / IGBT） |
| **150 mm** | ✗（SD 产线 2025 关闭） | ✗（SD 产线 2025 关闭） | ✗（SD 产线 2025 关闭） | **HIREF®**（非抛光，100/125/150 mm） |
| **125 mm** | ✗ | ✗ | ✗ | **HIREF®**（MEMS / 探测器） |
| **100 mm** | ✗ | ✗ | ✗ | **HIREF®**（MEMS / 探测器） |

资料来源：[Siltronic Products page](https://www.siltronic.com/en/products.html); [Siltronic Special Products](https://www.siltronic.com/en/products/special-products.html); [Annual Report 2025, p. 19, Important products, business processes, and markets](https://www.siltronic.com/fileadmin/investorrelations/2025/Q4/260420_Siltronic_Annual_Report_2025_safe.pdf); [Siltronic press release — SD line shutdown, 2024-03-22](https://www.siltronic.com/en/press/press-releases/siltronic-ends-wafer-production-for-small-diameters.html)。

剥离冗余规格，FY25 收入实际由两个直径承担：

- **300 mm — AI / 先进节点 (leading-edge) 主力。** 抛光与磊晶两种工艺均有，主要销往存储器客户（Samsung、SK Hynix、Micron）以及先进节点逻辑客户（TSMC、Intel、Samsung Foundry、GlobalFoundries）。这是公司的增长引擎：[Q1 2026 IR deck p. 7](https://www.siltronic.com/fileadmin/investorrelations/2026/Q1/20260429_Q1_2026_conference_call_presentation__.pdf) 显示 300 mm 硅片需求 25 年 CAGR 为 **6%（2000–2025）**，而 200 mm 仅 1%。
- **200 mm — Power / 模拟 / 汽车主力。** 以磊晶 Power-MOS / IGBT 为主（客户：Infineon、STMicroelectronics、Nexperia、ON Semiconductor、Mitsubishi Electric、Bosch），以及区熔 FZ 与品牌化的 **PowerFZ®** 产品。由于汽车与工控终端在 2024–25 年仍处库存消化期，需求停滞，FY26 指引仍将 Power 列为拖累。

### 4.2 综合解读 — 各品类在客户工作流中的相互关系

```mermaid
graph LR
    A[多晶硅 Polysilicon<br/>主要来自 Wacker Chemie<br/>+ 已认证替代供应商] --> B[CZ 直拉法长晶<br/>Burghausen, Freiberg, Singapore]
    A --> C[FZ 区熔长晶<br/>Burghausen]
    B --> D[300 mm 硅片<br/>抛光 + 磊晶<br/>Singapore + Freiberg]
    B --> E[200 mm 硅片<br/>抛光 + 磊晶<br/>Burghausen + Portland + Singapore]
    C --> F[200 mm FZ<br/>PowerFZ 用于 IGBT]
    D --> G[存储 + 逻辑<br/>客户: Samsung, SKH,<br/>Micron, TSMC, Intel]
    E --> H[Power 分立元件 + MCU<br/>客户: Infineon, STM,<br/>Nexperia, Bosch]
    F --> H
```

硅片是 IC 价值链最起始的一道物理输入——每一道后续制造工序（沉积、光刻、刻蚀、注入、CMP、切割、封装）都在它之上完成。理解 Siltronic 产品组合为何重要，关键在于 **300 mm 与 200 mm 硅片在三方面存在结构性差异**。其一，300 mm 硅片表面积是 200 mm 的约 2.25 倍（πr² 比 22,500 mm² vs 10,000 mm²），同一工艺节点下每片 300 mm 可产出约多 125% 的 die，从而拉低单 die 制造成本。其二，300 mm 市场集中于五大供应商，主要客户是先进节点存储与逻辑——即骑乘 AI / HBM / 先进封装浪潮的厂商。其三，200 mm 市场客户端更分散，主要服务模拟、MCU、Power、传感器等晶圆厂，结构性增速更低（Siltronic 自家数据：过去 25 年 CAGR 约 1%，而 300 mm 为 6%）。

在 Siltronic 内部组合中，三个"品牌化"产品系列（Ultimate Silicon™、PowerFZ®、HIREF®）各自对应不同终端用途，相互之间不可替代。综合洞察：**Siltronic 的盈利将日益取决于 300 mm 子组合的占比**——SD 产线关闭已切除 ≤150 mm 尾部，200 mm Power 业务陷于库存消化，新加坡 Fab S2 几乎全部新增产能落在 300 mm 一侧。

### 4.3 300 mm 抛光与磊晶硅片（存储 + 逻辑 — AI 引擎）

**年报原文 (Annual Report 2025, p. 19, Important products)：**
...
**中文释义 / Plain-language gloss：** 300 mm 硅片是直径 300 mm、厚度约 775 µm 的单晶硅 (single-crystal silicon, Si) 圆盘，由 **Czochralski 直拉法（CZ，直拉法）** 生长——将一颗籽晶浸入熔融多晶硅中，缓慢旋转上提，可拉出长达约 2 米的"晶棒" (ingot)。该晶棒经切片、倒角、研磨 (lapping)、抛光，对磊晶片再用化学气相沉积 (CVD, 化学气相沉积) 在表面生长一层完美取向的单晶硅。最终硅片的表面平整度规格——按 Siltronic 自家类比——相当于在网球场尺度上仅允许 1 个细菌高度（20 nm）的特征 ([Investor Presentation April 2026, p. 18, Purity and flatness requirements](https://www.siltronic.com/fileadmin/investorrelations/2026/Q1/20260429_Siltronic_InvestorPresentation__.pdf))。颗粒规格相当于"在整个慕尼黑市区只允许散布 10 粒沙"。这就是进入 TSMC、Samsung Foundry、Intel、Micron、SK Hynix 工厂的那一片硅片，承载着所有先进节点 GPU、HBM 堆叠、先进节点 CPU、高密度 NAND 芯片。

300 mm 内部的关键分化在于**抛光 vs 磊晶**。抛光片是裸基底，用于 DRAM、NAND 与部分逻辑；磊晶片在抛光基底上以 CVD 生长一层 5–10 µm 高度纯净的单晶硅层（"epi"，磊晶），是要求最高的逻辑节点（2 nm、3 nm、A14、A10——见 [Investor Presentation April 2026, p. 16](https://www.siltronic.com/fileadmin/investorrelations/2026/Q1/20260429_Siltronic_InvestorPresentation__.pdf) 工艺路线图）的指定规格，因为磊晶层缺陷密度更低、电阻率控制更紧。2025 年爬坡中的新加坡 Fab S2 关键意义在于：这是 **新加坡的第一条 300 mm 磊晶线**——此前磊晶能力集中在 Freiberg ([Investor Presentation April 2026, p. 12, Facts about new Singapore fab](https://www.siltronic.com/fileadmin/investorrelations/2026/Q1/20260429_Siltronic_InvestorPresentation__.pdf))。新加坡新增磊晶能力给了 Siltronic 一个美元成本基础下的磊晶卡位，既具备 FX 对冲意义（SGD/USD 强相关），又靠近核心客户群（TSMC、Samsung、SMIC、UMC 都在亚洲）。

驱动 2025–26 年 300 mm 需求的战略拐点很清晰：**AI 服务器建设正以历史最快速度消耗 HBM**，每个 HBM 堆叠包含 8–16 层 DRAM die，每层都需一片 300 mm 硅片。Siltronic 自家 FY25 终端拆分显示，服务器占总硅片面积消耗的 18%，2026e 服务器面积增速高达 +44% YoY——为整个组合中拉动最强的单一细分 ([Q1 2026 Conference Call Presentation, p. 10](https://www.siltronic.com/fileadmin/investorrelations/2026/Q1/20260429_Q1_2026_conference_call_presentation__.pdf))。需要特别指出的是：Siltronic 警示 **DRAM bit 增长与硅片需求出现"解耦" (decoupled)**——因为客户 DRAM 产能成为瓶颈：2026 年预计仅 6–7% 的 DRAM 硅片需求会到达硅片行业，其余被芯片涨价与库存消耗吸收 ([Investor Presentation April 2026, p. 9 — DRAM decoupling](https://www.siltronic.com/fileadmin/investorrelations/2026/Q1/20260429_Siltronic_InvestorPresentation__.pdf))。

*分析师观点：* Siltronic 在 300 mm 磊晶上具备**部分**竞争优势（技术护城河 + 客户认证成本护城河），在 300 mm 抛光上则**与对手处于规模均势**（Shin-Etsu 与 SUMCO 合计约占全球 300 mm 一半，规模与成本曲线的优势在他们手里）。野村《Greater China Semi 2026-30F Renaissance》报告（[reports/sector/半导体材料.md](../../sector/半导体材料.md)）将 Siltronic 列为 300 mm 全球第 4——位于 Shin-Etsu、SUMCO、GlobalWafers 之后，在 SK Siltron 之前。最直接的同业产品对照是 **Shin-Etsu Handotai** 的 300 mm SOI / 退火片 (annealed wafer) 系列（Shin-Etsu 在其英文 IR 中未单独披露产品名；参见 [Shin-Etsu Chemical — Silicon Wafers product page](https://www.shinetsu.co.jp/en/products/electronics-materials/silicon-wafers/)）与 **SUMCO 的 "PW + EPI"** 抛光 + 磊晶组合。

### 4.4 200 mm 硅片（Power + 模拟 + 汽车）

**年报原文 (Annual Report 2025, p. 21, Corporate strategy)：**
...
**中文释义 / Plain-language gloss：** 200 mm 硅片是 **模拟、MCU、汽车、Power 分立元件** 行业的主力——这些细分中芯片本身较大（一颗 IGBT die 可达 1 cm × 1 cm），工作电压较高（600 V、1,200 V、1,700 V，SiC 替代 IGBT 场景），芯片经济从未要求过 200 mm → 300 mm 的转移——而 2000 年代初的存储与先进逻辑则完成了这一跨越。该硅片的工艺路径与 300 mm 抛光 / 磊晶基本相同（CZ 直拉、切片、抛光、可选 CVD 磊晶），区别仅在于直径为 200 mm，且表面规格可以放宽——因为器件结构在微米级而非纳米级。200 mm 中还有一类独特变体——**区熔 (Float-Zone, FZ, 区熔法)**：与 CZ 不同，FZ 不从熔池里拉，而是用射频线圈在一根垂直多晶硅棒上局部熔融一个区域，逐步上移并在身后再结晶——产出极低氧、极低碳含量、长少子寿命的"最纯硅 / purest silicon"。Siltronic 将其品牌化为 **PowerFZ®**，作为中子嬗变掺杂 (Neutron-Transmutation-Doped, NTD, 中子嬗变掺杂) 硅片的成本更优替代方案，主攻 PowerMOS 与 IGBT 客户 ([Siltronic Special Products page](https://www.siltronic.com/en/products/special-products.html))。

战略拐点在 2025–26 阶段**短期负面 / 长期正面**。负面：EV 与工业自动化周期承袭 2021–23 年缺货期累积的库存，200 mm 硅片需求"低迷"，去库存延续至 2026 年 ([Annual Report 2025, p. 47, Outlook](https://www.siltronic.com/fileadmin/investorrelations/2025/Q4/260420_Siltronic_Annual_Report_2025_safe.pdf))。结构性正面：来自 EV 动力总成、数据中心电源转换链（48V → 12V → 1V）、风电 / 光伏逆变器、5G 基站的功率电子需求处于 10–15 年长周期上行——届时 200 mm 产能或难以满足。*分析师观点：* Siltronic 是全球 **Power 硅片 Top 3** 供应商（与 SUMCO、Shin-Etsu 并列）——公司在 FY25 IR 资料中自我定位为"Power: leading position" ([Investor Presentation April 2026, p. 10](https://www.siltronic.com/fileadmin/investorrelations/2026/Q1/20260429_Siltronic_InvestorPresentation__.pdf))。最直接的同业对照产品是 **SUMCO 200 mm Power 线**——SUMCO 已于 2025 年 2 月宣布将于 2026 年末关闭宫崎工厂的 200 mm 硅片生产，将资源转向高端 300 mm AI 级硅片——这是 Siltronic 的份额机会——以及 **GlobalWafers MEMC 200 mm Power 线**（随 MEMC 收购而来）。SUMCO 宫崎退出与 Siltronic 自身 SD 产线关闭部分相互抵消——两家都在剥离低增长 Western/Japanese 中小直径产能。

### 4.5 区熔 (FZ) 与品牌化特种产品 — PowerFZ® + HIREF® + Ultimate Silicon™

**Siltronic Special Products 页面原文：**
...
**中文释义 / Plain-language gloss：** 三个品牌化特种产品与未品牌化的抛光 / 磊晶产品并列存在。
- **Ultimate Silicon™** — Siltronic 的旗舰 CMOS 硅片品牌，主攻先进存储（DRAM、NAND）。200 mm 与 300 mm 均有提供。该品牌的卡位是"低缺陷 / 高平整度 / 极纯净"前沿光谱端——与 Shin-Etsu 的"Annealed Silicon Wafer"系列对位。*分析师观点：* 该品牌更像营销标签而非独立产品族——底层仍是高规格 CZ 抛光或磊晶硅片。
- **PowerFZ®** — 200 mm 区熔产品，主攻 PowerMOS / IGBT 客户。*意义：* IGBT 客户（Infineon、STM、Mitsubishi、Toshiba、Onsemi、Renesas）要求极低氧含量——因为氧会干扰垂直功率器件的载流子寿命。FZ 硅片与 NTD 硅片是两种主流方案，PowerFZ® 以成本优势对位 NTD。
- **HIREF®**（High Reflectivity）— 非抛光硅片，100 mm、125 mm、150 mm 直径，厚度 100 µm 到 1,500 µm，主攻分立器件、探测器、MEMS 应用 ([Siltronic Special Products page](https://www.siltronic.com/en/products/special-products.html))。*意义：* 极低产量 / 极高毛利率 SKU——典型的"长尾业务"，毛利好正因 Top-5 大厂都不愿竞标。组合中本还包括传统小直径——但 **SD 产线于 2024 年 3 月 22 日宣布关闭** ([Siltronic press release — SD shutdown](https://www.siltronic.com/en/press/press-releases/siltronic-ends-wafer-production-for-small-diameters.html))，关停了 ≤150 mm 抛光与磊晶产线，留下 HIREF® 作为唯一的 ≤150 mm 选项。

### 4.6 研发组合与专利 — 技术护城河

研发人员约 **450 名**，集中在 Burghausen 研发中心，目标研发费用率 **占销售 5–6%** ([Investor Presentation April 2026, p. 15](https://www.siltronic.com/fileadmin/investorrelations/2026/Q1/20260429_Siltronic_InvestorPresentation__.pdf))。FY25 研发费用 **EUR 7,830 万**（占销售 5.8%），较 FY24 的 EUR 8,310 万下降 ([Annual Report 2025, p. 27](https://www.siltronic.com/fileadmin/investorrelations/2025/Q4/260420_Siltronic_Annual_Report_2025_safe.pdf))。有效专利组合约 **1,900 项已注册及申请中的专利**，构成管理层口中的技术领导地位基础 ([Annual Report 2025, p. 63, Eco-design of wafers](https://www.siltronic.com/fileadmin/investorrelations/2025/Q4/260420_Siltronic_Annual_Report_2025_safe.pdf))。Siltronic 公开发布一份 10 年研发与商业化里程碑路线图——A14 节点研发自 2023 年启动，A10 节点研发自 2025 年启动，两者均瞄准 2026 年商业化 ([Investor Presentation April 2026, p. 16, Technology Leader track record](https://www.siltronic.com/fileadmin/investorrelations/2026/Q1/20260429_Siltronic_InvestorPresentation__.pdf))。该路线图历史表现稳健：45 nm 节点 2004 年立项、2007 年量产（3 年滞后）；5 nm 节点 2016 年立项、2020 年量产（4 年滞后）；AI 时代节点（3 nm、2 nm、A14、A10）均显示 2 年的研发到量产滞后。这条 2 年管线滞后构成**结构性切换成本护城河**：2025 年已通过 A10 认证的客户，在 2027 年之前不可能转去认证替代厂——因为每个节点 / 每个 fab 的认证周期约 18–24 个月。

### 4.7 旗舰产品系列 + 近期发布

**Top-3 旗舰：** (1) **面向先进节点逻辑的 300 mm 磊晶片** — 客户包括 TSMC、Samsung Foundry、Intel、GlobalFoundries；这是单片 ASP 最高的 SKU，也是新加坡 Fab S2 爬坡的引擎；(2) **面向存储的 300 mm 抛光片** — 客户包括 Samsung、SK Hynix、Micron；这是销量引擎，也是最直接受益于 HBM4 拐点的细分；(3) **面向 Infineon 与 STM 的 PowerFZ® 200 mm** — 200 mm 中毛利率最高的 SKU，是公司在 EV 功率电子上的结构性押注。三者合计可能贡献 FY25 收入超过 65%（Siltronic 未按产品线披露分项；以上为分析师估算）。

**过去 12 个月的发布 / 转向：**
- **2025-07** — 新加坡 Fab S2 主要客户认证完成；首次实现 300 mm 磊晶能力的新加坡产能 ([Investor Presentation April 2026, p. 12](https://www.siltronic.com/fileadmin/investorrelations/2026/Q1/20260429_Siltronic_InvestorPresentation__.pdf))
- **2025（全年）** — Burghausen SD 产线（≤150 mm 抛光 + 磊晶）全面关闭；HIREF® 成为唯一 ≤150 mm 产品 ([Siltronic press release — SD shutdown, 2024-03-22](https://www.siltronic.com/en/press/press-releases/siltronic-ends-wafer-production-for-small-diameters.html))
