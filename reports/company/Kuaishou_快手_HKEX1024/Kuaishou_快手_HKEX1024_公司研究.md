...
timeline
    title 快手发展时间线
    2011 : 程一笑创办 "GIF 快手" 动图工具
    2013 : 宿华加入，转型短视频社区，GIF 快手更名为 "快手"
    2017 : 腾讯首次注资，绑定生态联盟
    2019 : 腾讯追加投资 USD 2 bn
    2020 : DAU 突破 3 亿，Q4 起诉抖音不正当竞争
    2021 : 2 月 5 日 HKEX:1024 IPO 上市，发行价 HKD 115，首日 +160%，募资 USD 5.3 bn
    2022 : 宿华辞任 CEO，程一笑独任董事长兼 CEO；启动海外业务收敛 (退出印度 + 部分欧美市场)
    2023 : 国内业务实现年度盈利，电商 GMV 突破 RMB 1.18 万亿
    2024 : 6 月发布可灵 AI (Kling AI) 视频生成大模型，全年营收破 RMB 1,269 亿
    2025 : 可灵 AI 12 月年化 ARR 突破 USD 240 mn；DAU 季度峰值 416 mn
```
...
```mermaid
graph LR
    A[短视频 / 直播 内容池] -->|算法分发| B[用户 DAU 401 mn]
    B -->|125 分钟/日 停留时长| C[广告变现]
    B -->|虚拟礼物打赏| D[直播变现]
    B -->|短视频带货 + 直播带货| E[电商 GMV 1,389.6 bn]
    C -->|广告收入 RMB 72.4 bn| F[公司现金流]
    D -->|分成 RMB 37.1 bn| F
    E -->|技术服务费 + 佣金 RMB 17.4 bn| F
    F -->|算力 / 算法 / 创作者激励| A
```
...
```mermaid
pie title FY2024 营收按业务分布 (RMB 126.9 bn, 合并口径)
    "在线营销 57.1%" : 57.1
    "直播 29.2%" : 29.2
    "其他服务 (电商 + 本地 + AI) 13.7%" : 13.7
```
