...
```mermaid
timeline
    title Equinix 关键里程碑 (1998–2026)
    1998 : 6 月 Jay Adelson 与 Al Avery 在 Delaware 创立 Equinix; 9 月获 VC 融资
    1999 : 7 月 27 日首座 IBX (Ashburn, VA) 开业
    2000 : 8 月 Nasdaq IPO
    2010 : 收购 Switch and Data (美国本土扩张)
    2011 : 收购 ALOG (拉美巴西扩张)
    2015 : 完成 REIT 转换 (1 月 1 日生效)
    2016 : 收购 Telecity Group (欧洲扩张) 与 Bit-isle (日本)
    2017 : 收购 Verizon 美国 24 座数据中心 (USD 3.6 bn)
    2018 : 收购 Metronode (澳大利亚) 与 Infomart Dallas
    2019 : 启动 xScale® hyperscale JV 战略
    2024 : 6 月 Adaire Fox-Martin 出任 CEO; 10 月与 GIC + CPP 签订 >USD 15 bn 美国 xScale JV
    2026 : Q1 营收破 USD 2.4 bn, AFFO 单季首破 USD 1 bn
```
...
```mermaid
graph TD
    A[Equinix Platform] --> B[IBX Retail Colocation]
    A --> C[xScale Hyperscale JV]
    B --> B1[Private Cage 私有笼舍]
    B --> B2[Secure Cabinet 安全机柜]
    B --> B3[Equinix Suite 模块化套间]
    B --> D[Interconnection 互联]
    D --> D1[Cross Connect 跨连线]
    D --> D2[Internet Exchange 互联网交换]
    D --> D3[Equinix Fabric 虚拟互联]
    B --> E[Managed Services 托管服务]
    E --> E1[Smart Hands 远程运维]
    E --> E2[Equinix Service Bundles ESB]
    E --> E3[Network Edge 虚拟网络功能 NFV]
    C --> C1[GIC + CPP US JV USD 15bn+]
    C --> C2[PGIM RE Silicon Valley SY9x USD 600mn]
    C --> C3[Other regional xScale JVs]
```
...
```mermaid
pie title Top 10 客户合计占 Q1 2026 MRR (consolidated; 口径=经常性收入)
    "Cloud & IT 客户 1 (2.5%)" : 2.5
    "Cloud & IT 客户 2 (2.2%)" : 2.2
    "Cloud & IT 客户 3 (2.2%)" : 2.2
    "Cloud & IT 客户 4 (1.9%)" : 1.9
    "Cloud & IT 客户 5 (1.8%)" : 1.8
    "Network 客户 6 (1.5%)" : 1.5
    "Cloud & IT 客户 7 (1.1%)" : 1.1
    "Network 客户 8 (1.1%)" : 1.1
    "Cloud & IT 客户 9 (1.1%)" : 1.1
    "Cloud & IT 客户 10 (1.0%)" : 1.0
    "其余 10,490+ 客户" : 83.8
```
