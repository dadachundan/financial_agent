...
```mermaid
graph TD
    H[TOPPAN Holdings FY25 ¥1,717.9 bn] --> IC[信息通讯 ¥929.4 bn]
    H --> LI[生活产业 ¥548.1 bn]
    H --> EL[电子 ¥279.9 bn]
    IC --> DB[数字业务 / 营销 DX]
    IC --> SM[Secure Media / IC 卡 / 智能卡]
    IC --> BP[BPO]
    IC --> CM[Communication Media / 出版物印刷]
    LI --> PK[软包装 + 折叠纸盒<br/>+ Sonoco TFP 2025 年 4 月并入]
    LI --> DM[装饰建材 / 墙纸]
    EL --> SEMI[**半导体** 约 ¥210 bn 分析师估算]
    EL --> DSP[**显示器** 约 ¥70 bn 分析师估算]
    SEMI --> TKS[**Tekscend Photomask**<br/>FY25 单体营收 ¥107.1 bn<br/>2025 年 10 月后凸版持股 46.6%]
    SEMI --> FCBGA[**FC-BGA 基板**<br/>新泻 + 石川 + 新加坡]
    DSP --> CF[LCD 用彩色滤光片]
    DSP --> TFT[TFT-LCD<br/>Giantplus 自 2025 年 1 月起转为权益法]
    DSP --> ARF[抗反射膜]
```
...
![Tekscend Photomask — 营收与利润率，FY22–FY25E](../../charts/toppan_tekscend_revenue.png)
...
![商用光罩市场份额，CY2024 (分析师估算)](../../charts/toppan_photomask_share.png)
...
![FC-BGA / 先进 IC 载板市场份额，2024 (分析师估算)](../../charts/toppan_fcbga_share.png)
