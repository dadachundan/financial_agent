...
![GMIN 产量与 AISC 路径](charts/gmin_production_aisc.png)
...
```mermaid
timeline
    title G Mining Ventures——历史里程碑, 2008–2026
    2008 : G Mining Services (GMS) 由 Louis Gignac Sr. 与其子创立
    2018 : GMS 担任 Essakane (IAMGOLD) 与 Eagle (Victoria Gold) 项目工程总顾问
    2020 : GMIN 注册成立; 从 Eldorado Gold 收购 Tocantinzinho
    2021 : 12 月 TSX Venture 交易所 IPO
    2022 : Tocantinzinho 建设决策; 全额融资方案落地
    2023 : 升入 TSX 主板
    2024 : TZ 首次倾炼 (7 月); 宣告商业生产 (9 月); Reunion Gold 合并 (7 月完成) — Oko West 并入
    2025 : Oko West 可行性研究提交 (4 月); 圭亚那最终环保许可 (8 月); Oko West 建设决策 (10 月); 20 年采矿许可证 (12 月)
    2026 : G2 Goldfields 收购公告 (4 月) — Oko-Ghanie 整合, 合计约 700 万盎司 M&I 资源 (待完成交割)
```
...
graph TD
    ...
    GMIN --> TZ["Tocantinzinho<br/>巴西帕拉州<br/>(在产)"]
    GMIN --> OW["Oko West<br/>圭亚那第七区<br/>(建设中)"]
    GMIN -. 待交割 .-> G2["G2 Goldfields<br/>Oko-Ghanie<br/>(2026-04 收购)"]
    TZ --> TZP["CIL 工艺<br/>12,890 tpd"]
    TZ --> TZR["200 万盎司 P&P<br/>1.31 g/t Au"]
    TZ --> TZL["~10.5 年 LOM<br/>~175 koz/年"]
    OW --> OWP["CIL+重选 工艺<br/>~1,000 万吨/年"]
    OW --> OWR["430 万盎司 P&P<br/>~2.07 g/t Au"]
    OW --> OWL["12.3 年 LOM<br/>350 koz/年 均值"]
    G2 --> G2R["~200 万盎司增量 M&I<br/>Oko-Ghanie"]
```
...
![GMIN 储量与资源组合](charts/gmin_reserves_mix.png)
...
```mermaid
pie title GMIN FY2025 营业收入按矿山划分
    "Tocantinzinho (巴西)" : 100
```

```mermaid
pie title GMIN LOM 预期黄金产量组合 (TZ + Oko West)
    "Oko West (圭亚那, LOM 350 koz/年)" : 67
    "Tocantinzinho (巴西, LOM 175 koz/年)" : 33
```
...
![GMIN 同业比较——产量与 AISC](charts/gmin_peer_compare.png)
