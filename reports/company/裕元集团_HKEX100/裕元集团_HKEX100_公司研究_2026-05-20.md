...
```mermaid
timeline
    title 裕元工业重要里程碑 (1969-2025)
    1969 : 蔡氏家族在台湾彰化创立宝成工业 (Pou Chen)
    1988 : 蔡其瑞在香港注册成立裕元工业（集团）
    1992 : 香港联交所主板上市 (股票代号 551)
    1990s : 在广东东莞、珠海、中山建立鞋厂集群；成为 Nike/Adidas/Reebok 核心供应商
    2000s : 集团年营收突破 US$1 bn；越南胡志明市、同奈省、印尼万隆设厂
    2008 : 旗下零售业务宝胜国际 (HKEX:03813) 在港单独上市
    2014 : 东莞高埗鞋厂大规模罢工事件，加速产能向越南/印尼迁移
    2018 : 加速去中国化产能布局以应对中美贸易摩擦
    2020 : 受 COVID 冲击，营收降至 US$8.4 bn；EBITDA 跌至阶段性低点
    2024 : 印尼出货占比首超 50%，达 54%；EPS YoY +42.9% 至 24.37 美仙
    2025 : 美国新关税扰动需求，全年营收回落 1.8% 至 US$8.03 bn
```
...
```mermaid
graph TD
    A[裕元工业集团 HKEX:00551] --> B[制造业务 US$5,620.8M FY2024]
    A --> C[零售业务 宝胜 HKEX:03813 US$2,561.4M FY2024]
    B --> B1[运动/户外鞋<br/>US$4,403.6M 53.8%]
    B --> B2[休闲鞋及运动凉鞋<br/>US$765.4M 9.4%]
    B --> B3[鞋底配件及其他<br/>US$451.8M 5.5%]
    B1 --> B11[Nike 篮球/跑步/训练]
    B1 --> B12[adidas 三叶草/Performance]
    B1 --> B13[Asics 跑鞋]
    B1 --> B14[New Balance/Salomon/<br/>Puma/UA/Converse]
    B2 --> B21[Timberland 户外]
    B2 --> B22[Crocs 休闲 EVA]
    B3 --> B31[鞋底材料 EVA/TPU]
    B3 --> B32[配件 鞋带/中底]
    C --> C1[直营零售 3,448 家门店]
...
```mermaid
pie title 裕元 FY2024 营业收入按主要客户 (US$ M)
    "客户甲 (估为 Nike) ~US$2,058M, 25%" : 25
    "客户乙 (估为 adidas) ~US$1,386M, 17%" : 17
    "其余前五客户 (估含 Asics/NB/Salomon) ~US$1,219M, 15%" : 15
    "其他中小客户 ~US$1,358M, 16%" : 16
    "宝胜零售 (大中华区 C 端) US$2,561M, 31%" : 31
```
