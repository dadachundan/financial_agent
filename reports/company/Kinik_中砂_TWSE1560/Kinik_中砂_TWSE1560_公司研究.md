...
![中砂营收与毛利率走势 2020–2025](../../charts/kinik_revenue_margin.png)
...
![同业估值比较](../../charts/kinik_peer_valuation.png)
...
```mermaid
timeline
    title 中砂 70 年发展时间线 (1953–2026)
    1953 : 白永传 (林长寿女婿) 创立中国砂轮 ；
         : 台湾第一家砂轮厂 (鹰歌) ；
         : 由家族原有「金敏窑业」陶器业务转型
    1967 : 与日本三井金属矿业开始 10 年技术合作
    1990s晚期 : 时任董事长林心正前瞻半导体 ；
              : 启动「再生晶圆」与「CMP 钻石碟」两大研发投资
    1997 : 成立「金敏精研」(子公司) 专攻再生晶圆
    2000 : 取得第一笔半导体客户 (TSMC) 订单
    2001 : 竹北建成台湾第一座 12 吋再生晶圆厂 (延性轮磨制程)
    2005 : 1/31 TWSE 上市 (代号 1560) ；金敏精研并入母公司成为 SBU 晶圆事业部
    2011 : 获颁经济部「台湾百大品牌奖」
    2017 : 获颁经济部第 4 届「卓越中坚企业奖」
    2021 : 11 月获 26 届「国家品质奖 — 全面卓越类绩优经营奖」 ；
         : 10 月获 30 届「台湾精品奖 - 12 吋再生晶圆」
    2023 : 公司 70 周年 ；3nm 钻石碟出货大幅成长
    2024 : 全年合并营收创新高 NT$70.2 亿元 ；
         : 12/24 董事会通过 NT$20 亿元扩建竹南二期 (12 吋产能 30 万→40 万片/月)
    2025 : 1/22 宣布收购三井研削砥石 (MKS) ¥19.19 亿 + MGT THB 4.5 亿 ；
         : 4/1 完成交割，集团升级为日台泰三地 8 个工厂 ；
         : 全年营收 NT$81.5 亿 (+16%)、EPS NT$9.28
    2026 : 1 月单月营收 NT$7.53 亿 (+33% YoY) ；
         : 股价 12 个月内 +150%，本研究撰写时市值 NT$1,013 亿
```
...
```mermaid
graph TD
    KINIK[KINIK Group<br/>合并营收 2024 NT$70.2 亿]
    ...
    SBU["**SBU 晶圆事业部**<br/>(竹北 / 竹南厂)<br/>客户：半导体业<br/>2024 占营收 50% / NT$35.2 亿"]
    SBU --> SBU_P1[测试晶圆 Test Wafer]
    SBU --> SBU_P2[再生晶圆 Reclaim Wafer]
    SBU --> SBU_P3[特殊 / 高阶承载晶圆]

    DBU["**DBU 钻石事业部**<br/>(鹰歌 / 树林 / 湖口厂)<br/>客户：半导体 / 先进封装<br/>2024 占营收 32% / NT$22.5 亿"]
    DBU --> DBU_P1[CMP 钻石碟<br/>Conventional 系列<br/>DiaGrid / I-DiaGrid / S-DiaGrid]
    DBU --> DBU_P2[CMP 钻石碟<br/>Advanced 系列<br/>Pyradia / equaDia / EDP / CVD-WAVE]
    DBU --> DBU_P3[晶圆研磨砂轮<br/>WLP / PLP / 2.5D / 3D]
    DBU --> DBU_P4[切割软刀 Dicing Blade]
    DBU --> DBU_P5[多孔陶瓷真空吸盘]
    DBU --> DBU_P6[PCD / SCD / PcBN 超精密刀具]

    ABU["**ABU 砂轮事业部**<br/>(鹰歌厂)<br/>客户：机械 / 工具机<br/>2024 占营收 12% / NT$8.1 亿<br/>2025H1 含子公司占 22%"]
    ABU --> ABU_P1[传统陶瓷砂轮]
    ABU --> ABU_P2[钻石 / CBN 树脂砂轮]
    ABU --> ABU_P3[蜂巢砂轮 SiC 用]
    ABU --> ABU_P4[鑽石滚轮 Diamond Roller]

    SUBS["**4 家研磨子公司**<br/>2024 占合并营收 6%"]
    SUBS --> S1[鸿记工业<br/>台湾 / 电铸砂轮]
    SUBS --> S2[KTC<br/>泰国 / 树脂 + 陶瓷砂轮]
    SUBS --> S3["MKS 2025/4 并入<br/>日本 / 中大型精密砂轮"]
    SUBS --> S4["MGT 2025/4 并入<br/>泰国 / 无心磨 + 双平面磨"]
```
...
![中砂事业部别营收对比](../../charts/kinik_segment_mix.png)
...
![钻石碟先进制程占比走势](../../charts/kinik_advanced_node.png)
...
![钻石碟月产能扩张轨迹](../../charts/kinik_capacity_ramp.png)
...
```mermaid
pie title 中砂 2024 营收客户集中度估算 (基于 36.99% 单一最大客户披露)
    "单一最大客户 (推断 TSMC)" : 36.99
    "其他前 5 大客户 (推断 Micron / Intel / Samsung / UMC 等)" : 28.0
    "其他半导体客户" : 17.0
    "ABU 机械 / 汽车 / 工具机客户" : 18.01
```
...
![中砂单季 EPS 走势 1Q23–1Q26](../../charts/kinik_eps_trend.png)
...
```mermaid
graph LR
    A[2024 营收<br/>NT$70.2 亿] --> B[2025 营收<br/>NT$81.5 亿 +16%]
    B --> C[2026E 营收<br/>NT$95–105 亿 +17–29%]
    C --> D[2028E 营收<br/>NT$130–160 亿]
    D --> E[2030E 营收<br/>NT$180–220 亿]

    style A fill:#a6c8ff
    style B fill:#a6c8ff
    style C fill:#3a78c2,color:#fff
    style D fill:#0c3a72,color:#fff
    style E fill:#062349,color:#fff
```
