...
```mermaid
timeline
    title Corning Incorporated 关键里程碑 (1851–2026)
    1851 : 公司由 Amory Houghton 在马萨诸塞州 Somerville 成立
    1868 : 迁至纽约州 Corning 镇
    1879 : 为爱迪生生产白炽灯泡玻璃外壳
    1908 : 发明 Pyrex® 耐热玻璃 (借硼硅技术)
    1934 : 与欧文斯-伊利诺斯合资成立 Owens-Corning
    1947 : 与 PPG 合资 Pittsburgh Corning (后剥离)
    1970 : 发明世界首根低损耗光纤 (low-loss optical fiber)
    1989 : 更名 Corning Incorporated, 业务扩至消费电子+光通信
    2007 : 发布 Gorilla® Glass — iPhone 一代盖板玻璃供应
    2018 : 上线 Gen 10.5 显示玻璃产线 (合肥)
    2020 : 启动 Vascade® EX3000 海底光纤新品
    2024 : 启动 Springboard 三年成长计划 (USD +3 bn 年化目标)
    2025 : Springboard 升级到 USD +4 bn 年化目标 (March 2025)
    2026 : Meta 多年 USD 6 bn 框架协议 (Jan); NVIDIA 美国制造扩 10× 战略合作 (May); Springboard 升级到 USD 6.5 bn 年化目标
```
...
```mermaid
graph TD
    Core[玻璃熔融<br>+ 表面处理<br>+ 精密制造] --> OC[光通信<br>Optical Communications<br>USD 6.27 bn]
    Core --> DP[显示玻璃<br>Display<br>USD 3.70 bn]
    Core --> SM[特种材料<br>Gorilla + 半导体载体<br>USD 2.21 bn]
    Core --> Auto[汽车环保+玻璃<br>Automotive<br>USD 1.79 bn]
    Core --> LS[生命科学<br>Life Sciences<br>USD 0.97 bn]
    Core --> HSG[多晶硅 HSG<br>+新兴增长<br>USD 1.46 bn]
    OC --> AI[AI 数据中心<br>Meta + NVIDIA + Apple]
    SM --> AP[半导体先进封装<br>TSMC CoWoS + Intel 18A]
    DP --> CN[中国显示<br>BOE + CSOT + LG Display]
```
...
```mermaid
pie title FY2025 可报告段销售构成 (USD 14.948 bn 总计, "% of reportable-segment net sales")
    "Optical Communications" : 42.0
    "Display" : 24.7
    "Specialty Materials" : 14.8
    "Automotive" : 12.0
    "Life Sciences" : 6.5
```
