...
```mermaid
timeline
    title 优必选 (9880.HK) 关键里程碑
    2012 : 周剑于深圳创立优必选，押注伺服驱动器国产化
    2015 : 推出 Alpha 1 消费级人形机器人
    2016 : 540 台 Alpha 登央视春晚；腾讯领投 B 轮
    2018 : 完成 C 轮 8.2 亿美元融资，估值 50 亿美元
    2018 : 发布第一代 Walker 双足人形机器人
    2020 : 进入物流智能机器人赛道 (无人叉车、无人物流车 Chitu 赤兔)
    2023 : 12 月 29 日香港联交所上市 (9880.HK)；"人形机器人第一股"
    2024 : 发布 Walker S1、群脑网络 BrainNet 1.0；进入比亚迪/蔚来/吉利车厂实训
    2025 : Walker S2 量产交付；累计订单破 8 亿元；H1 收入 +27.6% YoY
    2026 : 计划年化产能 5,000 台 Walker (目标 2026)，2027 年扩至 1 万台
```
...
```mermaid
graph TD
  A[优必选 UBTech] --> B[1. 人形机器人 Walker 系列]
  A --> C[2. 教育 & 通用机器人]
  A --> D[3. 物流智能机器人]
  A --> E[4. 行业定制 & 商用服务]
  A --> F[5. 消费级机器人 / 智能硬件]
  ...
  B --> B1[Walker S — 1 代工业]
  B --> B2[Walker S1 — 2024 二代]
  B --> B3[Walker S2 — 2025 三代, 热插拔自主换电]
  B --> B4[天工 Ultra — 北京人形机器人创新中心]

  C --> C1[Alpha 系列 — 教育/消费桌面]
  C --> C2[UGOT 多拟态 AI 教育机器人]
  C --> C3[AperBot M1 轮式教育机器人 + 5 款实训平台]
  C --> C4[CreaBot 多场景服务机器人]
  C --> C5[行知 PaaS 平台 + UDECA 开源软硬件]

  D --> D1[瓦力 F3000 双驱重载无人叉车 3.5t]
  D --> D2[瓦力 T8000 室外牵引机器人 8t]
  D --> D3[Chitu 赤兔 L4 无人物流车]
  D --> D4[ACU 控制器 + UPilot 操作系统]

  E --> E1[商用服务一体式机器人]
  E --> E2[Cadebot 悠宝智能递送机器人]
  E --> E3[智慧康养机器人解决方案 — 优悠等]

  F --> F1[空气萝卜 C20 智能猫砂盆 — 跨境爆品]
  F --> F2[宠物吸毛器/智能冰箱餵食器 F10]
  F --> F3[M10 无边界智能割草机]
  F --> F4[PC10 泳池机器人]
  F --> F5[V10 智能扫地机器人]
```
...
```mermaid
pie title FY2024 收入按客户集中度
    "最大客户 (估算: 头部汽车 OEM)" : 14.4
    "第二至第五大客户" : 19.9
    "其他 (含跨境电商长尾、教育政府)" : 65.7
```
...
quadrantChart
    ...
    quadrant-3 早期低壁垒
    quadrant-4 低壁垒 + 已落地
    "Tesla Optimus": [0.75, 0.95]
    "Figure AI": [0.65, 0.85]
    "Apptronik": [0.62, 0.7]
    "Boston Dynamics Atlas": [0.55, 0.85]
    "Agility Robotics Digit": [0.7, 0.65]
    "1X NEO": [0.4, 0.6]
    "优必选 Walker S2": [0.7, 0.7]
    "Unitree H1/G1": [0.55, 0.4]
    "智元机器人": [0.45, 0.55]
    "傅利叶 GR-2": [0.3, 0.45]
    "银河通用": [0.25, 0.5]
```
