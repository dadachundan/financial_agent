...
![Revenue and gross margin trend](charts/amat_revenue_margin.png)
...
![Peer valuation](charts/amat_peer_valuation.png)
...
![Segment revenue mix](charts/amat_segment_mix.png)
...
timeline
    ...
    2011 : Acquires Varian Semiconductor (ion implant) for $4.9B; Gary Dickerson joins
    2013 : Gary Dickerson becomes CEO
    2014 : Announces Tokyo Electron merger (~$30B)
    2015 : Tokyo Electron merger terminated on US DOJ antitrust review
    2019 : Announces Kokusai Electric acquisition ($2.2B)
    2021 : Kokusai deal terminated on China SAMR non-clearance; $154M breakup fee
    2022 : Revenue crosses $25B (FY22 $25.8B)
    2024 : China revenue peaks at $10.1B (37% of total)
    2025 : EPIC Center opens; revenue $28.4B; Display de-segmented; China revenue declines to $8.5B (30%)
    2026 : Q2 FY26 record $7.9B revenue; >30% semi-equipment growth guided for CY26; ASMPT NEXX (panel-level packaging) acquisition announced
```
...
![Applied Materials Technology Portfolio — verbatim slide from 10-K Item 1 Business](charts/amat_10k_products_table.jpg)
...
```mermaid
graph LR
  A[Deposition<br/>PVD · CVD · ALD · Epi · Plating<br/><i>Applied</i>] --> B[Lithography exposure<br/><i>ASML — not Applied</i>]
  B --> C[Etch · Shape & remove<br/>Sym3 · Centura · selective removal<br/><i>Applied</i>]
  C --> D[Clean · Selective removal<br/><i>Applied / SCREEN / TEL</i>]
  D --> E[Modify · Implant · Thermal · Treatments<br/>VIISta · Vantage<br/><i>Applied</i>]
  E --> F[Process control · Optical · eBeam · CD-SEM<br/>SEMVision · PROVision<br/><i>Applied / KLA</i>]
  F --> A
  C --> G[Advanced packaging<br/>Hybrid bonding · panel-level PVD<br/><i>Applied — ASMPT NEXX</i>]
```
...
![AGS revenue and margin](charts/amat_ags_trend.png)
...
![Backlog](charts/amat_backlog.png)
...
![Quarterly revenue](charts/amat_quarterly_rev.png)
...
```mermaid
pie title FY2025 net revenue concentration (top-2 = 34%, disclosed; names are widely-reported industry attributions)
    "Top customer (19%, likely TSMC)" : 19
    "#2 customer (15%, likely Samsung)" : 15
    "All others (66%)" : 66
```
...
![China exposure](charts/amat_china_exposure.png)
...
```mermaid
quadrantChart
    title WFE peer positioning — breadth vs. terminal margin
    x-axis Narrow portfolio --> Broad portfolio
    y-axis Lower margin --> Higher margin
    quadrant-1 Broad, high margin
    quadrant-2 Narrow, high margin
    quadrant-3 Narrow, low margin
    quadrant-4 Broad, low margin
    AMAT: [0.85, 0.55]
    ASML: [0.35, 0.85]
    LRCX: [0.55, 0.70]
    KLAC: [0.40, 0.95]
...
![Cash flow and capital return](charts/amat_cashflow.png)
