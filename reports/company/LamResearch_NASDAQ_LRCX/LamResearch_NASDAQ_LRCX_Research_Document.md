...
```mermaid
graph TD
    LAM[Lam Research] --> DEP[Deposition]
    LAM --> ETCH[Etch]
    LAM --> CLEAN[Clean]
    LAM --> CSBG[Customer Support Business Group / CSBG]
    DEP --> ECD[ECD - Copper plating - SABRE® / SABRE® 3D]
    DEP --> WCVD[Tungsten/Moly CVD/ALD - ALTUS® / ALTUS® Halo]
    DEP --> PECVD[PECVD - VECTOR® / Striker®]
    DEP --> HDPCVD[HDP-CVD gapfill - SPEED®]
    ETCH --> COND[Conductor Etch - Kiyo® / Versys® Metal / Akara®]
    ETCH --> DIEL[Dielectric Etch - Flex® / Vantex®]
    ETCH --> TSV[TSV Deep RIE - Syndion®]
    ETCH --> CRYO[Cryogenic etch - Cryo® 3.0 for 3D NAND channel hole]
    CLEAN --> WET[Wet Clean - EOS® / DV-Prime® / Da Vinci® / SP Series]
    CLEAN --> BEVEL[Bevel & post-etch dry plasma clean - Coronus®]
    CSBG --> SERV[Service, spares, EI software]
    CSBG --> UPG[Upgrades / refurb]
    CSBG --> RELIANT[Reliant® refurbished non-leading-edge equipment]
```

### 4.1 Deposition (~35–40% of Systems revenue — *analyst estimate; Lam does not disclose revenue by process category in the 10-K*)

Per the 10-K's Competition section, Lam's primary competitor in the dielectric and metals deposition market is **Applied Materials**; for ALD and PECVD specifically the 10-K also names **ASM International** and **Wonik IPS** ([2025 10-K — Competition](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)). The 10-K does not publish product-vs-product comparisons or share rankings; the assessments below are the analyst's view based on industry observation, not Lam disclosure.

**Electrochemical deposition (ECD) — SABRE® / SABRE® 3D family.** Lam's copper-plating platform is used for dual-damascene copper interconnect in logic and DRAM and for wafer-level packaging (WLP), fan-out, and HBM through-silicon via (TSV) fill via the SABRE 3D platform ([2025 10-K — SABRE Product Family description](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)). *Analyst view:* Lam has been widely regarded as the leading single-wafer dual-damascene Cu ECD supplier for two decades; process-of-record qualification on a leading-edge node typically takes 12–18 months, which makes switching costs high. Applied Materials (with the NOKOTA / Raider ECD platforms) and Ebara are the nearest external competitors in this niche; for advanced packaging the SABRE 3D installed base appears particularly entrenched.

**Tungsten / Molybdenum CVD-ALD — ALTUS® / ALTUS® Halo family.** The 10-K describes ALTUS as combining CVD and ALD technologies to deposit highly conformal or selective films for advanced tungsten or molybdenum metallization (ALTUS Halo) in both logic and memory, using a Multi-Station Sequential Deposition architecture ([2025 10-K — ALTUS Product Family](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)). ALTUS Halo, launched February 2025, is Lam's first high-volume ALD tool designed for molybdenum metallization and is claimed to deliver a 50%+ reduction in word-line resistance vs. tungsten; Micron has been cited by Lam as an early adopter in advanced NAND ([Lam Research — Ushers in New Era with ALTUS® Halo, 2025-02-19](https://newsroom.lamresearch.com/2025-02-19-Lam-Research-Ushers-in-New-Era-of-Semiconductor-Metallization-with-ALTUS-R-Halo-for-Molybdenum-Atomic-Layer-Deposition)). *Analyst view:* AMAT competes with the Endura W platform; the early molybdenum-fill ramp is a key incremental opportunity for Lam through the >300-layer NAND roadmap.

**PECVD — VECTOR® / Striker® family.** Plasma-enhanced CVD for dielectric films, including interlayer dielectric and high-aspect-ratio gapfill applications ([2025 10-K — Products](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)). *Analyst view:* AMAT's Producer platform is the principal external competitor for many PECVD applications; relative positioning varies by film stack and customer.

**HDP-CVD — SPEED® family.** High-density plasma CVD for legacy gapfill — gradually displaced by ALD at the most advanced nodes but still high-volume in mature flows ([2025 10-K — Products](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)).

**ALD (specialised).** Lam runs ALD across multiple tool platforms (ALTUS, Striker) and is developing a dry-photoresist solution (Aether®) jointly with ASML and IMEC for EUV / high-NA EUV lithography ([Lam Research — Entegris/Gelest dry resist ecosystem, 2022-07-12](https://newsroom.lamresearch.com/2022-07-12-Lam-Research,-Entegris,-Gelest-Team-Up-to-Advance-EUV-Dry-Resist-Technology-Ecosystem); SK hynix qualified Lam's dry resist for advanced DRAM in mid-2022 — [Lam Research / SK hynix press release](https://www.prnewswire.com/news-releases/lam-research-teams-up-with-sk-hynix-to-enhance-dram-production-cost-efficiency-with-breakthrough-dry-resist-euv-technology-301567359.html)). Per the 10-K Competition section the ALD/PECVD competitor set explicitly includes **ASM International** and **Wonik IPS** in addition to AMAT.

### 4.2 Etch (~45–50% of Systems revenue — *analyst estimate; Lam does not disclose revenue by process category*)

Per the 10-K's Competition section, Lam's primary etch competitors are **Applied Materials, Hitachi Ltd., and Tokyo Electron** ([2025 10-K — Competition](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)). The 10-K does not publish product-vs-product comparisons or share rankings.

**Conductor etch — Kiyo® / Versys® Metal / Akara® families.** Removes silicon, polysilicon, and metal materials with atomic precision. Critical applications include gate-all-around (GAA) selective etch for sub-3nm logic nodes (TSMC N2, Samsung SF2, Intel 18A/14A) — GAA nanosheet construction requires precision lateral etch steps not present in FinFET. Lam's newest conductor-etch platform **Akara®** launched in February 2025 as, per Lam, "the most advanced conductor etch tool available," built on the Sense.i®/DirectDrive® platform and targeting GAA logic, 4F² DRAM, CFET, and 3D DRAM applications ([Lam Research — Unveils Akara® Conductor Etch, 2025-02-19](https://investor.lamresearch.com/2025-02-19-Lam-Research-Unveils-Industrys-Most-Advanced-Conductor-Etch-Technology-to-Date); [Akara® — A Generational Leap in Semiconductor Etch](https://newsroom.lamresearch.com/everything-about-akara); [2025 10-K — Products](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)). *Analyst view:* among the 10-K-named etch competitors, Tokyo Electron is generally regarded as the most direct competitor in advanced conductor etch ([TEL FY2025 Q4 results presentation, 2025-05](https://www.tel.com/ir/library/report/l8gqgo00000000gl-att/fy25q4presentations-e.pdf)).

**Dielectric etch — Flex® / Vantex® families.** Per the 10-K, the Flex family offers differentiated technologies for critical dielectric etch applications enabled by a multi-frequency confined-plasma design, and the Vantex family is Lam's latest dielectric etch system for high-aspect-ratio device features such as deep holes and trenches in leading-edge memory ([2025 10-K — Flex / Vantex Product Family description](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)). These tools are used to drill channel holes in 3D NAND that now exceed **400 layers in advanced devices and target ~1,000 layers by 2030** ([Lam Research — The Road to 1000 Layer 3D NAND](https://newsroom.lamresearch.com/road-1000-layer-3D-NAND); [TrendForce — Samsung targets 1,000-layer NAND by 2030, 2025-02-26](https://www.trendforce.com/news/2025/02/26/news-samsung-reportedly-targets-1000-layer-nand-by-2030-rolls-out-wafer-bonding-at-400-layers/)). Lam's Cryo® 3.0 cryogenic-etch upgrade (announced July 2024) etches channels >10µm deep at <0.1% critical-dimension deviation and 2.5× faster than prior generations ([Lam Research — Introduces Lam Cryo™ 3.0, 2024-07-31](https://newsroom.lamresearch.com/2024-07-31-Lam-Research-Introduces-Lam-Cryo-TM-3-0-Cryogenic-Etch-Technology-to-Accelerate-Scaling-of-3D-NAND-for-the-AI-Era)). *Analyst view:* Tokyo Electron has developed its own cryogenic dielectric etch for 400+ layer NAND, positioning itself as the most direct competitor at the leading-edge channel-hole node ([TechPowerUp — TEL channel-hole etch for 400-layer NAND](https://www.techpowerup.com/309892/tokyo-electron-develops-memory-channel-hole-etching-for-400-layer-3d-nand-flash)).

**Through-silicon via (TSV) etch — Syndion®.** Deep reactive-ion etch for 3D packaging — relevant for HBM and chiplet integration ([Lam Research — Etch processes](https://www.lamresearch.com/products/our-processes/etch/)). *Analyst view:* third-party reporting indicates Lam is a primary supplier of TSV etch for HBM at Samsung and SK hynix, although neither Lam nor the customers separately disclose tool-by-tool sourcing ([iNEWS — Lam supplies TSV for HBM, 2025](https://inf.news/en/tech/93e514891b03af13b5df9e4ea8305fb8.html)).

### 4.3 Clean (~10–15% of Systems revenue — *analyst estimate; not separately disclosed in the 10-K*)

Per the 10-K's Competition section, Lam's primary wet-clean competitors are **Screen Holdings Co. Ltd., SEMES Co. Ltd., and Tokyo Electron Ltd.** ([2025 10-K — Competition](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)).

**Wet single-wafer clean — EOS®, DV-Prime®, Da Vinci®, SP Series.** Removes residues after etch/CMP and prepares wafer surfaces for next-step deposition; particle counts are increasingly yield-limiting at advanced nodes ([2025 10-K — Products](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)). *Analyst view:* among the 10-K-disclosed wet-clean competitor set, **Screen Holdings (Japan)** is widely regarded as the global market leader, with Lam generally considered #2 globally by share but with stronger relative positioning at U.S. and Korean customers ([SCREEN Holdings — Investor Relations](https://www.screen.co.jp/en/ir)).

**Bevel / dry plasma clean — Coronus® family.** Cleans the wafer edge and removes contamination after etch — a smaller-volume, higher-margin niche ([2025 10-K — Products](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)).
...
**Market size.** Industry consultancy **Gartner** estimates total 2025 WFE spending was **~$118B**, growing toward **$133B (2026)** and **$151B (2027)** as 300mm fab spending posts double-digit growth ([SEMI — Global 300mm Fab Equipment Spending press release, 2025-12](https://www.semi.org/en/semi-press-release/semi-projects-double-digit-growth-in-global-300mm-fab-equipment-spending-for-2026-and-2027); [SEMI World Fab Forecast](https://www.semi.org/en/products-services/market-data/world-fab-forecast)). Of total WFE, deposition+etch+clean (Lam's served market) is roughly **45-50% of WFE**, putting Lam's served available market (SAM) at approximately **$55-60B in 2025** — implying Lam captured around **30%+ share of its SAM** in FY2025 (built on [2025 10-K revenue of $18.4B](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm) and SEMI WFE size).
...
**Industry structure (oligopoly).** WFE is one of the most consolidated industries in capital goods. **Top-5 vendors — Applied Materials, ASML, Lam Research, Tokyo Electron (TEL), and KLA — together account for ~70-75% of WFE spend** ([AMAT FY2024 10-K](https://www.sec.gov/Archives/edgar/data/0000006951/000000695124000044/0000006951-24-000044-index.htm); [KLA FY2025 10-K](https://www.sec.gov/Archives/edgar/data/0000319201/000031920125000024/0000319201-25-000024-index.htm); [ASML 2025 20-F](https://www.sec.gov/Archives/edgar/data/0000937966/000093796625000009/0000937966-25-000009-index.htm); [TEL — FY2025 Q4 Presentation](https://www.tel.com/ir/library/report/l8gqgo00000000gl-att/fy25q4presentations-e.pdf)). Within Lam's etch/deposition/clean SAM, Lam and AMAT typically each take 30-40% of segment revenue; TEL and SCREEN account for most of the remainder; smaller niche players (Hitachi High-Tech, Plasma-Therm) take low single-digit share. **Barriers to entry are extreme**: process-of-record qualification cycles are 12-24 months, each leading-edge customer co-develops over many years, IP libraries are deep, and the capital cost of building competitive R&D (Lam spends >$2B/yr on R&D, 11% of revenue, per [2025 10-K MD&A](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)) is prohibitive for new entrants. Chinese tool makers (NAURA, AMEC) have grown share in trailing-edge etch and deposition but remain absent from leading-edge logic and DRAM, with the gap widening at sub-5nm ([TrendForce — Chinese Semi Equipment Makers Set New Records, 2025-01-23](https://www.trendforce.com/news/2025/01/23/news-chinese-semiconductor-equipment-manufacturers-set-new-records/)).
...
4. **KLA Corporation (KLAC, NASDAQ).** Metrology/inspection leader (>50% global share) ([KLA FY2025 10-K](https://www.sec.gov/Archives/edgar/data/0000319201/000031920125000024/0000319201-25-000024-index.htm)). No direct etch/dep overlap, but a peer for "AI-WFE pick" trading. KLAC's TTM multiples are very similar to Lam's ([Yahoo Finance — KLAC](https://finance.yahoo.com/quote/KLAC/key-statistics/)), supporting the thesis that the market prices the top-3 U.S. semicap names in a similar "AI-infra" multiple band.
...
**TAM sizing.** As noted in Section 6, total WFE was approximately **$118B in 2025** (Gartner / SEMI estimates), of which Lam's served market in **deposition + etch + clean** is approximately **$55-60B** (~45-50% of WFE) ([SEMI — Global Fab Equipment Investment 2025](https://www.semi.org/en/semi-press-release/global-fab-equipment-investment-expected-to-reach-110-billion-dollar-in-2025)). With Lam's FY2025 revenue of **$18.4B**, implied share is **~31-33%** of SAM ([2025 10-K — Results of Operations](https://www.sec.gov/Archives/edgar/data/707549/000070754925000075/lrcx-20250629.htm)).

**TAM growth.** **SEMI's World Fab Forecast** projects 300mm WFE to reach **$133B in 2026** (+18%) and **$151B in 2027** (+14%) — a clearly double-digit growth trajectory ([SEMI — Double-Digit Growth in Global 300mm Fab Equipment Spending, 2025-12](https://www.semi.org/en/semi-press-release/semi-projects-double-digit-growth-in-global-300mm-fab-equipment-spending-for-2026-and-2027); [SEMI — $156B Semi Equipment Sales 2027](https://www.semi.org/en/semi-press-release/global-semiconductor-equipment-sales-projected-to-reach-a-record-of-156-billion-dollars-in-2027-semi-reports)). Of this growth, three subsectors disproportionately benefit Lam:
