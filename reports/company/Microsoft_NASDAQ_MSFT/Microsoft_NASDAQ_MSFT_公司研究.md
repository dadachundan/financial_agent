...
```mermaid
timeline
    title Microsoft 重要里程碑
    1975 : Gates 与 Allen 创立 Microsoft, 为 Altair 8800 销售 BASIC
    1980 : IBM PC 授权 MS-DOS; Microsoft 保留向兼容机厂商授权权利
    1986 : 以每股 21 美元 IPO; 总部迁至华盛顿州雷德蒙德
    1990 : Windows 3.0 发布; PC 平台标准奠定
    1995 : Windows 95 + Office 捆绑; Internet Explorer 出货
    2001 : Xbox 发布, 进入主机游戏市场
    2014 : Satya Nadella 出任 CEO; 提出"云优先, 移动优先"
    2016 : 以 262 亿美元收购 LinkedIn
    2018 : 以 75 亿美元收购 GitHub
    2019-23 : 与 OpenAI 三阶段战略合作及资本承诺 (累计 130 亿美元)
    2022 : 以 197 亿美元收购 Nuance
    2023-10 : 以 687 亿美元完成对 Activision Blizzard 的收购
    2024-08 : 反映 M365 商业重组的业务分部重述
    2025-10 : OpenAI 重组为公共利益公司 (PBC); Microsoft 按转股基础持股约 27%, 价值约 1,350 亿美元
    2026-Q3 : AI 业务年化运行率突破 370 亿美元; Azure 同比 +40%; Copilot 席位破 2,000 万
```
...
graph TD
    MSFT[Microsoft Corp.]
    MSFT --> PBP[生产力与业务流程<br/>FY2025 营收 1,208 亿美元]
    MSFT --> IC[智能云<br/>FY2025 营收 1,063 亿美元]
    MSFT --> MPC[更具个人化的计算<br/>FY2025 营收 546 亿美元]

    PBP --> M365C[Microsoft 365 商业版<br/>云 + 本地部署]
    PBP --> M365K[Microsoft 365 消费版<br/>含 Copilot]
    PBP --> LI[LinkedIn]
    PBP --> DYN[Dynamics 365 + Power Platform]

    M365C --> M365E5[E3 / E5 / F1 / F3]
    M365C --> CopilotM365[M365 Copilot]
    M365C --> Teams[Teams Phone / Premium]

    IC --> Azure[Azure 及其他云服务<br/>云 + AI 消费]
    IC --> Server[服务器产品<br/>SQL Server, Win Server]
    IC --> EnterprSvc[企业与合作伙伴服务]
    IC --> GH[GitHub 云]
    IC --> Nuance[Nuance 医疗 AI]

    Azure --> AzureAI[Azure OpenAI / AI Foundry]
    Azure --> AzureCore[计算 / 存储 / 网络]
    Azure --> AzureData[Fabric / Synapse / Cosmos]
    Azure --> Sec[Defender / Sentinel / Entra]

    MPC --> WinDev[Windows OEM + 设备]
    MPC --> Gaming[游戏<br/>Xbox + Activision Blizzard]
    MPC --> Search[搜索与新闻广告]

    WinDev --> Win[Windows 操作系统]
    WinDev --> Surface[Surface 设备]
    Gaming --> Xbox[Xbox 主机 + Game Pass]
    Gaming --> ATVI[Activision 标题<br/>使命召唤、魔兽世界、暗黑破坏神、糖果传奇]
```
...
```mermaid
xychart-beta
    title "Microsoft 核心 TAM 桶: 2024 vs 2028E (十亿美元)"
    x-axis ["公有云", "生成式AI", "生产力/协作", "CRM+ERP", "安全软件"]
    y-axis "市场规模 (十亿美元)" 0 --> 1400
    bar [675, 235, 280, 190, 210]
    bar [1260, 632, 430, 310, 315]
```
