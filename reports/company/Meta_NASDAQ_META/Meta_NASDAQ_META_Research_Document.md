...
```mermaid
timeline
    title Meta Platforms — Selected Milestones
    2004 : Facebook founded at Harvard by Mark Zuckerberg and co-founders
    2006 : Opens to general public (13+ with email)
    2012 : IPO on NASDAQ (May 18); acquires Instagram (~$1B); reaches 1B users
    2014 : Acquires WhatsApp (~$19B) and Oculus VR (~$2B)
    2018 : Cambridge Analytica scandal; record FTC complaint
    2019 : $5B FTC privacy settlement and modified consent order
    2021 : Renamed "Meta Platforms"; Reality Labs broken out as segment
    2022 : "Year of Efficiency"; first major layoffs (~21,000 across 2022–2023)
    2023 : Launches Threads (July) — fastest app to 100M users
    2024 : Llama 3 release; Ray-Ban Meta AI glasses scale
    2025 : Llama 4 release; $14.3B Scale AI investment; FTC antitrust ruling in Meta's favor (Nov 18); $30B debt issuance; Meta Superintelligence Labs formed
    2026 : Capex guide $115–135B; "less personalised ads" rolls out in EU
```
...
graph TD
  ...
  Meta --> AI[Meta AI + Llama foundation models]
  FoA --> FB[Facebook]
  FoA --> IG[Instagram]
  FoA --> MSG[Messenger]
  FoA --> WA[WhatsApp]
  FoA --> TH[Threads]
  FoA --> MV[Meta Verified subscription]
  RL --> VR[Meta Quest VR headsets]
  RL --> GLASS[Ray-Ban & Oakley Meta AI glasses]
  RL --> DISPLAY[Meta Ray-Ban Display + Neural Band]
  RL --> AR[Orion AR prototype + future AR glasses]
  AI --> LLAMA[Llama 3 / 4 open-weight models]
  AI --> SUPER[Meta Superintelligence Labs]
  AI --> METAAI[Meta AI assistant in apps]
```
...
```mermaid
pie title Estimated FY2025 advertiser-base composition (illustrative)
  "Long-tail SMB direct response" : 55
  "Mid-market & ecommerce" : 25
  "Global brands (top 100)" : 15
  "Other (Verified, payments, RL hardware)" : 5
```
...
```mermaid
quadrantChart
  title Competitor map — ad-business scale × AI/model leadership (May 2026)
  x-axis Smaller ad business --> Larger ad business
  y-axis Behind on AI --> Leading on AI
  quadrant-1 "Leaders"
  quadrant-2 "AI-led challengers"
  quadrant-3 "Niche / declining"
  quadrant-4 "Ad scale, AI followers"
  Meta: [0.9, 0.7]
  Alphabet: [0.95, 0.85]
  Amazon: [0.65, 0.5]
  ByteDance / TikTok: [0.55, 0.5]
  Apple: [0.45, 0.45]
  Microsoft: [0.45, 0.75]
  OpenAI: [0.1, 0.95]
  Anthropic: [0.05, 0.85]
