...
![Materion FY2021-2025 收入、增值销售与毛利率走势](charts/materion_revenue_gm_trend.png)
...
![Materion vs. 先进材料同业 — TTM 估值（2026 年 5 月）](charts/materion_peer_valuation.png)
...
graph TD
  ...
  M --> O[Other 公司层面]
  PM --> PM1[Advanced Alloys<br/>铜铍合金、铍氢氧化物<br/>铍金属与氧化铍]
  PM --> PM2[Specialty Materials<br/>精密带、棒、线<br/>复合包覆 / 叠层金属系统]
  PM --> PM3[Performance Solutions<br/>近净成形铍部件<br/>ToughMet, SupremEX, BeO 陶瓷]
  EM --> EM1[气相沉积靶<br/>Au/Ag/Pt/Pd/Ru/Cu/Co/Ni/Mo/Ta/Nb/W/Ti]
  EM --> EM2[微电子封装<br/>框架盖组件、钎焊、预制件]
  EM --> EM3[先进化学品<br/>ALD/CVD 前驱体]
  EM --> EM4[金属回收与精炼<br/>贵金属闭环]
  PO --> PO1[薄膜光学涂层<br/>光学滤光片与组件]
```
