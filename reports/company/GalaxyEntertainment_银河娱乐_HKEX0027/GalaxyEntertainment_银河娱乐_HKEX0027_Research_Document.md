...
```mermaid
xychart-beta
    title "GEG Revenue and Adjusted EBITDA (HK$ bn) — Five-Year View"
    x-axis [2021, 2022, 2023, 2024, 2025]
    y-axis "HK$ bn" 0 --> 55
    bar [19.7, 11.5, 35.7, 43.4, 49.2]
    line [3.1, -0.6, 10.0, 12.2, 14.5]
```
...
```mermaid
timeline
    title GEG — Key Milestones (1988–2026)
    1988 : K. Wah Construction Materials listed on HKEX
    2002 : Macau ends STDM monopoly; awards Galaxy original concession
    2005 : K. Wah acquires 97.9% of Galaxy Casino S.A.; sub-concession sold to MGM/Pansy Ho
    2006 : StarWorld Hotel opens on Macau Peninsula
    2011 : Galaxy Macau Phase 1 opens (May) on 1.1m sqm Cotai parcel
    2015 : Galaxy Macau Phase 2 opens; strategic investment in Monte-Carlo SBM (July)
    2020 : Withdraws from Osaka IR bid; COVID closes Macau casinos (February)
    2022 : New 10-year concession granted (16 December); valid 2023–2032
    2023 : Phase 3 opens — GICC, 16,000-seat Galaxy Arena, Raffles, Andaz Macau
    2025 : Capella at Galaxy Macau soft-launched (May); 350+ events at Arena/GICC
    2026 : Capella officially opens (Feb); Q1 NPAS up double-digits; Phase 4 fitting-out
```
...
```mermaid
pie title GEG FY2025 Revenue Mix (HK$49.2 bn consolidated)
    "Net Gaming" : 39.6
    "Hotels / F&B / Mall / Others" : 6.6
...
```mermaid
graph TD
    GEG[Galaxy Entertainment Group HKEX 27]
    GEG --> GE[Gaming & Entertainment]
    GEG --> CMD[Construction Materials Division]
    GE --> GM[Galaxy Macau Cotai]
    GE --> SW[StarWorld Hotel Peninsula]
    GE --> BR[Broadway Macau Cotai]
    GE --> CC[City Clubs Peninsula]
    GM --> GMH[9 hotels, 5,000 rooms]
    GM --> GMP[Galaxy Promenade luxury mall]
    GM --> GMA[16,000-seat Galaxy Arena]
    GM --> GIC[Galaxy International Convention Center]
    CMD --> HK[Hong Kong sites]
    CMD --> MA[Macau sites]
    CMD --> CN[Mainland China sites]
```
...
```mermaid
pie title 2025 Macau Visitor Arrivals (40.1 million, GEG-cited DSEC/MGTO data)
    "Mainland China — Greater Bay Area (9 PRD cities)" : 14.8
    "Mainland China — non-GBA" : 14.2
    "Hong Kong / Taiwan / Macau resident return" : 8.3
    "International (Korea, Japan, Thailand, etc.)" : 2.8
```
...
```mermaid
xychart-beta
    title "Macau GGR Trajectory (HK$ bn, full year)"
    x-axis [2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026E]
    y-axis "HK$ bn" 0 --> 300
    bar [283, 60, 87, 42, 184, 220, 240, 270]
```
...
```mermaid
quadrantChart
    title Macau IR Competitive Positioning — Premium-mass vs. Mass-market footprint
    x-axis "Mass-market depth (rooms × catchment)" --> "Premium-mass focus"
    y-axis "Smaller balance sheet" --> "Larger balance sheet"
    quadrant-1 "Premium-mass + strong balance sheet"
    quadrant-2 "Mass-market + strong balance sheet"
    quadrant-3 "Mass-market + leveraged"
    quadrant-4 "Premium-mass + leveraged"
    "Galaxy (0027)": [0.62, 0.92]
    "Sands China (1928)": [0.30, 0.55]
    "Wynn Macau (1128)": [0.85, 0.40]
    "MGM China (2282)": [0.55, 0.55]
    "SJM (0880)": [0.20, 0.30]
    "Melco (0200)": [0.50, 0.35]
```
