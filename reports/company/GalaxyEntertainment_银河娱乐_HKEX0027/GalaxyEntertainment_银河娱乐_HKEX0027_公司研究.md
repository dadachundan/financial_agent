...
```mermaid
timeline
    title 银娱关键里程碑（1988–2026）
    1988 : 嘉华建材 K. Wah Construction Materials 在港交所上市
    2002 : 澳门终结 STDM 垄断，授予银娱原始博彩牌照
    2005 : 嘉华完成"蛇吞象"，收购澳门银河 97.9%; sub-concession 转让 MGM / 何超琼
    2006 : StarWorld 星际酒店开业于澳门半岛
    2011 : 澳门银河 Phase 1 开业（5 月），位于 1.1m 平米路氹城地块
    2015 : 澳门银河 Phase 2 开业；战略入股摩纳哥 Monte-Carlo SBM（7 月）
    2020 : 退出大阪 IR 竞标；澳门博彩业 2 月起因 COVID 暂停
    2022 : 新一代 10 年博彩牌照授出（12 月 16 日），有效至 2032 年
    2023 : Phase 3 开业 — GICC、16,000 座 Galaxy Arena、Raffles、Andaz 同步入市
    2025 : Capella at Galaxy Macau 软开业（5 月）；全年 350+ 大型活动
    2026 : Capella 正式开业（2 月）；Q1 NPAS 双位数增长；Phase 4 内装施工中
```
...
```mermaid
pie title 2025 GEG 集团收入结构（HK$49.2 亿，consolidated 合并基础）
    "博彩净收入 Net Gaming" : 39.6
    "酒店 / 餐饮 / 商场 / 其他" : 6.6
    "建材 Construction Materials" : 3.0
```
...
```mermaid
graph TD
    GEG[银河娱乐 GEG HKEX 27]
    GEG --> GE[博彩与娱乐 G&E]
    GEG --> CMD[建材分部 CMD]
    GE --> GM[澳门银河 Galaxy Macau 路氹]
    GE --> SW[星际酒店 StarWorld 半岛]
    GE --> BR[澳门百老汇 Broadway 路氹]
    GE --> CC[卫星 City Clubs 半岛]
    GM --> GMH[9 家酒店 ~5,000 间客房]
    GM --> GMP[Galaxy Promenade 奢侈品商场]
    GM --> GMA[16,000 座 Galaxy Arena 综艺馆]
    GM --> GIC[Galaxy International Convention Center GICC]
    CMD --> HK[香港业务]
    CMD --> MA[澳门业务]
    CMD --> CN[中国大陆业务]
```
...
```mermaid
pie title 2025 澳门访客来源结构（4,010 万人次，GEG-引用 DSEC/MGTO 数据）
    "中国大陆 — 大湾区 (9 个珠三角城市)" : 14.8
    "中国大陆 — 非大湾区" : 14.2
    "香港 / 台湾 / 澳门居民回访" : 8.3
    "国际 (韩国、日本、泰国等)" : 2.8
```
...
```mermaid
quadrantChart
    title 澳门 IR 竞争定位 — premium-mass vs. mass-market 覆盖
    x-axis "mass-market 覆盖 (rooms × 客源)" --> "premium-mass 聚焦"
    y-axis "资产负债表较弱" --> "资产负债表较强"
    quadrant-1 "Premium-mass + 强资产负债"
    quadrant-2 "Mass-market + 强资产负债"
    quadrant-3 "Mass-market + 高杠杆"
    quadrant-4 "Premium-mass + 高杠杆"
    "银娱 (0027)": [0.62, 0.92]
    "金沙中国 (1928)": [0.30, 0.55]
    "永利澳门 (1128)": [0.85, 0.40]
    "美高梅中国 (2282)": [0.55, 0.55]
    "澳博 (0880)": [0.20, 0.30]
    "新濠 (0200)": [0.50, 0.35]
```
...
```mermaid
xychart-beta
    title "澳门 GGR 恢复轨迹（HK$ 亿）vs 2019 峰值"
