...
```mermaid
xychart-beta
    title "Stryker 营收与 operating margin 趋势（FY2021–FY2025） — 稳健复利、利润率扩张"
    x-axis [FY21, FY22, FY23, FY24, FY25]
    y-axis "净营收 (US$ bn)" 0 --> 30
    bar [17.1, 18.4, 20.5, 22.6, 25.1]
    line [13.6, 13.5, 19.0, 16.3, 19.5]
```
...
公司指引列引自 [Stryker Q1-2026 8-K 2026 Outlook, 2026-04-30](https://www.sec.gov/Archives/edgar/data/0000310764/000031076426000025/sykex991earningsq12026.htm)；consensus 列为 `*分析师观点：*`——本地 zsxq 库的投行 note 普遍认可 SYK 指引、并将其列为板块 Top Pick（[Citi — US MedTech 1Q26 Recap, 2026-05-28, p.1](http://xs-macbook-air.local:5001/zsxq/pdf-viewer/212485545248851/CITI-US%20MedTech%201Q26%20Recap%EF%BC%9A%20The%20%22Good%E2%80%9D%20Didn%E2%80%99t%20Stick%20and%20the%20%22Bad%E2%80%9D%20was%20Terrible-260528.pdf#page=1)），但 note 中并未给出 SYK 的具体逐项 consensus 数字，故此处以"约"标注、不伪造精确街道数字；分析师自身预测列与公司指引中点对齐。
...
```mermaid
xychart-beta
    title "Forward P/E 对标 — SYK 居成长溢价中位（FY1 forward P/E, ~2026-06）"
    x-axis [ZBH, MDT, BSX, SYK, ISRG]
    y-axis "Forward P/E (x)" 0 --> 45
    bar [10.6, 13.6, 14.2, 19.3, 39.3]
```
...
timeline
    title Stryker 关键里程碑
    1941 : Dr. Homer H. Stryker 创立业务前身（医生发明工坊）
    1946 : 在 Michigan 注册成立 Stryker Corporation
    2013 : 以约 US$17 亿收购 Mako Surgical — 进入骨科手术机器人
    2016 : Mako 总膝（Total Knee）应用获 FDA 510(k)，razor-and-blade 飞轮启动
    2024 : Spine 业务计提 US$456m 商誉减值并将 Spinal Implants 划归待售
    2025 : 收购 Inari Medical（静脉血栓栓塞，US$4.9bn 总对价）；推出 Mako 4 平台
    2026 : 3 月遭遇重大网络安全事件；Q1 重组为含 Mako 的 "Ortho Tech" 业务
```
...
```mermaid
graph LR
    A["资本设备<br/>Mako 机器人 / LIFEPAK 35 / 1788 内镜塔"] --> B["一次性器械 + 规划软件<br/>Q-Guidance / 镜头护套 / 电极"]
    B --> C["高毛利植入物 + 耗材<br/>knee/hip implant / Sage / Tornier 肩"]
    C --> D["服务 + 外科医生培训<br/>(switching-cost 护城河)"]
    D -.复购/锁定.-> C
    A -.装机量扩张.-> C
```
...
```mermaid
graph TD
    SYK["Stryker（两个 reportable segment）"]
    SYK --> MS["MedSurg & Neurotechnology<br/>FY25 US$15.6bn · 62%"]
    SYK --> OR["Orthopaedics<br/>FY25 US$9.5bn · 38%"]
    MS --> I["Instruments US$3.2bn"]
    MS --> E["Endoscopy US$3.8bn"]
    MS --> M["Medical US$4.2bn (LIFEPAK/Sage/Vocera)"]
    MS --> V["Vascular US$2.0bn (含 Inari)"]
    MS --> N["Neuro Cranial US$2.5bn"]
    OR --> K["Knees US$2.7bn"]
    OR --> H["Hips US$1.9bn"]
    OR --> T["Trauma & Extremities US$3.9bn"]
    OR --> O["Other US$0.8bn (含 Mako 机器人)"]
    O -.razor-and-blade 带动.-> K
    O -.razor-and-blade 带动.-> H
```
...
```mermaid
xychart-beta
    title "全球手术机器人收入池预测（含系统/耗材/服务，US$ bn）"
    x-axis [2024, 2025, 2030E, 2035E]
    y-axis "收入池 (US$ bn)" 0 --> 55
    line [11.5, 13.7, 27, 46]
```
...
- **中国本土玩家（TINAVI 等）**：在中国市场，本土骨科机器人由 TINAVI（天智航，约 40% 累计中标份额）等主导，Stryker 在中国的渗透远不如其在美国/欧洲的近乎领先地位——这是地域分割的竞争现实（[Goldman Sachs — TINAVI 初评, 2026-05-07, p.1](http://xs-macbook-air.local:5001/zsxq/pdf-viewer/585421451418284/Goldman%20Sachs-Tinavi%20Medical%20%EF%BC%88688277.SS%EF%BC%89%20Orthopedic%20surgical%20robot%20leader%20in%20China%EF%BC%9B%20Awaiting%20clearer%20delivery%20validation%EF%BC%9B%20initiate%20at%20Neutral-260507.pdf#page=1)）。
...
```mermaid
quadrantChart
    title 骨科机器人竞争定位（装机量/临床基数 vs 全球覆盖广度）
    x-axis "全球覆盖窄" --> "全球覆盖广"
    y-axis "临床基数浅" --> "临床基数深"
    quadrant-1 "全球领先"
    quadrant-2 "深基数/区域型"
    quadrant-3 "新进入者"
    quadrant-4 "广覆盖/浅基数"
    "Stryker Mako": [0.85, 0.9]
    "Zimmer ROSA": [0.6, 0.5]
    "Smith+Nephew CORI": [0.5, 0.4]
    "TINAVI(中国)": [0.25, 0.55]
```
*图注：Mako 在装机量/累计临床例数与全球覆盖两个维度均居领先（中国市场除外，由 TINAVI 主导）。来源：基于 [Stryker AAOS 2025 PR](https://www.stryker.com/us/en/about/news/2025/stryker-showcases-next-generation-of-mako-smartrobotics--at-aaos.html) 与 [GS TINAVI 初评](http://xs-macbook-air.local:5001/zsxq/pdf-viewer/585421451418284/Goldman%20Sachs-Tinavi%20Medical%20%EF%BC%88688277.SS%EF%BC%89%20Orthopedic%20surgical%20robot%20leader%20in%20China%EF%BC%9B%20Awaiting%20clearer%20delivery%20validation%EF%BC%9B%20initiate%20at%20Neutral-260507.pdf#page=1) 的分析师定位（非精确份额）。*
...
**渗透策略。** *分析师观点：* Stryker 的渗透打法是经典的装机量飞轮——先以更易采购的形态（Mako RPS 手持、Mako 4 多术式）扩大装机底座，再靠 implant pull-through 把每台机器的经常性收入做厚；同时用 Mako Shoulder（整合 Tornier 肩植入物 + Blueprint 规划软件 + Mako）把肩关节这块新术式纳入同一机器人生态，扩大每台机器的可带动 implant 品类。本地行业研究认为，骨科机器人正进入"政策与创新双轮驱动、开启出海破局新阶段"的扩张期（[东方证券系——手术机器人专题, 2026-04-30](http://xs-macbook-air.local:5001/zsxq/pdf-viewer/415515545411258/%E6%89%8B%E6%9C%AF%E6%9C%BA%E5%99%A8%E4%BA%BA%E4%B8%93%E9%A2%98%EF%BC%9A%E6%94%BF%E7%AD%96%E4%B8%8E%E5%88%9B%E6%96%B0%E5%8F%8C%E8%BD%AE%E9%A9%B1%E5%8A%A8%EF%BC%8C%E5%BC%80%E5%90%AF%E5%87%BA%E6%B5%B7%E7%A0%B4%E5%B1%80%E6%96%B0%E9%98%B6%E6%AE%B5.pdf)）——这是 Mako 全球渗透的行业级顺风（注：该 note 主要针对中国玩家的出海，Stryker 作为既有全球龙头是参照系）。
...
2. **骨科机器人竞品蚕食。** Zimmer ROSA、Smith+Nephew CORI 等竞品系统持续争夺装机量，中国市场由 TINAVI 等本土玩家主导（[GS — TINAVI 初评, 2026-05-07](http://xs-macbook-air.local:5001/zsxq/pdf-viewer/
http://xs-macbook-air.local:5001/zsxq/pdf-viewer/585428852142244/J.P.%20Morgan-J.P.%20Morgan%20MedTech%EF%BC%9ADown%20but%20Not%20Out%EF%BC%9A%20The%20Argument%20for%20Owning%20MedTech-260526.pdf#page=1)）；花旗在 Q1 财报季后新增 SYK 为 Top Pick（[Citi — US MedTech 1Q26 Recap, 2026-05-28, p.1](http://xs-macbook-air.local:5001/zsxq/pdf-viewer/212485545248851/CITI-US%20MedTech%201Q26%20Recap%EF%BC%9A%20The%20%22Good%E2%80%9D%20Didn%E2%80%99t%20Stick%20and%20the%20%22Bad%E2%80%9D%20was%20Terrible-260528.pdf#page=1)）。
...
- Citi — US MedTech 1Q26 Recap（新增 SYK 为 Top Pick）: http://xs-macbook-air.local:5001/zsxq/pdf-viewer/212485545248851/CITI-US%20MedTech%201Q26%20Recap%EF%BC%9A%20The%20%22Good%E2%80%9D%20Didn%E2%80%99t%20Stick%20and%20the%20%22Bad%E2%80%9D%20was%20Terrible-260528.pdf
- J.P. Morgan — MedTech: Down but Not Out（SYK 列首选龙头）: http://xs-macbook-air.local:5001/zsxq/pdf-viewer/585428852142244/J.P.%20Morgan-J.P.%20Morgan%20MedTech%EF%BC%9ADown%20but%20Not%20Out%EF%BC%9A%20The%20Argument%20for%20Owning%20MedTech-260526.pdf
- J.P. Morgan — Medical Devices: Enough Is Enough（板块估值压缩过度）: http://xs-macbook-air.local:5001/zsxq/pdf-viewer/212228411484221/J.P.%20Morgan-Medical%20Devices%EF%BC%9AEnough%20Is%20Enough%EF%BC%9B%20Valuation%20Compression%20Appears%20to%20Have%20Gone%20Too%20Far-260312.pdf
- Goldman Sachs — MedTech & HCIT 宏观: http://xs-macbook-air.local:5001/zsxq/pdf-viewer/184411858418452/Goldman%20Sachs-MEDTECH%20%26%20HCIT%EF%BC%9ATaking%20stock%20of%20evolving%20macro%20dynamics%20%E2%80%94%20global%20exposure%20and%20input%20cost%20risk%20makes%20strong%20case%20for%20pure%20play%20growth-260408.pdf
- Goldman Sachs — TINAVI 初评（中国骨科机器人对照）: http://xs-macbook-air.local:5001/zsxq/pdf-viewer/585421451418284/Goldman%20Sachs-Tinavi%20Medical%20%EF%BC%88688277.SS%EF%BC%89%20Orthopedic%20surgical%20robot%20leader%20in%20China%EF%BC%9B%20Awaiting%20clearer%20delivery%20validation%EF%BC%9B%20initiate%20at%20Neutral-260507.pdf
- 东方系 — 手术机器人专题（行业出海）: http://xs-macbook-air.local:5001/zsxq/pdf-viewer/415515545411258/%E6%89%8B%E6%9C%AF%E6%9C%BA%E5%99%A8%E4%BA%BA%E4%B8%93%E9%A2%98%EF%BC%9A%E6%94%BF%E7%AD%96%E4%B8%8E%E5%88%9B%E6%96%B0%E5%8F%8C%E8%BD%AE%E9%A9%B1%E5%8A%A8%EF%BC%8C%E5%BC%80%E5%90%AF%E5%87%BA%E6%B5%B7%E7%A0%B4%E5%B1%80%E6%96%B0%E9%98%B6%E6%AE%B5.pdf
...
**zsxq 局限（重要）：** find_pdf.py 与 extract_pdf.py 在本环境分别因 DB 锁 / 缺 PyPDF2 失败；改以 sqlite immutable 只读连接查询命中 70 条去重 note，引用 6 条。**未能逐字串匹配 PDF 正文**——因此 zsxq 引用严格限于 curated 翻译精华 summary 中明确陈述的定性事实（券商、评级、Top-Pick 指定、板块论点），未将任何精确硬数字归因到 zsxq note；所有精确数字锚定 filing/PR/市场数据。zsxq 引用全部标 `*分析师观点：*` 并用 `/zsxq/pdf-viewer/<file_id>/<filename>` 路由（无 `/zsxq-pdf/` 死链）。
