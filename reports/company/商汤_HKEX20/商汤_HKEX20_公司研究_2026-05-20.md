...
```mermaid
timeline
    title 商汤集团里程碑 (2014-2025)
    2014 : 公司创立于香港 / 上海，CUHK Multimedia Lab 核心成员组建
    2017 : 完成 4.1 亿美元 B 轮融资，估值过百亿美元；与本田达成 L4 自动驾驶合作
    2018 : 阿里巴巴领投 6 亿美元 C 轮，估值升至 ~45 亿美元，成为全球估值最高 AI 独角兽
    2019 : 10 月被美国商务部列入 Entity List（涉新疆人权指控）
    2021 : 12 月美国 OFAC 列入 NS-CMIC 投资黑名单，IPO 一度推迟；12-30 港交所主板挂牌（代码 0020）
    2022 : 上海临港 AIDC 投入运营；SenseNova 大模型族首版发布
    2023 : 12-15 创始人汤晓鸥教授逝世，股价单日下跌 18%
    2024 : 完成 "1+X" 组织重塑；GenAI 收入翻倍至 RMB 24 亿；运营算力升至 23,000 Petaflops
    2025 : H1 营收 +35.6%，GenAI 占比升至 77%；SenseNova V6 / V6.5 多模态发布；Raccoon 系列 MAU 破千万
```
...
graph TD
    A[商汤集团] --> B[1 核心业务]
    A --> C[X 生态业务]
    B --> B1[生成式 AI<br/>Generative AI]
    B --> B2[计算机视觉<br/>Computer Vision]
    B1 --> B1a[SenseCore<br/>AI 基础设施]
    B1 --> B1b[SenseNova<br/>大模型族]
    B1 --> B1c[应用层<br/>办公/金融/政务/智能终端]
    B2 --> B2a[SenseFoundry<br/>视觉智能体平台]
    B2 --> B2b[智能手机<br/>影像 IP 授权]
    B2 --> B2c[智能座舱<br/>感知软件]
    C --> C1[SenseAuto<br/>智能驾驶]
    C --> C2[SenseCare<br/>智慧医疗]
    C --> C3[SenseRobot<br/>家用机器人]
    C --> C4[SenseMart<br/>智慧零售]
    B1c --> D1[小浣熊 Raccoon<br/>财务/编程/教育/政务]
    B1c --> D2[Kapi 系列<br/>相机/记账 to-C]
```
...
```mermaid
pie title FY2024 商汤集团收入按前五大客户披露 (RMB 百万)
    "最大客户 (约 460 百万 / 12.2%)" : 460
    "其他四大客户 (合计约 1,206 百万 / 32.0%)" : 1206
    "其他客户 (约 2,106 百万 / 55.8%)" : 2106
```
