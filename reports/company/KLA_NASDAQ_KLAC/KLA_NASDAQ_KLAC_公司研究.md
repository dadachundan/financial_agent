...
![KLA — 营业收入与毛利率, FY2021–FY2025](charts/klac_revenue_gm.png)
...
timeline
    title KLA — 关键里程碑
    1975 : KLA Instruments 由 Ken Levy 与 Robert Anderson 创立; 推出 KLA-100 光罩检测系统
    1976 : Tencor Instruments 成立
    1992 : 首次 KLA–Tencor 合并协议 (1993 年终止)
    1997 : KLA–Tencor 合并完成 (一比一换股, 13 亿美元); Ken Levy 卸任 CEO
    2005 : Rick Wallace 出任总裁兼 CEO
    2014 : Orbotech (独立) 以 3.71 亿美元收购 SPTS Technologies
    2019-02 : KLA 完成收购 Orbotech (约 34 亿美元); 获得 SPTS、PCB、先进封装产品线
    2019-07 : KLA-Tencor 更名为 KLA Corporation; "Keep Looking Ahead" 新形象
    2024-03 : 决定退出平板显示 Display 产品制造
    2025-06 : 在手订单 (backlog) 78.6 亿美元 (上年同期 98.3 亿美元, 反映交付周期回归正常)
    2026-03 : 投资者日——2030 模型: 260 亿美元 ±25 亿美元营业收入、45–47% 营业利润率、Non-GAAP EPS 84 美元 ±8 美元
    2026-05 : 连续第 17 年股息上调; 70 亿美元回购授权; 宣布 10 比 1 股票拆分
```
...
```mermaid
graph LR
    LITHO[光刻 Lithography] --> ETCH[刻蚀 / 沉积]
    ETCH --> CMP[CMP / 清洁]
    CMP --> INSP[KLA 检测<br/>明场 / 暗场 / 电子束]
    INSP --> METRO[KLA 量测<br/>Archer / SpectraShape / SpectraFilm]
    METRO --> SW[KLA 软件<br/>Klarity / 5D Analyzer / aiSIGHT]
    SW --> LITHO
    SW --> ETCH
    SW --> CMP
```
...
```mermaid
pie title KLA FY2025 — 估算客户集中度
    "TSMC (披露约 19%)" : 19
    "三星 (披露 >10%)" : 13
    "Intel / SK Hynix / Micron / 中国先进代工厂 (估算)" : 28
    "其他 (较小代工厂、IDM、专用、封装、PCB)" : 40
```
...
![KLA — 按地区营业收入 (出货地), FY2023–FY2025](charts/klac_geo_mix.png)
...
![KLA — 现金生成与资本回报](charts/klac_capital_return.png)
...
![工艺控制 / WFE 同业 — TTM P/E 和 P/S (2026-05-20)](charts/klac_peer_multiples.png)
...
```mermaid
graph LR
    SEMI["全球半导体<br/>2025-2030 约 11% CAGR"] --> WFE["晶圆制造设备<br/>2030 年 ~2,150 亿美元 ±200 亿<br/>约 12% CAGR"]
    WFE --> PC["工艺控制 / 检测量测<br/>2030 年 ~250-300 亿美元<br/>分析师估算, ~13-15% CAGR"]
    PC --> KLA["KLA 营业收入<br/>260 亿美元 ±25 亿目标<br/>FY25-2030 ~13-17% CAGR"]
```
