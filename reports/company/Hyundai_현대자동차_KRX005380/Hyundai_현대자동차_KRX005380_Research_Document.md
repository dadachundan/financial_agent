...
```mermaid
timeline
    title Hyundai Motor — Key Milestones (1967 – 2026)
    1967 : Founded by Chung Ju-yung in Seoul
    1975 : Pony — first Korean-designed mass-market car
    1986 : US market entry with Excel
    1998 : Acquires Kia Motors post-Asian Financial Crisis
    1999 : Launches 10-yr/100k-mile US powertrain warranty
    2015 : Launches Genesis as standalone luxury marque
    2020 : Launches Ioniq dedicated EV sub-brand
    2021 : Acquires 80% of Boston Dynamics from SoftBank
    2022 : E-GMP-based Ioniq 5/6 win World Car of the Year
    2024 : Aug — "Hyundai Way" CEO Investor Day (KRW 120.5 trn)
    2024 : Oct — HMGMA Metaplant Georgia opens (US$7.6 bn)
    2024 : Oct — Hyundai Motor India IPO ($3.3 bn — India's largest)
    2025 : Jan — José Muñoz becomes CEO
    2025 : Q3 — US tariff cost reaches KRW 1.8 trn for the quarter
```
...
```mermaid
graph TD
    HMC[Hyundai Motor Company KRX:005380] --> ICE[ICE / HEV platforms - N3]
    HMC --> BEV[BEV platforms - E-GMP / eM]
    HMC --> FC[Hydrogen FCEV - HTWO]
    HMC --> COM[Commercial - Porter / Mighty / Xcient]
    HMC --> GEN[Genesis luxury]
    HMC --> N[N performance]
    HMC --> BD[Boston Dynamics - 80%]
    HMC --> SUP[Supernal eVTOL]
    BEV --> I5[Ioniq 5]
    BEV --> I6[Ioniq 6 / 6 N]
    BEV --> I9[Ioniq 9 - 2025]
    GEN --> G80[G80 / Electrified G80]
    GEN --> GV80[GV80]
```
...
```mermaid
pie title FY2024 Hyundai Motor Company wholesales by region (consolidated, 4.14M units)
    "Overseas (NA, EU, India, China, Other)" : 3437
    "Korea (domestic)" : 705
```
