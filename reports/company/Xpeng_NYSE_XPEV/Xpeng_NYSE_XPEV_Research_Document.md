...
![XPeng 3-year financial trend](charts/xpeng_3yr_chart.png)
...
![Peer P/S comparison](charts/xpeng_peer_valuation.png)
...
```mermaid
timeline
    title XPeng key milestones (2014–2026)
    2014 : Company founded in Guangzhou
         : He Xiaopeng angel investor
    2017 : He Xiaopeng joins full-time as Chairman/CEO
         : First model G3 announced
    2018 : Alibaba leads Series B (USD 348 mn)
    2020 : NYSE IPO (Aug 27) raises USD 1.5 bn at USD 15/ADS
         : Second model P7 sedan ships
    2021 : Hong Kong dual-primary listing (HKEX 9868)
         : G9 flagship SUV unveiled
    2022 : G9 launch stumbles; full re-org under He Xiaopeng
    2023 : DiDi smart-EV asset acquisition (MONA program)
         : Volkswagen invests USD 700 mn at USD 15/ADS for 4.99%
         : Fengying Wang joins as President (ex-Great Wall)
    2024 : MONA M03 launches at RMB 119,800
         : Iron humanoid robot 1st-gen reveal
         : VW E/E architecture framework agreement
    2025 : P7+, G7 EREV, X9 EREV launched
         : Q4 first quarterly net profit (RMB 0.38 bn)
         : 429k FY deliveries (+126% YoY)
         : Next-Gen Iron + Robotaxi unveiled at AI Day
    2026 : Robotaxi Business Unit formed (Mar 23)
         : AeroHT Land Aircraft Carrier trial production
         : Iron mass-production base groundbreaking
         : XPENG GX flagship SUV launched (May 20)
         : Q1 2026 results — net loss RMB -1.78 bn (May 28)
```
...
graph TD
    XPeng[XPeng Inc.]
    XPeng --> Auto[Auto: 89.1% of FY25 rev]
    XPeng --> Svc[Services & others: 10.9%]
    XPeng --> Iron[XPENG IRON humanoid]
    XPeng --> Aero[AERIDGE / AeroHT flying car]
    XPeng --> Robo[XPENG Robotaxi]
    Auto --> Sedan[Sedans: P7+, Next P7]
    Auto --> SUV[SUVs: G6, G7, G9, GX]
    Auto --> MPV[MPV: X9]
    Auto --> Entry[Entry: MONA M03]
    Sedan --> P7Plus[P7+ BEV/EREV — RMB 186.8k start]
    SUV --> G6[G6 BEV — RMB 169.8k start]
    SUV --> G7[G7 BEV/EREV — RMB 195.8k start]
    SUV --> G9[G9 BEV only — RMB 248.8k start]
    SUV --> GX[GX BEV/EREV — RMB 269.8k start, full-size 6-seat flagship]
    MPV --> X9[X9 BEV/EREV — premium 7-seat MPV]
    Entry --> MONA[MONA M03 — RMB 119.8k start]
    Svc --> VWFee[Volkswagen R&D + tech licence fees]
    Svc --> Carbon[Carbon credits]
    Svc --> Parts[Parts, charging, after-sales]
    Iron --> IronGen2[Next-Gen IRON]
    Aero --> Land[Land Aircraft Carrier]
    Robo --> RT5[5-seat Robotaxi]
    Robo --> RT6[6-seat Robotaxi]
    Robo --> RT7[7-seat Robotaxi]
```
...
```mermaid
pie title XPeng FY2025 revenue by channel (estimated)
  "Mainland-China retail consumer (BEV + EREV)" : 70
  "Overseas retail consumer (40+ countries)" : 15
  "Services & others (incl. VW tech fees, carbon credits, supercharging)" : 11
  "Other (parts / after-sales / fleet pilots)" : 4
```
