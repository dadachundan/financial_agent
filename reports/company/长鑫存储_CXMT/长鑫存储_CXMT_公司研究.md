...
![长鑫科技营收与归母净利润趋势](charts/cxmt_revenue_profit.png)
...
timeline
    title 长鑫科技 关键里程碑
    2016 : 「506项目」启动 ; 合肥智聚成立 (公司前身)
    2017 : 更名睿力集成 ; 11月长鑫存储 (合肥) 注册成立
    2018 : 朱一明出任 CEO ; 一厂厂房竣工设备搬入
    2019 : 9月8Gb DDR4 量产 ; 中国大陆 DRAM "从零到一"
    2020-21 : LPDDR4X 量产 ; 长鑫集电 (北京) 启动建设 ; 长鑫新桥 (合肥二厂) 成立
...
![长鑫科技营收结构 - DDR vs LPDDR](charts/cxmt_revenue_structure.png)
...
```mermaid
pie title 长鑫科技 客户集中度 (2025, 主营业务收入)
    "前五大客户合计 (68.08%)" : 68.08
    "其他客户 (31.92%)" : 31.92
```
