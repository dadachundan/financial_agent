...
![NSHD 营收与利润率轨迹 (FYE2021–FYE2025)](../../charts/nipponsanso_revenue_margin.png)
...
![NSHD FYE2025 分部营收结构（日本 / 美国 / 欧洲 / 亚洲与大洋洲 / Thermos）](../../charts/nipponsanso_segment_mix.png)
...
![NSHD 与同业 TTM P/E 及 EV/EBITDA 快照](../../charts/nipponsanso_peer_valuation.png)
...
![NSHD 发展时间轴 (1910 → 2026 品牌整合)](../../charts/nipponsanso_timeline.png)
...
```mermaid
timeline
    title NSHD — 重要里程碑 1910–2026
    1910 : 在东京成立 Nippon Sanso Ltd.
    1964 : 建成周南工厂——旗舰一体化空分基地
    1970s : 进入半导体 / 电子气体业务
    1989 : 收购 THERMOS LLC + Matheson Gas Products
    1999 : 美国业务重组为 Matheson Tri-Gas, Inc.
    2004 : Nippon Sanso Ltd. + Taiyo Toyo Sanso 合并 → Taiyo Nippon Sanso Corp.
    2014 : 三菱化学控股取得多数股权（并表子公司，约 50.6%）
    2018 : 以 €50 亿收购 Praxair 欧洲业务（Linde-Praxair 反垄断救济）→ Nippon Gases
    2020 : 转为控股架构 → Nippon Sanso Holdings Corporation (TSE 4091)
    2024 : 签署 Coregas (澳大利亚 / 新西兰) 收购协议 (Wesfarmers, AUD 7.7 亿)
    2025 : Coregas 交割 (2025-07)；取消美国氢气项目 (¥260 亿减值)
    2026 : 品牌整合 — TNSC → Nippon Sanso；Matheson → Nippon Sanso Matheson；Nippon Gases → Nippon Sanso Euro-Holding (全部 2026-04-01)
```
...
```mermaid
graph LR
    A[客户进入<br/>包装钢瓶] --> B[用量增长<br/>→ 散装液态槽车]
    B --> C[最大客户<br/>→ 驻厂空分装置<br/>15-20 年 take-or-pay]
    A --> D[特种气体 SSG<br/>钢瓶柜 + 纯化 + 尾气处理]
    C --> D
    D --> E[电子设备集成]
```
