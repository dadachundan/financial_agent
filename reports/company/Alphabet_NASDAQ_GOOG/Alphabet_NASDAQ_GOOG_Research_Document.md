...
```mermaid
timeline
    title Alphabet — selected milestones
    1998 : Google founded by Larry Page and Sergey Brin
    2004 : IPO at $85 / share (Class A); dual-class structure
    2006 : YouTube acquired for $1.65B
    2008 : Android Open Source Project launched; first Android phone ships
    2014 : DeepMind acquired for ~$500M
    2015 : Reorganises into Alphabet; Sundar Pichai becomes Google CEO
    2017 : Transformer paper published by Google researchers
    2019 : Pichai appointed Alphabet CEO; Page and Brin step back
    2023 : Bard (later Gemini) launched in response to ChatGPT
    2024 : First-ever quarterly dividend; $70B buyback authorised; Anat Ashkenazi joins as CFO
    2025 : DOJ Search-remedy ruling — no Chrome divestiture; behavioural remedies imposed
    2026 : Q1 revenue $109.9B; Cloud backlog >$460B; FY26 capex guide $175–185B
```
...
graph TD
    ...
    Alphabet --> Services[Google Services - $342.7B / 85%]
    Alphabet --> Cloud[Google Cloud - $58.7B / 15%]
    Alphabet --> Other[Other Bets - $1.5B / 0.4%]

    Services --> Search[Google Search and other]
    Services --> YT[YouTube ads + subscriptions]
    Services --> Net[Google Network - AdMob/AdSense/Ad Manager]
    Services --> SubPlat[Subscriptions, Platforms and Devices]
    SubPlat --> Android[Android OS]
    SubPlat --> Chrome[Chrome browser]
    SubPlat --> Play[Google Play]
    SubPlat --> Pixel[Pixel phones, Watch, Buds, Nest]
    SubPlat --> One[Google One / AI Pro / AI Ultra]
    SubPlat --> Workspace[Workspace consumer]
    SubPlat --> Maps[Maps]
    SubPlat --> Gemini[Gemini app]

    Cloud --> GCP[Google Cloud Platform]
    GCP --> Vertex[Vertex AI / Gemini Enterprise]
    GCP --> Compute[Compute, Storage, Networking]
    GCP --> Data[BigQuery, Spanner, Looker]
    GCP --> Sec[Security - Mandiant / Wiz pending]
    Cloud --> WS[Workspace Enterprise]

    Other --> Waymo[Waymo - autonomous ride-hail]
    Other --> Verily[Verily - life sciences]
    Other --> X[X - the moonshot factory]
    Other --> Wing[Wing - drone delivery]
...
```mermaid
pie title FY2025 Alphabet revenue mix by product line
    "Google Search & other" : 224.5
    "Google Subscriptions / Platforms / Devices" : 48.0
    "Google Cloud" : 58.7
    "YouTube ads" : 40.4
    "Google Network" : 29.8
    "Other Bets" : 1.5
...
```mermaid
quadrantChart
    title AI-platform positioning (2026)
    x-axis "Narrow AI focus" --> "Broad full-stack AI"
    y-axis "Smaller scale" --> "Hyperscale infrastructure"
    quadrant-1 Hyperscalers
    quadrant-2 Niche scale
    quadrant-3 Niche
