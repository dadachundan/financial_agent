...
```mermaid
timeline
    title 君实生物关键时间节点 (2012–2026)
    2012-12 : 公司成立 (Founded in Shanghai)
    2015-08 : 拓益 / toripalimab (JS001) 启动临床
    2018-12 : H 股港交所主板挂牌 (HKEX:1877)
    2018-12 : 拓益获 NMPA 批准 — 中国首个国产 PD-1
    2020-07 : 科创板 A 股挂牌 (SSE:688180)
    2021-02 : 与 Coherus 签订 USD 150M+380M 美加授权
    2022-07 : 与礼来 (Eli Lilly) 签订中和抗体 etesevimab 全球授权
    2022-12 : 与 Hikma 签订中东北非 (MENA) 授权
    2023-10 : LOQTORZI 获 FDA 批准 — 中国首个 FDA 批准的 PD-1
    2024-01 : CEO 换届 — 邹建军接任 GM & CEO,李宁转任副董事长
    2025-01 : 与 LEO Pharma 签订欧洲 32 国授权 (EUR 15M upfront)
    2025-06 : H 股配售净筹 HK$ 1,026M;FDA cGMP 检查通过
    2025-11 : JS001sc (皮下注射拓益) Phase 3 NSQ-NSCLC 主要终点达成
    2026-04 : AACR 2026 — JS207 (PD-1/VEGF BsAb)、JS212 (EGFR/HER3 ADC) 重磅数据读出
```
...
```mermaid
graph TD
    A[君实生物核心产品树] --> B[肿瘤 / Oncology]
    A --> C[自身免疫 / Autoimmune]
    A --> D[代谢 / Metabolic]
    A --> E[传染病 / Infectious]
    B --> B1[拓益 TUOYI® / LOQTORZI® - 特瑞普利单抗 PD-1]
    C --> C1[君迈康 - 阿达木单抗 TNF-α biosimilar]
    D --> D1[君适达 JUNSHIDA - 昂戈瑞昔单抗 PCSK9]
    E --> E1[民得维 MINDEWEI - 民得卫德西韦 RdRp 抑制剂 - COVID-19]
```
...
```mermaid
pie title 君实生物 2025 FY 收入结构 (近似估算 / approximate)
    "拓益国内销售 (toripalimab China)" : 83
    "其他商业化产品国内销售" : 10
    "海外授权收入 (Coherus/LEO/Hikma royalty + milestone)" : 5
    "其他 (合作研发等)" : 2
```
...
quadrantChart
    ...
    quadrant-3 "海外弱 + 国内小"
    quadrant-4 "国内大 + 海外弱"
    Hengrui-Camrelizumab: [0.85, 0.55]
    Innovent-Sintilimab: [0.78, 0.75]
    BeiGene-Tislelizumab: [0.65, 0.92]
    Junshi-Toripalimab: [0.40, 0.78]
    CSPC-Nofazinlimab: [0.30, 0.25]
    Akeso-AK105-Penpulimab: [0.45, 0.60]
    Hansoh-PD-1: [0.35, 0.20]
```
...
```mermaid
xychart-beta
    title "拓益国内销售放量轨迹 (RMB mn)"
    x-axis ["2023A", "2024A", "2025A", "2026E", "2027E", "2028E"]
    y-axis "拓益国内销售 (RMB mn)" 0 --> 5000
    bar [905, 1501, 2068, 2700, 3400, 4100]
```
