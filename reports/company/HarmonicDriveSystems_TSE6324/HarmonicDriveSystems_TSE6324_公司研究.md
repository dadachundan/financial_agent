...
```mermaid
timeline
    title Harmonic Drive Systems 主要里程碑
    1970 : 东京设立合资公司（USM + 长谷川齿轮）
         : 长野松本工厂量产
    1987 : 设立美国子公司 HD Systems Inc.
    1988 : 推出 IH 齿形产品
    1990 : 生产基地迁至穗高 (Hotaka) 工厂
    1998 : JASDAQ 店头登记上市
    2003 : 设立 Harmonic AD 子公司（北上市）
    2004 : JASDAQ 证券交易所正式上市
    2011 : 设立 Harmonic Drive Systems (Shanghai)
    2017 : 德国子公司 Harmonic Drive SE 与 INCJ 共同持有
    2021 : 收购美国 Harmonic Drive LLC 49% 股权
         : 增持德国 Harmonic Drive SE 至控股
    2024 : 启动 2024–2026 中期经营计划
    2026 : 板块升级至 TSE Prime（一部）
```
...
```mermaid
graph TD
    A[Harmonic Drive Systems<br/>TSE:6324] --> B[精密减速器<br/>Speed Reducer]
    A --> C[机电一体化<br/>Mechatronics]
    B --> B1[CSF / CSG / CSD<br/>实心轴 谐波]
    B --> B2[SHG / SHF<br/>中空轴 谐波]
    B --> B3[HPN / HPG<br/>行星减速器]
    C --> C1[FHA-C<br/>中空轴执行器]
    C --> C2[FLA / RSF<br/>紧凑执行器]
    C --> C3[SHA-SG<br/>大尺寸中空轴]
    B1 --> M1[半导体设备/<br/>工业机器人]
    B2 --> M2[协作机器人/<br/>人形机器人]
    B3 --> M3[伺服电机/<br/>机床/光学]
    C1 --> M4[cobot 关节/<br/>人形手部]
    C2 --> M5[半导体直驱/<br/>测量仪]
    C3 --> M6[J1-J3 关节/<br/>航天定位]
```
...
```mermaid
pie title FY2025/3 非合并按终端应用销售额估算 (JPY mn / %)
    "工业机器人 Industrial Robots" : 24302
    "半导体设备 Semi Equipment" : 13462
    "其他 (机床/光学/医疗/汽车/印刷/测量等)" : 17033
```
