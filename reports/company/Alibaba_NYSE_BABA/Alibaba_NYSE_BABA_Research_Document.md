...
```mermaid
timeline
    title Alibaba — 27-year corporate timeline
    1999 : Founded in Hangzhou (Jack Ma + 17 partners)
         : Alibaba.com B2B marketplace launched
    2000 : SoftBank invests US$20M
    2003 : Taobao consumer marketplace launched (defeats eBay China)
    2004 : Alipay launched (later spun out to Ant Group)
    2007 : Alibaba.com IPO on HKEX (later privatized 2012)
    2008 : Tmall (B2C, brand-led) launched
    2009 : Aliyun (Alibaba Cloud) founded; first proprietary distributed-OS
    2013 : Cainiao Smart Logistics Network founded
    2014 : NYSE IPO (US$25B — then-record); Alibaba Partnership disclosed
    2018 : T-Head semiconductor unit founded; Lazada control acquired
    2019 : Hong Kong secondary listing (9988); Ant Group SAPA executed (33% stake)
    2020-21 : Suspension of Ant IPO (Nov-2020); SAMR antitrust fine RMB 18.2 bn (Apr-2021)
    2023 : Six-business-group reorganization (March); Jack Ma steps fully back; Eddie Wu becomes CEO (Sept)
    2024 : Primary HK listing conversion (Aug-2024); 2024 equity incentive plans adopted
    2025 : RMB 380bn / 3-yr AI + cloud capex commitment (Feb); Sun Art and Intime divested
    2026 : FY26 reorg into 4 segments; Cloud Q4 +40% YoY; FY26 capex RMB 126.1bn
```
...
```mermaid
graph TD
    A[Alibaba Group] --> B[Alibaba China E-Commerce Group]
    A --> C[AIDC — International Digital Commerce]
    A --> D[Cloud Intelligence Group]
    A --> E[All Others]

    B --> B1[Taobao app]
    B --> B2[Tmall / Tmall Global]
    B --> B3[Tmall Supermarket]
    B --> B4[Taobao Instant Commerce<br/>formerly Ele.me — quick commerce]
    B --> B5[Fliggy — travel]
    B --> B6[1688.com — China B2B wholesale]
    B --> B7[Alimama — P4P ad platform]

    C --> C1[AliExpress + Choice]
    C --> C2[Lazada — SEA]
    C --> C3[Trendyol — Türkiye]
    C --> C4[Daraz — South Asia]
    C --> C5[Alibaba.com — global B2B]

    D --> D1[Alibaba Cloud IaaS / PaaS]
    D --> D2[Qwen foundation models + MaaS]
    D --> D3[T-Head — Yitian / Hanguang / PPU]
    D --> D4[Wukong — agentic platform]
    D --> D5[DingTalk — enterprise productivity]

    E --> E1[Cainiao — logistics]
    E --> E2[Amap — navigation / Local services]
    E --> E3[Freshippo Hema — supermarkets]
    E --> E4[Alibaba Health]
    E --> E5[Hujing Digital Media & Entertainment]
    E --> E6[Lingxi Games]
    E --> E7[Qwen Consumer Business Group<br/>— Qwen app, video, world models]
```
...
```mermaid
pie title FY2026 revenue mix by segment (RMB bn, pre-elimination)
    "China E-Commerce (Taobao/Tmall/Quick Commerce)" : 554
    "AIDC (AliExpress/Lazada/Trendyol)" : 144
    "Cloud Intelligence (Aliyun/Qwen)" : 158
    "All others (Cainiao/Amap/Freshippo/etc.)" : 254
```
...
```mermaid
quadrantChart
    title China platform-economy positioning — 2026 (price vs feature breadth)
    x-axis "Narrow product scope" --> "Broad ecosystem"
    y-axis "Premium / brand" --> "Value / price-led"
    quadrant-1 "Cheap broad-ecosystem"
    quadrant-2 "Cheap narrow"
    quadrant-3 "Premium narrow"
    quadrant-4 "Premium broad-ecosystem"
    Alibaba: [0.85, 0.55]
    JD.com: [0.55, 0.40]
    Pinduoduo / Temu: [0.55, 0.85]
    Meituan: [0.65, 0.50]
    ByteDance / Douyin: [0.75, 0.50]
    Tencent: [0.80, 0.30]
    Baidu: [0.55, 0.40]
```
