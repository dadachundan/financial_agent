...
![Revenue & margin trend](charts/csb_revenue_margin.png)
...
```mermaid
timeline
    title CSB / 长盛轴承 — Key Milestones
    1989 : 孙志华 starts at Jiashan Oil-Free Bearing Factory
    1995 : Sun chairs Jiashan Wuyou Bearing
    2004 : Predecessor of 浙江长盛 incorporated; Sun departs Shuangfei
    2008 : National Sliding-Bearing Standardization Sub-Committee secretariat in Jiashan
    2017 : IPO on ChiNext (SZSE:300718) Nov-2017
    2019 : Strategic partnership formalized with Sany Heavy Industry
    2023 : Provincial-level Key Research Institute designation
    2024 : Sample shipments to humanoid-robot integrators incl. Unitree
    2025 : National-level Single-Champion Manufacturing Enterprise; humanoid-joint mass production with Unitree begins
    2026 : Q1 revenue +23% YoY; humanoid pipeline expands to lead-screws & dexterous-hand components
```
...
```mermaid
graph TD
    A[CSB / 长盛轴承<br/>Self-lubricating bearings + polymer friction-pair products] --> B[1. Metal-Polymer SOB<br/>金属塑料聚合物自润滑卷制轴承<br/>¥463.3M FY25 / 36.5%]
    A --> C[2. Bimetallic Boundary SOB<br/>双金属边界润滑卷制轴承<br/>¥212.3M / 16.7%]
    A --> D[3. Metal-Base SOB / Plane-Slide<br/>金属基自润滑轴承<br/>¥201.3M / 15.9%]
    A --> E[4. Non-Metallic SOB<br/>非金属自润滑轴承<br/>¥95.4M / 7.5%]
    A --> F[5. Cu-Base Boundary SOB<br/>铜基边界润滑卷制轴承<br/>¥40.4M / 3.2%]
    A --> G[6. CM Precision Parts<br/>工程机械精密部件<br/>¥102.7M / 8.1%]
    A --> H[7. Cu Powder & Metal Mats<br/>铜粉等金属材料<br/>¥71.4M / 5.6%]
    A --> I[8. Other + Other Biz<br/>¥81.0M / 6.4%]
    E --> E1[Fiber-wound bearings]
    E --> E2[Engineering-plastic bearings]
    E --> E3[Sintered-bronze powder-metallurgy bearings]
    E --> E4[Joint bearings 关节轴承]
    B --> B1[CSB-50PRO seat-recliner bushing]
    B --> B2[CSB-FMP / CSB-12FMP punched-mesh flexible bearing]
    G --> G1[CSB-600CC wind self-shape sliding bearing]
    G --> G2[CSB-600RC anti-galling sliding bearing]
    A --> R[Humanoid-robot / Embodied-AI line<br/>joint bearings + linear-actuator components<br/>+ dexterous-hand parts<br/>currently <1% of revenue]
    R --> R1[PEEK-faced joint self-lubricating bearings]
    R --> R2[Lead-screw products for linear actuators]
    R --> R3[Micro ball-screws for fingers/wrists]
    R --> R4[Tendon-rope sheaths & polymer structural parts]
```
...
![Product mix](charts/csb_segment_mix.png)
...
```mermaid
pie title FY2025 Customer Concentration (¥ million, % of revenue)
    "Customer 1 — 66.9 (5.3%)" : 66.92
    "Customer 2 — 43.0 (3.4%)" : 42.95
    "Customer 3 — 39.6 (3.1%)" : 39.62
    "Customer 4 — 38.2 (3.0%)" : 38.19
    "Customer 5 — 32.3 (2.6%)" : 32.34
    "Customers 6+ — 1,048 (82.6%)" : 1047.75
```
...
![TAM context](charts/csb_tam.png)
