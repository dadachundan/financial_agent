...
```mermaid
timeline
    title GDS Holdings 主要里程碑
    2001 : 创立, 以 IT 业务连续性与灾难恢复服务 (BCDR) 起家
    2002 : Mr. William Huang 出任 CEO
    2006 : 在开曼群岛注册 GDS Holdings Limited
    2009 : 自建数据中心战略起步
    2010-2011 : 进入上海、成都建立首批数据中心
    2013-2014 : 拓展至北京、深圳, 覆盖中国所有主流市场
    2014 : 获得 STT GDC (Temasek/Singapore Technologies) 战略入股
    2016 : NASDAQ IPO (代码 GDS) 募资约 USD 167 mn
    2020 : 港交所二次上市 (9698.HK)
    2022 : 设立 DigitalLand (后更名 DayOne), 启动国际数据中心业务
    2024 : DayOne 完成 Series A/B 共 USD 1.87 bn 融资, GDS 不参与稀释至 35.6%, 国际业务出表
    2025 : 完成境内 ABS + GDS C-REIT IPO (508060.SH); 赢得 152 MW hyperscale 大单
    2026 : DayOne Series C upsizing 后, GDS 持股摊薄至 19.9%, 持仓估值 USD 2.2 bn
```
...
```mermaid
graph TD
    A[GDS Holdings 服务体系] --> B[Colocation Services 托管服务<br/>90.8% revenue FY2025]
    A --> C[Managed Services 运维服务<br/>~9.0% revenue]
    A --> D[Consulting 咨询<br/>< 0.5%]
    B --> B1[Unbundled pricing<br/>面积 + kW + kWh<br/>主用于 hyperscale/internet 客户<br/>合约 3-10 年]
    B --> B2[Bundled pricing<br/>按机柜定价 含一定电量<br/>主用于金融/企业客户<br/>合约 1-5 年]
    B --> B3[Build-Operate-Transfer<br/>BOT 客户指定选址]
    C --> C1[Managed Hosting<br/>BCDR / 网络管理 /<br/>存储 / 安全 / OS / DB / 中间件]
    C --> C2[Managed Cloud<br/>直连 AWS/Azure/<br/>阿里云/腾讯云/华为云<br/>混合云控制平台]
    D --> D1[灾备咨询 + IT 顾问 +<br/>设备代售/转售]
```
...
```mermaid
pie
    title GDS 客户类型 (按 total area committed, FY2025)
    "Cloud Service Providers (云服务商)" : 56.0
    "Large Internet (大型互联网)" : 33.3
    "金融机构 + 企业" : 10.7
```
