...
```mermaid
xychart-beta
    title "Rivian — Revenue and Consolidated Gross Margin (FY21-FY25)"
    x-axis ["FY21", "FY22", "FY23", "FY24", "FY25"]
    y-axis "Revenue (USD mn)" 0 --> 6000
    bar [55, 1658, 4434, 4970, 5387]
    line [-2818, -190, -46, -24, 3]
```
...
```mermaid
timeline
    title Rivian — Strategic Milestones
    2009 : Founded by RJ Scaringe in Florida (then "Mainstream Motors")
    2017 : Acquired ex-Mitsubishi Normal, IL plant for ~$16M
    2019 : Amazon + Ford lead funding; Amazon orders 100,000 EDVs
    2021 : IPO at $78 raising $11.9B; D1 close peak ~$100B
    2022 : First Amazon EDV deliveries; R1T/R1S customer deliveries scale
    2024 : R1 Gen-2 zonal architecture launch ; VW JV upsized to $5.8B
    2025 : DOE ATVM loan signed (up to $4.5B for Georgia plant)
    2026 : Uber robotaxi partnership ; R2 saleable production begins ; VW $1B milestone investment received
```
...
```mermaid
graph TD
    A[Rivian Automotive] --> B[Automotive Segment]
    A --> C[Software & Services Segment]
    B --> D[Consumer Vehicles]
    B --> E[Commercial Vehicles]
    D --> D1[R1T pickup<br/>$70k-122k]
    D --> D2[R1S SUV<br/>$77k-122k]
    D --> D3[R2 midsize SUV<br/>$45k-58k<br/>2026 SOP]
    D --> D4[R3/R3X crossover<br/>future]
    E --> E1[EDV<br/>Amazon partnership]
    E --> E2[Rivian Commercial Van<br/>500/700 cu ft<br/>multi-fleet]
    C --> F[RV Tech JV<br/>w/ VW Group]
    C --> G[Autonomy+<br/>$2.5k/$49.99 mo]
    C --> H[Connect+ subscription]
    C --> I[Rivian Adventure Network<br/>145 sites / 973 stalls]
    C --> J[FleetOS for commercial]
    C --> K[Service / Remarketing / Insurance]
```
...
```mermaid
pie title FY25 consolidated revenue by counterparty — denominator $5,387M total revenue
    "Chase Bank (EDV lease bill-of-sale)" : 1939
    "All other (consumer R1 sales + non-JV S&S)" : 1891
    "Volkswagen Group (RV Tech JV billings, est. ≥$1.0B; analyst est.)" : 1557
```
...
```mermaid
xychart-beta
    title "BNEF — Global passenger EV sales (millions, 2020 actual → 2030 forecast)"
    x-axis ["2020", "2022", "2024", "2026E", "2028E", "2030E"]
    y-axis "Annual passenger EV sales (millions of units)" 0 --> 35
    bar [3.2, 10.2, 17.5, 21, 26, 30]
```
...
```mermaid
xychart-beta
    title "Peer TTM P/S — Rivian vs EV-pureplay and legacy OEMs (2026-06-03)"
    x-axis ["TSLA", "RIVN", "LCID", "F", "GM", "TM", "BYDDY"]
    y-axis "P/S (TTM)" 0 --> 18
    bar [16.3, 4.2, 1.7, 0.34, 0.40, 0.00, 0.14]
```
...
```mermaid
xychart-beta
    title "TAM: US passenger-EV unit sales forecast (millions, 2024-2030)"
    x-axis ["2024", "2025E", "2026E", "2027E", "2028E", "2029E", "2030E"]
    y-axis "US passenger EVs (millions of units)" 0 --> 5
    bar [1.4, 1.6, 1.8, 2.2, 2.8, 3.4, 4.1]
```
...
```mermaid
xychart-beta
    title "Cash + ST investments vs quarterly free cash flow ($M)"
    x-axis ["Q1 25", "Q2 25", "Q3 25", "Q4 25", "Q1 26"]
    y-axis "$M" -1500 --> 8000
    bar [7178, 7508, 7088, 6082, 4830]
    line [-526, -398, -421, -1144, -1075]
```
