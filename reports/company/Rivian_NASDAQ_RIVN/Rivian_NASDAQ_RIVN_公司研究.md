...
```mermaid
xychart-beta
    title "Rivian — 收入与合并毛利率 (FY21-FY25)"
    x-axis ["FY21", "FY22", "FY23", "FY24", "FY25"]
    y-axis "收入 (百万美元)" 0 --> 6000
...
timeline
    title Rivian — 战略里程碑
    2009 : RJ Scaringe 在佛罗里达创立 (最初名为 Mainstream Motors)
    2017 : 以约 1,600 万美元收购 Normal, IL 旧 Mitsubishi 工厂
    2019 : Amazon + Ford 领投 ; Amazon 下单 100,000 辆 EDV
    2021 : 以 $78 IPO 募资 119 亿美元 ; 上市首日峰值约 1,050 亿
    2022 : Amazon 首批 EDV 交付 ; R1T/R1S 量产爬坡
    2024 : R1 Gen-2 域控架构 ; Volkswagen JV 上调至 58 亿美元
    2025 : 美国能源部 ATVM 贷款 (最高 45 亿) Georgia 工厂用
    2026 : Uber robotaxi 合作 ; R2 量产 ; VW 10 亿里程碑投资到账
```
...
```mermaid
graph TD
    A[Rivian Automotive] --> B[Automotive 分部]
    A --> C[Software & Services 分部]
    B --> D[消费车]
    B --> E[商用车]
    D --> D1[R1T 皮卡<br/>$70k-122k]
    D --> D2[R1S SUV<br/>$77k-122k]
    D --> D3[R2 中型 SUV<br/>$45k-58k<br/>2026 量产]
    D --> D4[R3/R3X 紧凑型<br/>未来]
    E --> E1[EDV<br/>Amazon 战略合作]
    E --> E2[Rivian Commercial Van<br/>500/700 立方英尺<br/>多车队客户]
    C --> F[RV Tech JV<br/>与 VW 集团]
    C --> G[Autonomy+<br/>$2.5k/$49.99 月]
    C --> H[Connect+ 订阅]
    C --> I[Adventure Network<br/>145 站 / 973 桩]
    C --> J[FleetOS 商用车队管理]
    C --> K[维修 / 二手车 / 保险]
```
...
```mermaid
pie title FY25 合并收入按交易对手 — 分母 5,387M 美元总收入
    "Chase Bank (EDV 租赁记账方)" : 1939
    "其他 (R1 消费车 + 非 JV S&S)" : 1891
    "Volkswagen 集团 (RV Tech 服务费, 估算 ≥10 亿; 分析师估算)" : 1557
```
...
```mermaid
xychart-beta
    title "BNEF — 全球乘用 EV 销售 (百万辆, 2020 实际 → 2030 预测)"
    x-axis ["2020", "2022", "2024", "2026E", "2028E", "2030E"]
    y-axis "年度乘用 EV 销量 (百万辆)" 0 --> 35
...
```mermaid
xychart-beta
    title "同业 TTM P/S — Rivian vs EV 纯做与传统 OEM (2026-06-03)"
...
```mermaid
xychart-beta
    title "TAM: 美国乘用 EV 单位销量预测 (百万辆, 2024-2030)"
    x-axis ["2024", "2025E", "2026E", "2027E", "2028E", "2029E", "2030E"]
    y-axis "美国乘用 EV (百万辆)" 0 --> 5
