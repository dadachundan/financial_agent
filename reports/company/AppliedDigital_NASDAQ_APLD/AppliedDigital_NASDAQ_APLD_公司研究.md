...
![营业收入趋势](charts/apld_revenue_trend.png)
...
```mermaid
timeline
    title Applied Digital——公司沿革时间线
    2001 : 原始壳公司 (Flight Safety Technologies) 在内华达州注册成立
    2021 : 由 Wes Cummins / Jason Zhang 重组为 Applied Blockchain
         : 北达科他州 Jamestown 首批加密货币托管客户上线
    2022 : 以 5 美元/股 IPO (4 月); 更名为 Applied Digital (11 月)
    2023 : 北达科他州 Ellendale 180 MW 托管设施带电运行
         : 提起证券集体诉讼 (McConnell 诉 Applied Digital)
    2024 : 在租赁 colocation 上启动云服务业务
         : NVIDIA 牵头 1.60 亿美元 PIPE, 价格 3.24 美元/股 (9 月)
         : 与 Macquarie / MIP VI HPC Holdings 签署 UPA (2025 年 1 月)
    2025 : 与 SMBC 签署信贷协议 (2 月)——3.75 亿美元 PF-1 建设贷款
         : Saidal Mohmand 晋升为 CFO; Laura Laltrello (前 Lenovo / Honeywell) 加入担任 COO
         : 与 CoreWeave 签署 ELN-02 + ELN-03 共 250 MW 租约 (5 月 28 日)
         : APLD ComputeCo LLC 发行 23.5 亿美元 9.250% 优先担保票据, 2030 年到期
         : 与 CoreWeave 追加 ELN-04 共 150 MW 租约 (8 月 29 日)——PF-1 共 400 MW
         : 50 亿美元 Polaris Forge 2 超大规模云客户租约签署 (10 月 22 日)
         : 修订与重述 (A&R) Macquarie UPA——永续优先股最高 50 亿美元 (10 月 3 日)
    2026 : 首座 HPC 楼 (ELN-02) 投入运营 (Q3 FY26)
         : ChronoScale (云业务分拆) 完成——Ekso Bionics 反向并购 (5 月 5 日)
         : CoreWeave 对 PF-1 债务以 A3 投资级评级再融资;
           在 ELN-02 上设立 5,000 万美元 LC (2026 年 3–4 月)
         : APLD ComputeCo 2 LLC 发行 21.5 亿美元 6.750% 优先担保票据, 2031 年到期 (Q4 FY26)
         : Delta Forge 1 (~300 MW 关键 IT 负载) 在美国南部动工
```
...
```mermaid
graph TD
    APLD[Applied Digital Corp.] --> A[数据中心托管业务<br/>加密货币 / 传统]
    APLD --> B[HPC 托管业务<br/>AI / 超大规模——战略核心]
    APLD --> C[ChronoScale — CHRN<br/>云 / GPU 即服务, 97% 持股]
    A --> A1[Jamestown ND<br/>106 MW]
    A --> A2[Ellendale ND<br/>180 MW]
    B --> B1[Polaris Forge 1 — Ellendale ND<br/>400 MW · 锚定 CoreWeave]
    B1 --> B1a[ELN-02 100 MW<br/>Q3 FY26 投运]
    B1 --> B1b[ELN-03 150 MW<br/>在建]
    B1 --> B1c[ELN-04 150 MW<br/>在建]
    B --> B2[Polaris Forge 2 — Harwood ND<br/>200 MW · IG 超大规模云客户]
    B --> B3[Delta Forge 1 — 美国南部<br/>300 MW 关键 IT · 未签约]
    B --> B4[3 个其他前瞻性站点<br/>累计约 1 GW 电网容量]
    C --> C1[科罗拉多 / 明尼苏达 / 犹他<br/>第三方 colocation, 自有 GPU]
```
...
![各园区产能](charts/apld_capacity_mw.png)
...
```mermaid
pie title 9M FY2026 客户收入构成 (持续经营业务)
    "客户 A——CoreWeave (HPC)" : 52
    "客户 B——某比特币矿企 (DCH)" : 33
    "客户 C——另一家比特币矿企 (DCH)" : 15
```
...
```mermaid
quadrantChart
    title HPC / AI colocation 定位
    x-axis 液冷 HPC 关注度有限 --> 纯液冷 HPC 厂商
    y-axis MW 管线较小 --> MW 管线较大
    quadrant-1 超大规模领先者
    quadrant-2 多元 colocation
    quadrant-3 利基运营商
    quadrant-4 AI 原生纯玩家
    Equinix: [0.20, 0.85]
...
![同业 P/S](charts/apld_ps_peers.png)
...
![资本开支资金堆栈](charts/apld_capex_stack.png)
...
![股权稀释](charts/apld_share_dilution.png)
...
![净亏损趋势](charts/apld_net_loss.png)
