...
```mermaid
timeline
    title Applied Digital — corporate timeline
    2001 : Original shell (Flight Safety Technologies) incorporated in Nevada
    2021 : Recapitalized under Wes Cummins / Jason Zhang as Applied Blockchain
         : First crypto-hosting customers in Jamestown, ND
    2022 : IPO at $5/share (April); rename to Applied Digital (November)
    2023 : 180 MW Ellendale, ND hosting facility energized
         : Securities class action filed (McConnell v. Applied Digital)
    2024 : Cloud Services Business launched on rented colocation footprint
         : NVIDIA-led $160M PIPE at $3.24/share (September)
         : Macquarie / MIP VI HPC Holdings UPA signed (January 2025)
    2025 : SMBC Credit Agreement closed (February) — $375M PF-1 construction loan
         : Saidal Mohmand promoted to CFO; Laura Laltrello (ex-Lenovo / Honeywell) joins as COO
         : CoreWeave 250 MW lease signed for ELN-02 + ELN-03 (May 28)
         : APLD ComputeCo LLC issues $2.35B 9.250% Senior Secured Notes due 2030
         : Additional 150 MW CoreWeave lease for ELN-04 (August 29) — PF-1 totals 400 MW
         : $5B Polaris Forge 2 hyperscaler lease signed (October 22)
         : A&R Macquarie UPA — perpetual preferred equity up to $5B (October 3)
    2026 : First HPC building (ELN-02) goes operational (Q3 FY26)
         : ChronoScale (cloud spin-off) closes — Ekso Bionics reverse merger (May 5)
         : CoreWeave refinances PF-1 debt at A3 investment-grade rating;
           posts $50M LC on ELN-02 (March–April 2026)
         : APLD ComputeCo 2 LLC issues $2.15B 6.750% Senior Secured Notes due 2031 (Q4 FY26)
         : Delta Forge 1 (~300 MW critical IT load) broken ground in U.S. South
```
...
```mermaid
graph TD
    APLD[Applied Digital Corp.] --> A[Data Center Hosting Business<br/>crypto / legacy]
    APLD --> B[HPC Hosting Business<br/>AI / hyperscaler — strategic core]
    APLD --> C[ChronoScale — CHRN<br/>cloud / GPU-as-a-Service, 97% owned]
    A --> A1[Jamestown ND<br/>106 MW]
    A --> A2[Ellendale ND<br/>180 MW]
    B --> B1[Polaris Forge 1 — Ellendale ND<br/>400 MW · CoreWeave anchor]
    B1 --> B1a[ELN-02 100 MW<br/>operational Q3 FY26]
    B1 --> B1b[ELN-03 150 MW<br/>under construction]
    B1 --> B1c[ELN-04 150 MW<br/>under construction]
    B --> B2[Polaris Forge 2 — Harwood ND<br/>200 MW · IG hyperscaler]
    B --> B3[Delta Forge 1 — Southern U.S.<br/>300 MW critical IT · uncontracted]
    B --> B4[3 other speculative sites<br/>~1 GW total grid potential]
    C --> C1[Colorado / Minnesota / Utah<br/>3rd-party colo, owned GPUs]
```
...
```mermaid
pie title 9-month FY2026 revenue mix by customer (continuing operations)
    "Customer A — CoreWeave (HPC)" : 52
    "Customer B — single Bitcoin miner (DCH)" : 33
    "Customer C — Bitcoin miner (DCH)" : 15
```
