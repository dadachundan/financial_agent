...
```mermaid
timeline
    title Caterpillar key milestones
    1925 : Holt + Best merger forms Caterpillar Tractor Co. in California
    1931 : Diesel-powered Caterpillar 65 launched — diesel becomes the industry default
    1963 : Cat Mitsubishi JV formed in Japan (now Caterpillar Japan)
    1981 : Solar Turbines acquired from International Harvester — entry into gas turbines
    1987 : Cat Financial expanded into global captive finance arm
    1998 : Perkins Engines acquired from LucasVarity — small/medium diesel platform
    2010 : Electro-Motive Diesel (EMD locomotives) acquired from Berkshire/Greenbriar
    2011 : Bucyrus International acquired ($8.6B) — surface mining & underground mining
    2015 : Restructuring + product redesign cycle launched after commodity downturn
    2018 : HQ moved to Deerfield, IL ; Jim Umpleby becomes CEO
    2022 : HQ relocated to Irving, TX ; $20B share-buyback authorisation (June 2024)
    2025 : Joe Creed becomes CEO (May 1) ; record $51.2B backlog ; "refreshed strategy"
    2026 : Creed appointed Chairman (April 1) ; Rail division to move to Resource Industries
```
...
```mermaid
graph TD
    CAT[Caterpillar Inc.<br/>FY2025 revenue $67.6B]
    CAT --> CI[Construction Industries<br/>$25.06B FY25 / 18.7% margin]
    CAT --> RI[Resource Industries<br/>$12.47B FY25 / 15.9% margin]
    CAT --> PE[Power & Energy<br/>$32.20B FY25 / 19.9% margin]
    CAT --> FP[Financial Products<br/>$3.59B revenue / $864M profit]

    CI --> CIa[Hydraulic excavators<br/>320, 336, 374, 395]
    CI --> CIb[Wheel loaders<br/>950, 966, 980, 988, 990]
    CI --> CIc[Track-type tractors<br/>D3, D6, D8, D9, D10, D11]
    CI --> CId[Backhoe loaders / Mini excavators]
    CI --> CIe[SEM brand — DM economies]

    RI --> RIa[Mining trucks<br/>793, 794, 795, 797, 798]
    RI --> RIb[Electric rope shovels<br/>7495 series — ex-Bucyrus]
    RI --> RIc[Hydraulic mining shovels<br/>6020, 6030, 6040, 6060]
    RI --> RId[Underground mining<br/>longwall, room & pillar]
    RI --> RIe[Cat MineStar — autonomy / fleet mgmt]

    PE --> PEa[Reciprocating engines<br/>Cat, MaK, Perkins, FG Wilson<br/>data centre back-up + prime]
    PE --> PEb[Solar Turbines<br/>Taurus, Mars, Titan / Centaur<br/>gas compression + power gen]
    PE --> PEc[Electrified powertrain / BESS]
    PE --> PEd[Locomotives — EMD<br/>SD70ACe-T4 / SD89ACe]
    PE --> PEe[Cat Reman — remanufacturing]

    FP --> FPa[Cat Financial — retail finance]
    FP --> FPb[Cat Financial — wholesale dealer]
    FP --> FPc[Insurance Services]
```
...
```mermaid
pie title FY2025 channel mix — distribution structure
    "Independent Cat dealers (150 dealers, 190 countries)" : 78
    "Direct sales (turbines, locomotives, large engines)" : 15
    "Perkins distributors (86, 183 countries)" : 4
    "FG Wilson distributors (108, 159 countries)" : 3
```
...
```mermaid
quadrantChart
    title CAT competitive positioning — global heavy off-highway
    x-axis Narrow product breadth --> Broad product breadth
    y-axis Lower scale --> Higher scale
    quadrant-1 "Scale leaders, full-line"
    quadrant-2 "Scale specialists"
    quadrant-3 "Niche specialists"
    quadrant-4 "Broad but sub-scale"
    "Caterpillar": [0.92, 0.95]
    "Komatsu": [0.80, 0.78]
    "Deere C&F": [0.45, 0.62]
    "Volvo CE": [0.50, 0.45]
    "Cummins": [0.40, 0.55]
    "Sandvik": [0.25, 0.30]
    "Epiroc": [0.30, 0.32]
    "Hitachi CM": [0.55, 0.45]
    "Liebherr": [0.65, 0.50]
    "GE Vernova": [0.45, 0.55]
    "Wabtec": [0.30, 0.25]
```
