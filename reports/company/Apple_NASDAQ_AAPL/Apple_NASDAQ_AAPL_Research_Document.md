...
```mermaid
timeline
    title Apple Inc. — selected milestones
    1976 : Founded by Jobs, Wozniak, Wayne (Apple I)
    1980 : IPO on Nasdaq, Dec 12
    1984 : Macintosh launched
    1997 : Jobs returns; Microsoft USD 150M investment
    2001 : iPod launched; first Apple Stores open
    2007 : iPhone launched (Jan 9)
    2010 : iPad launched
    2011 : Tim Cook becomes CEO (Aug)
    2014 : Apple Watch announced (launched 2015); Apple Pay
    2018 : First USD 1T market cap (Aug 2)
    2020 : Apple Silicon (M1) Macs ship; Apple One bundle
    2022 : First USD 3T market cap (Jan 3, intraday)
    2024 : Apple Vision Pro launched (Feb); Apple Intelligence announced (Jun)
    2025 : EU DMA fine EUR 500M; DOJ smartphone suit clears motion-to-dismiss; iPhone 17 / Air launch
    2026 : Q2 record revenue USD 111.2B; new USD 100B buyback; WWDC Siri overhaul scheduled (Jun)
```
...
```mermaid
graph TD
    A[Apple Inc.] --> B[iPhone — 50% of FY25 sales]
    A --> C[Mac — 8%]
    A --> D[iPad — 7%]
    A --> E[Wearables, Home & Acc. — 9%]
    A --> F[Services — 26%]
    B --> B1[iPhone 17 Pro]
    B --> B2[iPhone Air]
    B --> B3[iPhone 17]
    ...
    C --> C2[MacBook Pro]
    C --> C3[MacBook Neo]
    C --> C4[iMac, Mac mini, Mac Studio, Mac Pro]
    D --> D1[iPad Pro]
    D --> D2[iPad Air]
    D --> D3[iPad / iPad mini]
    E --> E1[Apple Watch — Series, Ultra, SE]
    E --> E2[AirPods — Pro, Max, regular]
    E --> E3[Apple Vision Pro]
    E --> E4[HomePod, HomePod mini, Apple TV]
    F --> F1[App Store]
    F --> F2[Advertising]
    F --> F3[iCloud / Cloud Services]
    F --> F4[AppleCare]
    F --> F5[Apple Music / TV+ / Arcade / Fitness+ / News+ / Books]
    F --> F6[Apple Pay / Card / Cash]
    F --> F7[Google search-licensing]
```
...
```mermaid
pie title FY2025 net sales by reportable segment (USD B)
    "Americas (186.7)" : 186.699
    "Europe (102.7)" : 102.686
    "Greater China (64.4)" : 64.377
    "Japan (28.7)" : 28.703
    "Rest of Asia Pacific (33.7)" : 33.696
```
...
```mermaid
quadrantChart
    title Apple competitive positioning — premium ASP vs. ecosystem integration
    x-axis "Low integration" --> "High integration"
    y-axis "Mass-market ASP" --> "Premium ASP"
    quadrant-1 "Differentiated premium"
    quadrant-2 "Boutique"
    quadrant-3 "Mass-market commodity"
    quadrant-4 "Volume scaled"
    "Apple": [0.92, 0.95]
    "Samsung": [0.55, 0.78]
    "Google (Pixel)": [0.7, 0.7]
    "Xiaomi": [0.4, 0.3]
    "Huawei": [0.65, 0.62]
    "Microsoft (Surface)": [0.5, 0.6]
    "Meta (Quest XR)": [0.45, 0.35]
    "Sony (XR/Audio)": [0.4, 0.55]
```
