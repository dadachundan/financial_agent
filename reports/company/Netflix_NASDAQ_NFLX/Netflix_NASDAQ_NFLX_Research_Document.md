...
![Revenue & operating margin trend](charts/nflx_revenue_margin.png)
...
![Content amortization vs. free cash flow, FY2021–FY2025](charts/nflx_fcf_content.png)
...
![Netflix vs. peers — TTM P/E and P/S](charts/nflx_peer_multiples.png)
...
```mermaid
timeline
    title Netflix — Key Milestones
    1997 : Founded by Reed Hastings & Marc Randolph in Scotts Valley, CA
    1998 : DVD-by-mail service launches
    2002 : IPO on NASDAQ — $15/share, $310M valuation
    2007 : "Watch Now" streaming service launches
    2010 : International expansion begins (Canada)
    2013 : First original — House of Cards — debuts; Emmy nominations follow
    2016 : Global rollout — service available in 190+ countries
    2017 : Crosses 100M paid memberships
    2020 : COVID surge; subs hit 200M
    2022 : Ad-supported plan launches; paid-sharing crackdown begins
    2023 : Co-CEO structure formalized (Sarandos & Peters); DVD service ends
    2025 : Revenue $45.2B, op margin 29.5%, 325M+ paid memberships; 10-for-1 stock split
    2026 : Announces (Dec 2025) & terminates (Feb 2026) $72B WBD acquisition
```
...
![Quarterly revenue and operating margin, Q1'24 to Q1'26](charts/nflx_quarterly_trend.png)
...
```mermaid
graph TD
    A[Netflix Service] --> B[Subscription Tiers]
    A --> C[Content Catalog]
    A --> D[Adjacent Products]

    B --> B1[Standard with Ads — $7.99]
    B --> B2[Standard — $17.99]
    B --> B3[Premium — $24.99]
    B --> B4[Extra Member sub-accounts]

    C --> C1[Originals — series, films, anime]
    C --> C2[Licensed library — TV & film]
    C --> C3[Live programming — sports, comedy, events]
    C --> C4[Games — cloud-first + mobile, 100+ titles]
    C --> C5[Stand-up specials]
    C --> C6[Documentaries / reality / podcasts]

    D --> D1[Netflix Ads platform]
    D --> D2[Consumer products & merchandise]
    D --> D3[Netflix House — physical experiences]
    D --> D4[Tudum.com — companion content site]
```
...
![Regional revenue mix FY2025](charts/nflx_regional_mix.png)
...
```mermaid
pie title FY2025 revenue by source ($45.2B total)
    "Subscription revenue (UCAN, EMEA, LATAM, APAC)" : 43.6
    "Advertising revenue" : 1.5
    "Other (consumer products, live events)" : 0.1
```
...
![Global SVOD revenue pool, 2021–2030E](charts/nflx_svod_tam.png)
