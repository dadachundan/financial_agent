...
timeline
    title 美团关键里程碑
    2010-03 : 美团网上线，对标 Groupon，团购起家
    2013    : 推出外卖业务 (food delivery)，开启第二曲线
    2014    : 拿下"千团大战"60%+ 份额，A/B/C 轮融资完成
    2015-10 : 与点评 Dianping 合并，组建"新美大"
    2017-04 : 27 亿美元收购摩拜单车 (Mobike)
    2018-09 : 港交所 IPO，发行价 HK$69，募资约 USD 4.2 bn
    2020-09 : 公司正式更名为"美团"，去"点评"标
    2021    : 反垄断处罚 USD 478 mn (二选一)
    2023-05 : 海外 KeeTa 在中国香港首发
    2024-09 : KeeTa 进入沙特阿拉伯利雅得
    2025    : KeeTa 进入卡塔尔/阿联酋/巴西；FY2025 净亏 RMB 23.4 bn
    2026-Q1 : 计划发布 Q1 2026 业绩 (2026-06-01)
```
...
```mermaid
graph TD
    Meituan[美团 Meituan 3690.HK]
    Meituan --> CLC[核心本地商业 Core Local Commerce]
    Meituan --> NI[新业务 New Initiatives]
    CLC --> CLC1[餐饮外卖 Food Delivery]
    CLC --> CLC2[即时零售 Instashopping 闪购]
    CLC --> CLC3[到店餐饮 In-store Dining]
    CLC --> CLC4[到店综合 In-store Comprehensive]
    CLC --> CLC5[酒店 Hotel]
    CLC --> CLC6[旅游 Travel]
    NI --> NI1[小象超市 Xiaoxiang Supermarket]
    NI --> NI2[美团优选 Meituan Select]
    NI --> NI3[快驴 Kuailv B2B]
    NI --> NI4[美团单车 Meituan Bike]
    NI --> NI5[餐饮 SaaS Restaurant SaaS]
    NI --> NI6[KeeTa 海外]
    NI --> NI7[充电宝 Power Bank]
    NI --> NI8[LongCat / AI Assistant 小美/小团]
```
...
```mermaid
pie title 美团生态的四类"客户"
    "C 端消费者 (770+ mn ATU)" : 60
    "B 端商户 (14.5 mn AAM)" : 15
    "骑手网络 (700+ mn 累计)" : 15
    "海外 KeeTa 用户/商户" : 10
```
...
quadrantChart
    ...
    "JD.com 外卖": [0.55, 0.65]
    "抖音生活服务": [0.45, 0.70]
    "携程 Trip.com": [0.30, 0.55]
    "饿了么 Ele.me": [0.60, 0.55]
    "京东到家": [0.35, 0.45]
```
...
```mermaid
xychart-beta
    title "美团收入 (RMB bn) FY2021–FY2025"
    x-axis [FY2021, FY2022, FY2023, FY2024, FY2025]
    y-axis "Revenue (RMB bn)" 0 --> 400
    bar [179, 220, 277, 338, 365]
```
