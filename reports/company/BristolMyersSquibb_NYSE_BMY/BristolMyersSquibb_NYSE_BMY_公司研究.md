...
```mermaid
timeline
    title BMS 关键里程碑 (1887–2026)
    1887 : Clinton Pharmaceutical Company 在纽约成立
    1989 : Bristol-Myers 与 Squibb 合并为 Bristol-Myers Squibb
    2009 : 启动 "string-of-pearls" BD 战略，剥离非核心业务
    2014 : Opdivo (nivolumab) 在日本首获批，开启 PD-1 时代
    2019 : 以 74B USD 收购 Celgene，获得 Revlimid / Pomalyst / Reblozyl
    2024 : 以 14B USD 收购 Karuna，获 KarXT（后命名 Cobenfy）
    2024 : 以 4.1B USD 收购 RayzeBio，进入放射性核素治疗
    2024 : 以 4.8B USD 收购 Mirati，获 Krazati (KRAS G12C)
    2025 : Cobenfy 获 FDA 批准用于精神分裂症（30 年来首个全新机制）
    2025 : 与 BioNTech 合作开发 pumitamig (PD-L1/VEGF 双抗)
    2026 : 与中国恒瑞医药签署 15.2B USD 全球战略协议（13 个项目）
```
...
```mermaid
graph TD
    BMS[Bristol Myers Squibb<br/>FY2025 Total Rev: $48.2B]
    BMS --> GP[Growth Portfolio<br/>$26.4B / +17% YoY]
    BMS --> LP[Legacy Portfolio<br/>$21.8B / -15% YoY]

    GP --> IO[Immuno-Oncology<br/>$14.6B]
    GP --> Hem[Hematology<br/>$4.5B]
    GP --> Immu[Immunology<br/>$4.0B]
    GP --> CV[Cardiovascular<br/>$1.1B]
    GP --> Neuro[Neuroscience<br/>$0.16B<br/>新产品 Cobenfy]
    GP --> Onc[Targeted Oncology<br/>$0.2B<br/>Krazati]

    IO --> Opdivo[Opdivo<br/>$10.0B]
    IO --> Yervoy[Yervoy<br/>$2.9B]
    IO --> Opdualag[Opdualag<br/>$1.2B]
    IO --> Qvantig[Opdivo Qvantig<br/>$0.2B]

    Hem --> Reblozyl[Reblozyl<br/>$2.3B]
    Hem --> Breyanzi[Breyanzi CAR-T<br/>$1.4B]
    Hem --> Abecma[Abecma CAR-T<br/>$0.4B]

    Immu --> Orencia[Orencia<br/>$3.7B]
    Immu --> Sotyktu[Sotyktu TYK2<br/>$0.3B]

    CV --> Camzyos[Camzyos<br/>$1.1B]

    LP --> Eliquis[Eliquis<br/>$14.4B]
    LP --> Revlimid[Revlimid<br/>$3.0B / -49%]
    LP --> Pomalyst[Pomalyst<br/>$2.7B / -23%]
    LP --> Other[Sprycel/Abraxane/其他<br/>$1.7B]
```
...
```mermaid
graph LR
    A[Legacy 现金流<br/>$22B/yr<br/>IRA + LOE 压力] -->|资本配置| B[BD + 并购]
    B --> C[新平台产品]
    C --> D[Growth Portfolio<br/>$26B/yr +17% YoY]
    D --> E[2027 后稳态增长]

    F[Hengrui 协议 $15.2B<br/>13 项目早期资产] --> B
    G[BioNTech pumitamig<br/>PD-L1/VEGF 双抗] --> B
    H[Karuna $14B<br/>Cobenfy] --> C
    I[RayzeBio $4.1B<br/>放射性核素] --> C
    J[Mirati $4.8B<br/>Krazati] --> C
```
...
```mermaid
pie title BMS 客户集中度 — FY2025 (% of consolidated revenue)
    "McKesson" : 36
    "Cencora" : 29
    "Cardinal Health" : 22
    "其他客户" : 13
...
quadrantChart
    ...
    quadrant-3 低成长高悬崖压力
    quadrant-4 现金牛但低成长
    "Eli Lilly LLY": [0.85, 0.95]
    "Merck MRK": [0.55, 0.65]
    "AbbVie ABBV": [0.30, 0.50]
    "Bristol Myers BMY": [0.20, 0.45]
    "Pfizer PFE": [0.25, 0.30]
    "Johnson Johnson JNJ": [0.70, 0.40]
    "AstraZeneca AZN": [0.65, 0.70]
    "Novartis NVS": [0.60, 0.55]
```
