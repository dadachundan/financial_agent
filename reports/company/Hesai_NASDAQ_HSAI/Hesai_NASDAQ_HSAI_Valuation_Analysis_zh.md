...
| 指标 | Q1 2026 实际 | Q1'26 管理层指引 | 我们 FY26E 基础 | 解读 |
|---|---:|---:|---:|:---|
| 净收入(人民币百万元) | **680.6**(+29.6% YoY) | 650-700 | 不适用 | 指引中位数 |
| 毛利率 | **39.1%** | 不适用 | 41.8% | 较我们 FY26 低 270 bps |
| GAAP 净利润(人民币百万元) | **18.3** | 不适用 | 433(全年) | 连续 4 个盈利季 |
| 非 GAAP 净利润(人民币百万元) | **47.7**(+452.9%) | 不适用 | 不适用 | 强劲;股权激励调整后 |
| 总出货量 | **471,723**(+140.9%) | 不适用 | 3,300K(全年) | Q1 = FY26 的 14% |
| ADAS 出货 | 353,441(+141.9%) | 不适用 | 2,700K | 按节奏推进 |
| Robotics 出货 | 118,282(+137.8%) | 不适用 | 600K | 超前 —— 暗示人形/扫地机器人放量更快 |
| Robotics 占单位比 | 25% | 不适用 | 18%(全年) | 占比上升 = 2H 毛利率潜在顺风 |
...
| # | 原催化剂 | 2026 年 5 月 19 日状态 |
|---|---|---|
| 1 | Q1 FY26 业绩 —— 指引 6.5-7 亿元 | ✅ **已触发** —— 6.806 亿元(指引中位数),出货 +141% |
