...
```mermaid
timeline
    title 华虹半导体关键里程碑（1996 – 2026）
    1996 : 上海华虹（集团）有限公司成立 — 909 工程核心载体
    1997 : 华虹 NEC 合资公司成立，首条 8 英寸产线投产
    2003 : 上海宏力半导体（Grace Semi）成立，发展第二条 8 英寸产线
    2011 : 香港注册 Hua Hong Semiconductor Limited 控股公司成立
    2013 : 公司在港交所主板上市（股份代号 01347）
    2013 : 华虹 NEC 与上海宏力合并 — 形成上海华虹宏力半导体制造有限公司
    2018 : 无锡第一条 12 英寸特色工艺产线 (FAB7) 投产
    2022 : 全年销售额突破 US$ 24.7 亿，行业景气高点
    2023 : 8 月 7 日 A 股科创板上市（证券代码 688347）
    2024 : 12 月 FAB9（华虹制造 / 无锡二期）开始风险量产
    2025 : FAB9 产能快速爬坡，12 月单月超 4 万片；12 英寸营收占比约 60%
    2025-10 : 唐均君卸任董事长，白鹏博士接任总裁兼董事长
    2026-Q1 : 拟收购上海华力微电子事项获上交所受理，进入实质审核
```
...
```mermaid
graph TD
    A[华虹半导体<br/>5 大特色工艺平台]
    A --> B[嵌入式非易失性存储<br/>eNVM<br/>FY25: ¥43.62亿 25.4%]
    A --> C[独立式非易失性存储<br/>Standalone NVM<br/>FY25: ¥13.39亿 7.8%]
    A --> D[功率器件<br/>Power Discretes<br/>FY25: ¥47.65亿 27.8%]
    A --> E[模拟与电源管理<br/>Analog & PMIC<br/>FY25: ¥45.60亿 26.6%]
    A --> F[逻辑与射频<br/>Logic & RF<br/>FY25: ¥21.19亿 12.4%]
    B --> B1[40nm eFlash COT 风险量产]
    B --> B2[55nm eFlash 大规模量产<br/>车规级 MCU 多平台供货]
    B --> B3[智能卡芯片 IC 卡 55nm]
    C --> C1[48nm NOR Flash 量产<br/>占出货比例大幅提升]
    C --> C2[ETOX Flash<br/>NORD Flash]
    D --> D1[1.6μm IGBT 国际领先<br/>EV 主驱逆变器]
    D --> D2[Super Junction MOSFET]
    D --> D3[Power GaN 化合物半导体研发]
    D --> D4[650/750/1000/1200V 系列<br/>新增 800V]
    E --> E1[0.18μm BCD 120V<br/>汽车 48V 系统]
    E --> E2[90nm BCD 量产<br/>BCD+ 集成方案]
    E --> E3[BCD+eFlash 集成]
    F --> F1[40nm 超低功耗 量产<br/>IoT/可穿戴]
    F --> F2[55/40nm 特色工艺<br/>RFCMOS 稳定量产]
    F --> F3[65nm RF SOI 增长]
    F --> F4[CIS 图像传感器<br/>智能手机主摄]
```
...
```mermaid
pie title FY2025 营收按前 5 大客户集中度 (¥ 亿元)
    "客户一" : 14.68
    "客户二" : 13.24
    "客户三" : 13.12
    "客户四" : 9.53
...
```mermaid
graph LR
    A[全球纯晶圆代工市场<br/>2025: ~US$ 1,700B 估算]
    A --> B[先进逻辑代工<br/>≤7nm]
    A --> C[特色工艺 / 成熟逻辑代工<br/>0.35μm – 28nm]
    B --> B1[台积电 TSMC<br/>NYSE: TSM<br/>份额 ~64%]
    B --> B2[三星代工 Samsung Foundry<br/>份额 ~9%]
    B --> B3[英特尔代工 Intel Foundry]
    C --> C1[联华电子 UMC<br/>NYSE: UMC]
    C --> C2[格芯 GlobalFoundries<br/>NASDAQ: GFS]
    C --> C3[华虹半导体<br/>HKEX:01347 / SSE:688347<br/>全球第 5 / 大陆第 2]
    C --> C4[中芯国际 SMIC<br/>SSE:688981 / HKEX:00981<br/>大陆第 1]
    C --> C5[力积电 PSMC<br/>TWSE:6770]
    C --> C6[世界先进 Vanguard<br/>TWSE:5347]
    C --> C7[台积电特殊节点子<br/>40/28/22nm BCD/eFlash]
```
