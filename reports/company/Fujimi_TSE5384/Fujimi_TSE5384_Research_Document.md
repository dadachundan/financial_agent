...
![Fujimi 10-yr revenue & operating margin](../../charts/fujimi_revenue_margin.png)
...
Fujimi was founded in **1950** in Nagoya, Aichi by **Teruji Koshiyama** to produce precision polishing powder for **optical lenses** — per the company's own account, "At the request of an optical device manufacturer, he began research and development of abrasives for polishing optical glass products such as lenses for sights. He succeeded in commercialization, launching production of the first synthetic precision abrasives made in Japan" [Integrated Report 2024 "Growth Trajectory" p.7](https://www.ircms.jp/irexport/fujimiinc/file/a79408181419746.pdf). The company was incorporated as a stock company on **20 March 1953**, with the head office and Biwajima Plant at Kiyosu, Aichi — the same location used today [Integrated Report 2024 "Corporate Profile" p.57](https://www.ircms.jp/irexport/fujimiinc/file/a79408181419746.pdf). The "Fujimi" name comes from the area's traditional view of Mount Fuji; the founder's personal foundation, **Koshiyama Science and Technology Foundation**, still holds 2.3 % of the shares, and the founder's holding company **Koma Co., Ltd. is the largest shareholder at 17.7 %** — the firm remains a founder-family-controlled business [Integrated Report 2024 "Stock Information" p.57](https://www.ircms.jp/irexport/fujimiinc/file/a79408181419746.pdf).

The product line walked the post-war Japanese electronics value chain:

```mermaid
timeline
    title Fujimi product-application timeline
    1950 : Founded — abrasives for optical lenses (germanium-era predecessor)
    1957 : Abrasives for germanium wafers (early transistor era)
    1967 : Abrasives for silicon wafers (Si replaces Ge)
    1969 : First commercial silicon-wafer polishing slurry shipment
    1983 : Abrasives for hard-disk substrates (Winchester drives ramp)
    1995 : PLANERLITE CMP slurry launched (CMP process commercialised)
    2000 : Thermal-spray materials business; Kakamigahara R&D Center opens
    2002 : Intel Preferred Quality Supplier Award
    2004 : Intel Supplier Continuous Quality Improvement Award (top honour)
    2010 : Fujimi Europe consolidated in Germany; CMP capacity expansion
    2011 : Fujimi Taiwan established (Tongluo, Miaoli) — dev + production
    2012 : Specialty Materials Division formed (non-semi diversification)
    2017 : Performance-linked stock benefit trust (BBT) for directors
    2021 : Kagamiyama New Plant land contract signed (Kakamigahara, Gifu)
    2023 : 3-for-1 stock split; dividend payout-ratio policy raised to 55 % min
    2024 : Acquired 75 % of Nanko Abrasives Industry Co., Ltd. (consolidated Oct)
    2024 : Kagamiyama New Plant construction starts (Oct)
    2025 : 2nd R&D Center construction starts (May); Kagamiyama plant nears completion
```
