...
```mermaid
timeline
    title Linde plc — 关键里程碑
    1879 : Carl von Linde 申请深冷空分专利（慕尼黑工大）
    1907 : Linde Air Products 在纽约 Tonawanda 开始驻厂供氧
    1992 : Praxair 从 Union Carbide 分拆，纽交所上市
    2017 : Praxair–Linde AG 合并宣布 (6/1)
    2018 : 合并完成 (10/31)；以 Linde plc 名义开始交易
    2021 : Sanjiv Lamba 任 COO (1月)；管理层过渡开启
    2022 : Lamba 任 CEO (3月)；FY22 调整后利润率达 25.5%
    2023 : 与 ExxonMobil 签订 Baytown 蓝氢 / NH3 首单
    2024 : 法兰克福退市；交易集中到纳斯达克
    2025 : 积压突破 100 亿美元；FY25 营收 340 亿美元、利润率 29.8%
    2026 : Lamba 当选董事长 (1/31)；Q1 FY26 EPS 指引上调
```
...
```mermaid
graph TD
    A[环 1：超大型驻厂吨级<br/>炼厂 / 钢厂 / 大型晶圆厂<br/>10–20 年照单照付] --> X[ASU + SMR + H2 管道]
    B[环 2：merchant + 散装<br/>焊接厂 / 中型晶圆厂 / 食品厂<br/>3–7 年需求合同] --> Y[LOX / LIN / LAR 槽车网络]
    C[环 3：包装 + 特种<br/>医院 / 实验室 / 电子特种 / R&D<br/>1–3 年 / PO] --> Z[钢瓶 + 特种气厂]
    X --> Linde[Linde plc 联产分子]
    Y --> Linde
    Z --> Linde
    Linde --> ER[Engineering EPC 板块<br/>建造三环对应的全部装置]
```
