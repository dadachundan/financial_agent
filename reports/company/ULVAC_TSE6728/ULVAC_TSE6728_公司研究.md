...
![ULVAC 营业收入与营业利润率走势 FY2021–FY2026E](../../charts/ulvac_revenue_margin.png)
...
```mermaid
timeline
    title ULVAC 重要里程碑（精选）
    1952 : 在神奈川县创立日本真空技術株式会社
    1955 : 大森工厂启动日本国内制造
    1961 : 进入真空冶金 → 溅射靶材料业务的种子
    1964 : 香港子公司（首个海外据点）
    1975 : 设立 ULVAC North America Corp.
    1982 : 设立 ULVAC TAIWAN Inc.；首批 FPD 溅射工具中标
    1987 : 设立 ULVAC GmbH（德国）——欧洲落脚点
    1995 : 设立 ULVAC KOREA Ltd.——服务三星 / LG 显示器扩产
    2001 : 集团更名为 ULVAC, Inc.
    2004 : 在东京证券交易所第一部上市
    2017 : 岩下节男出任社长兼 CEO
    2022 : 升级至东证 Prime 市场
    2025 : 发布 Value-Up Plan（FY2025.6–FY2027.6），目标 FY26 销售 ¥3,000 亿、营业利润率 16%
    2025-08 : 宣布将中国 FPD 溅射靶子公司剥离至 KFMI / Fengke 合资公司
    2026-05 : 史上最强 9 个月接单 ¥2,362 亿（同比 +44%）；FY26 营业利润指引下修至 ¥190 亿
```
...
```mermaid
graph TD
    A[ULVAC, Inc.<br/>FY26E 销售 ¥2,600 亿] --> B[真空设备<br/>占比约 79%, 营业利润率约 8.5%]
    A --> C[真空应用<br/>占比约 21%, 营业利润率约 4.5%]
    B --> B1[半导体与电子器件<br/>约 ¥1,005 亿 FY26E]
    B --> B2[显示器与能源<br/>生产设备<br/>约 ¥390 亿 FY26E]
    B --> B3[零部件<br/>约 ¥350 亿 FY26E]
    B --> B4[工业设备<br/>约 ¥200 亿 FY26E]
    C --> C1[材料<br/>溅射靶等<br/>约 ¥235 亿 FY26E]
    C --> C2[其他<br/>掩膜基板、表面分析<br/>约 ¥320 亿 FY26E]
    B1 --> B1a[溅射 / MHM / 灰化<br/>成熟制程逻辑 + 存储<br/>+ 先进封装]
    B2 --> B2a[OLED 蒸发 + 溅射<br/>EV 电池研发<br/>卷对卷]
    B3 --> B3a[分子涡轮泵、干式真空泵<br/>检漏仪、测量仪]
    B4 --> B4a[稀土永磁设备<br/>研发用真空系统]
    C1 --> C1a[铝 / 钛 / 铜 / 钼 / 钨<br/>ITO / IGZO 靶材]
    C2 --> C2a[PHI 表面分析<br/>OLED 掩膜基板]
```
...
![ULVAC FY26E 分部结构与 FY25 区域分布](../../charts/ulvac_segment_geo_mix.png)
