...
**Date:** 2026-05-24 (Step 10 verification pass applied — see verification log below)
**Ticker:** NASDAQ: AMBA
...
![Revenue and gross margin trend](charts/amba_revenue_gm_trend.png)
...
**Valuation snapshot (as of 2026-05-20).** Ambarella closed at **USD 84.28**, with a market cap of **USD 3.70 billion** on 43.86 million ordinary shares outstanding ([Yahoo Finance, AMBA quote, 2026-05-20](https://finance.yahoo.com/quote/AMBA/)). Trailing twelve-month figures: **TTM P/E is not meaningful** (GAAP net loss of USD 75.9 million in FY2026); **forward P/E is ~77.6×** consensus, **TTM P/S is 9.46×** (USD 3.70 bn market cap ÷ USD 390.7 mn TTM revenue), **P/B is 6.1×**, **EV/Revenue 8.5×** and **EV/EBITDA is negative (–48×)** as the company is still EBITDA-loss-making on a GAAP basis ([Yahoo Finance Key Statistics, AMBA, 2026-05-20](https://finance.yahoo.com/quote/AMBA/key-statistics)).
...
![TTM P/S peer comparison](charts/amba_ps_peers.png)
...
```mermaid
timeline
    title Ambarella — 2004 to 2026 milestones
    2004 : Founded in Cayman Islands by Fermi Wang, Les Kohn, Didier LeGall
    2007 : First broadcast HD video encoder ships; #1 in broadcast
    2009 : Solid-state camcorder wins (Flip, Sony, Samsung)
    2012 : IPO on Nasdaq (October 2012) — A1 / A5 SoCs
    2014 : GoPro Hero4 ships powered by Ambarella A9 — peak consumer era
    2015 : Acquires VisLab S.r.l. (Italy) — autonomous-driving research
    2016 : DJI Phantom 4, Mavic adopt Ambarella SoCs (drones)
    2017 : GoPro switches Hero6 to in-house GP1 silicon (Socionext-designed)
    2018 : Launches CVflow architecture — first generation CV1 / CV2 SoCs
    2019 : Consumer revenue continues to decline as Hero7 / Hero8 stay off Ambarella
    2020 : COVID demand spike — security & dash cams pull through
    2021 : Acquires Oculii (Nov 2021) — 4D imaging radar perception
    2022 : Launches CV3-AD family — automotive AI domain controllers
    2023 : Announces CV3-AD685 in Continental ADAS reference design
    2024 : Inventory correction; CFO transition — John Young appointed Feb 2024
    2025 : CV7 (8K edge-AI), N1 family unveiled for generative AI on edge
    2026 : Revenue +37% YoY to $390.7M; CV7 4nm announced at CES; non-GAAP back to profit
```
...
```mermaid
graph TD
    A[Ambarella SoC portfolio] --> B[CVflow AI SoCs]
    A --> C[N1 family — generative AI on edge]
    A --> D[Oculii AI Radar Software]
    A --> E[Cooper Developer Platform]
    B --> B1[CV3 family — automotive AI domain controllers]
    B1 --> B1a[CV3-AD685 — L2+ to L4 ADAS/AD]
    B1 --> B1b[CV3-AD635 — L2/L2+ ADAS]
    B1 --> B1c[CV3-AD655 — premium ADAS]
    B --> B2[CV7 family — 8K edge AI]
    B2 --> B2a[CV7 — 8KP60 consumer/robotics]
    B2 --> B2b[CV72 / CV72S — 4KP60+ security/IP cam]
    B2 --> B2c[CV75A / CV75S — 4KP30+ DMS/security]
    B --> B3[CV5 family — 8K low-power consumer]
    B3 --> B3a[CV5 — sports/VR cameras]
    B3 --> B3b[CV5S — security multi-stream]
    B3 --> B3c[CV52 / CV52S — 4K security]
    B --> B4[CV2 / CV22 / CV25 / CV28 — gen-2 CVflow, deployed base]
    C --> C1[N1 — multi-modal LLMs at edge]
    C --> C2[N1-655 — robotics & smart-city]
```
...
```mermaid
pie title FY2026 revenue by channel (Ambarella, % of total)
    "WT Microelectronics (distributor, Asia ex-Japan)" : 70
    "Other distributors and direct OEM/Tier-1" : 30
```
...
![Distributor concentration trend](charts/amba_customer_concentration.png)
...
```mermaid
quadrantChart
    title Edge-AI vision SoC competitive positioning (qualitative)
    x-axis "Lower AI performance" --> "Higher AI performance"
    y-axis "Lower power efficiency" --> "Higher power efficiency"
    quadrant-1 "Performance leaders"
    quadrant-2 "Power-efficient leaders"
    quadrant-3 "Legacy / commodity"
    quadrant-4 "Performance, power-hungry"
    "Ambarella CV3-AD/CV7/N1" : [0.72, 0.82]
    "NVIDIA Jetson Orin/Thor" : [0.95, 0.45]
    "Mobileye EyeQ6H" : [0.62, 0.78]
    "Qualcomm Snapdragon Ride" : [0.85, 0.55]
    "TI TDA4" : [0.45, 0.65]
    "Horizon Robotics J5/J6" : [0.65, 0.60]
    "Novatek vision SoCs" : [0.35, 0.55]
    "HiSilicon (sanctioned)" : [0.55, 0.65]
```
...
**3. Key-person dependency on Fermi Wang.** Founder-led companies live and die by founder execution; Wang is the architectural and strategic decision-maker, and has been for 22 years. He is not super-voting and there is no disclosed succession plan in the proxy. Loss of Wang for any reason would materially impair the next product cycle.
...
![R&D, SG&A and GAAP operating loss](charts/amba_opex_opl.png)
...
![Cash and marketable securities](charts/amba_cash_balance.png)
...
**11. Persistent GAAP losses and R&D-driven cash burn.** GAAP operating loss was **USD 82.5 million in FY2026** (improving from USD 126.6 mn FY2025 and USD 154.6 mn FY2024), with **R&D at 61% of revenue** in FY2026 — a structurally heavy R&D burden tied to leading-edge node design (4 nm CV7, 2 nm in development). Non-GAAP profitability returned in FY2026 (USD 26.9 mn net income), but GAAP profitability requires either materially higher revenue (USD 500–600 mn) or sustained R&D restraint that the company has not historically demonstrated. Mitigant: USD 312.6 million combined cash + marketable securities and no debt provides ~3.5 years of runway at current cash-burn pace.

**12. Valuation / multiple-compression risk (MATERIAL).** Trading at **9.5× TTM P/S** and **~77.6× forward P/E** ([Yahoo Finance, AMBA Key Statistics, 2026-05-20](https://finance.yahoo.com/quote/AMBA/key-statistics)) — multiples that imply sustained 25%+ revenue growth and a path to high-teens operating margins. Either growth deceleration (an automotive design-win miss, a slower-than-expected CV3 ramp) or sector-wide multiple compression (an AI-narrative pullback) could re-rate the stock 30–50%. Peer median TTM P/S is ~5.0× (excluding NVDA outlier); a re-rate to peer-median territory implies ~50% downside before any earnings-power debate.
