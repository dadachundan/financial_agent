...
![TTM P/S 同业比较](charts/amba_ps_peers.png)
...
```mermaid
timeline
    title Ambarella — 2004 至 2026 重大里程碑
    2004 : 由 Fermi Wang、Les Kohn、Didier LeGall 在开曼群岛创立
    2007 : 首款广播 HD 视频编码器出货; 居广播市场第一
    2009 : 拿下固态便携摄像机大单 (Flip、Sony、Samsung)
    2012 : 2012 年 10 月在纳斯达克 IPO — 推出 A1 / A5 SoC
    2014 : GoPro Hero4 搭载 Ambarella A9 出货 — 消费时代的巅峰
    2015 : 收购意大利 VisLab S.r.l. — 自动驾驶研究
    2016 : DJI Phantom 4、Mavic 采用 Ambarella SoC (无人机)
    2017 : GoPro Hero6 切换至自研 GP1 硅片 (Socionext 设计)
    2018 : 推出 CVflow 架构 — 第一代 CV1 / CV2 SoC
    2019 : Hero7 / Hero8 持续不用 Ambarella, 消费营业收入继续下滑
    2020 : 新冠疫情需求激增 — 安防与行车记录仪拉动
    2021 : 2021 年 11 月收购 Oculii — 4D 成像雷达感知
    2022 : 推出 CV3-AD 系列 — 车载 AI 域控制器
...
![季度营业收入: 2025 财年 vs 2026 财年](charts/amba_quarterly_revenue.png)
...
```mermaid
graph TD
    A[Ambarella SoC 产品组合] --> B[CVflow AI SoC]
    A --> C[N1 家族 — 边缘端生成式 AI]
    A --> D[Oculii AI Radar 软件]
    A --> E[Cooper 开发者平台]
    B --> B1[CV3 家族 — 车载 AI 域控制器]
    B1 --> B1a[CV3-AD685 — L2+ 至 L4 ADAS/AD]
    B1 --> B1b[CV3-AD635 — L2/L2+ ADAS]
    B1 --> B1c[CV3-AD655 — 高端 ADAS]
    B --> B2[CV7 家族 — 8K 边缘 AI]
    B2 --> B2a[CV7 — 8KP60 消费/机器人]
    B2 --> B2b[CV72 / CV72S — 4KP60+ 安防/IP cam]
    B2 --> B2c[CV75A / CV75S — 4KP30+ DMS/安防]
    B --> B3[CV5 家族 — 8K 低功耗消费]
    B3 --> B3a[CV5 — 运动/VR 相机]
    B3 --> B3b[CV5S — 安防多流]
    B3 --> B3c[CV52 / CV52S — 4K 安防]
    B --> B4[CV2 / CV22 / CV25 / CV28 — 第二代 CVflow, 部署存量]
    C --> C1[N1 — 边缘端多模态 LLM]
    C --> C2[N1-655 — 机器人与智慧城市]
```
...
```mermaid
pie title 2026 财年按渠道划分的营业收入 (Ambarella, 占总营业收入)
    "WT Microelectronics (分销商, 日本以外亚洲)" : 70
    "其他分销商与直接 OEM/Tier-1" : 30
```
...
![分销商集中度走势](charts/amba_customer_concentration.png)
...
```mermaid
quadrantChart
    title 边缘 AI 视觉 SoC 竞争定位 (定性)
    x-axis "较低 AI 性能" --> "较高 AI 性能"
    y-axis "较低能效" --> "较高能效"
    quadrant-1 "性能领导者"
    quadrant-2 "能效领导者"
    quadrant-3 "传统/通用"
...
![研发、SG&A 与 GAAP 营业亏损](charts/amba_opex_opl.png)
...
![现金与可销售证券](charts/amba_cash_balance.png)
...
<details>
<summary>核验日志 (第 10 步) — 2026-05-24</summary>
