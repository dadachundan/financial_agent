...
```mermaid
timeline
  title Amazon — selected milestones
  1994 : Founded by Jeff Bezos in Bellevue, WA
  1995 : Launches Amazon.com online bookstore
  1997 : Nasdaq IPO (15 May)
  2002 : Begins selling web services to third parties (precursor to AWS)
  2005 : Launches Amazon Prime ($79/yr, 2-day shipping in U.S.)
  2006 : Launches AWS (Simple Storage Service S3, EC2 compute)
  2007 : Launches Kindle e-reader
  2014 : Echo / Alexa launched
  2017 : Acquires Whole Foods Market for $13.7 bn
  2018 : Announces HQ2 (Arlington, VA + Long Island City, NY — LIC cancelled 2019)
  2020 : Pandemic surge — net sales jump 38% to $386 bn
  2021 : Andy Jassy succeeds Bezos as CEO (5 July)
  2022 : Acquires One Medical ($3.9 bn); MGM Studios ($8.5 bn)
  2023 : First Trainium2 silicon announced; $4 bn initial Anthropic commitment
  2024 : Project Kuiper first satellites; Trainium2 in GA at AWS
  2025 : $2.5 bn FTC Prime settlement (Sep); Anthropic equity step-up; project Hail Mary film
  2026 : Q1 AWS +28%; Amazon Leo (formerly Kuiper) commercial customer launch with Delta
```
...
```mermaid
graph TD
  A[Amazon.com Inc.] --> B[North America segment]
  A --> C[International segment]
  A --> D[AWS segment]
  B --> B1[Online Stores 1P retail]
  B --> B2[3P Marketplace / FBA]
  B --> B3[Physical stores: Whole Foods, Fresh, Go, 4-star, Books]
  B --> B4[Advertising services]
  B --> B5[Subscriptions: Prime, Audible, Kindle Unlimited, Music, Luna]
  B --> B6[Devices: Echo / Alexa, Fire TV, Kindle, Ring, Blink, eero]
  B --> B7[Healthcare: Pharmacy, One Medical, Clinic, Health AI]
  B --> B8[Logistics: Buy with Prime, Multi-Channel Fulfillment]
  C --> C1[Local marketplaces: amazon.co.uk, .de, .jp, .in, .com.br, etc.]
  C --> C2[Prime Video, Music, ads-supported]
  C --> C3[International Stores 1P + 3P, FBA, Devices, Ads]
  D --> D1[Compute: EC2, Graviton, Trainium, Inferentia, ECS, EKS, Lambda]
  D --> D2[Storage / DB: S3, EBS, Glacier, RDS, DynamoDB, Aurora, Redshift]
  D --> D3[AI/ML: Bedrock, SageMaker, Q, Kiro, AgentCore, Bio Discovery]
  D --> D4[Networking: VPC, CloudFront, Route 53, Direct Connect]
  D --> D5[Productivity: Connect, Quick, WorkSpaces, Chime]
  D --> D6[Satellite: Amazon Leo / Project Kuiper]
```
...
```mermaid
pie title FY2025 net sales by reporting segment ($ bn, total $716.9bn)
  "North America" : 426.305
  "International" : 161.894
  "AWS" : 128.725
```
