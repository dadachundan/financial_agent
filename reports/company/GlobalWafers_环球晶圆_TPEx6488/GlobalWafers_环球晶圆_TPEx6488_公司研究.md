...
![3 年财务一览](../../charts/globalwafers_financials_3yr.png)
...
```mermaid
timeline
    title 环球晶圆 (GlobalWafers) 关键里程碑
    1981 : 中美晶 (SAS) 成立，主营硅锭与硅片切割代工
    2007 : 盧明光接任 SAS CEO，启动半导体 + 太阳能双轨战略
    2008 : 收购美国 Globitech (Texas 磊晶片厂)
    2011 : SAS 拆分半导体硅片业务，环球晶圆挂牌 TPEx:6488；徐秀蘭出任董事长
    2012 : 收购日本 Covalent Materials (Toshiba 旗下硅片厂)
    2016 : 收购丹麦 Topsil (FZ HV) + 美国 SunEdison Semiconductor (USD 683 mn)
    2017 : 整合 SunEdison/MEMC，市占率升至全球第三
    2020 : 宣告 EUR 4.35 bn 收购 Siltronic AG (德国硅片厂)
    2022 : Siltronic 收购破局；改投 NT$100 bn 三年扩产 (台/美/日/韩/欧)
    2024 : 美 CHIPS Act 确认补贴 USD 406 mn 给 Sherman 厂
    2025 : Sherman 12 寸一期开幕；同日宣告 2 期 USD 4 bn 扩产 (总投 USD 7.5 bn)
    2026 : 野村从 Neutral 上调至 Buy，TP TWD 850；Q1 2026 定调周期谷底
```
...
```mermaid
graph LR
  A[Poly-Si<br/>多晶硅料] --> B[CZ 单晶硅锭<br/>Czochralski Ingot]
  A --> C[FZ 单晶硅锭<br/>Float-Zone Ingot]
  B --> D[Slicing<br/>切片]
  C --> D
  D --> E[Lapping + Polishing<br/>研磨 + 抛光]
  E --> F[Polished Wafer<br/>抛光片]
  F --> G[Epi CVD<br/>磊晶生长]
  G --> H[Epi Wafer<br/>磊晶片]
  F --> I[H2 Anneal<br/>氢退火]
  I --> J[Annealed Wafer<br/>退火片]
  F --> K[Smart Cut / BESOI<br/>键合 + 减薄]
  K --> L[SOI Wafer<br/>绝缘体上硅]
  F --> M[Diffusion<br/>扩散]
  M --> N[Diffusion Wafer<br/>扩散片]
  H --> TSMC[TSMC / Samsung / Intel 先进逻辑]
  J --> Memory[Micron / SK Hynix / Samsung HBM/DRAM]
  L --> Soitec[Soitec / GlobalFoundries / STM RF/光子 SOI]
  N --> Power[Infineon / Onsemi / TI 功率器件]
```
