...
![Schneider Electric Revenue & Margin FY2021–FY2025](charts/schneider_revenue_margin.png)
...
```mermaid
timeline
    title Schneider Electric 重大里程碑 / Key Milestones
    1836 : Schneider 兄弟接手 Le Creusot 炼铁厂
    1988 : 收购 Télémécanique (工业控制)
    1991 : 收购 Square D (美国低压配电)
    1992 : 收购 Merlin Gerin (法国配电)
    1999 : 正式更名为 Schneider Electric
    2007 : 收购 APC ($6.1 bn) — 数据中心 UPS 龙头
    2017 : 与 AVEVA 合并取得多数股权
    2022 : 上调对 AVEVA 全面要约收购
    2023 : AVEVA 私有化 (£3.1 bn 现金部分) 完成
    2024 : 收购 Motivair 液冷 75% 股权 ($850 mn)
    2025 : 营收首次突破 €40 bn 历史里程碑
```
...
![Schneider Electric Segment Mix FY2025](charts/schneider_segment_mix.png)
...
```mermaid
graph LR
    A[Connected Products<br/>UPS/PLC/Drives/Breakers] --> B[Edge Control<br/>EcoStruxure HMI/PLC]
    B --> C[Apps Analytics Services<br/>AVEVA / EcoStruxure IT / Motivair Mgmt]
    C --> D[Operational Insights<br/>能效 / 预测性维护 / 碳追踪]
    D --> A
```
...
![Peer Comparison TTM P/E](charts/schneider_peer_pe.png)
...
<details>
<summary>验证日志 (Step 10) — 2026-06-01</summary>
