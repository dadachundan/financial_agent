...
```mermaid
timeline
    title GSK 关键历史里程碑 / Key historical milestones
    1873 : Glaxo 在新西兰起步 (乳制品业务)
    1880 : Burroughs Wellcome 成立 (英国)
    1989 : SmithKline Beecham plc 由 SmithKline Beckman 与 Beecham Group 合并
    1995 : Glaxo Wellcome plc 由 Glaxo 与 Wellcome 合并而成
    2000-12 : Glaxo Wellcome + SmithKline Beecham 合并 → GlaxoSmithKline plc
    2009 : 与 Pfizer 合资成立 ViiV Healthcare (专注 HIV)
    2014 : 与 Novartis 三方资产置换 (剥离肿瘤、收购 Novartis 疫苗、消费保健合资)
    2017-04 : Emma Walmsley 出任 CEO (首位女性大型药企 CEO)
    2018-12 : 与 Pfizer 消费保健业务合并 (GSK 68% / Pfizer 32%)
    2021 : 提出消费保健业务分拆计划
    2022-05 : 集团更名 GlaxoSmithKline plc → GSK plc
    2022-07-18 : Haleon plc (LSE:HLN) 分拆上市,GSK 转型为纯粹生物制药公司
    2024-10 : Zantac 诉讼达成 $2.2 billion 和解,覆盖约 80,000 件州法院诉讼
    2025-07-28 : 与恒瑞医药签署最高 $12.5B 中国创新药许可协议 (主题事件)
    2025-09-29 : 宣布 Luke Miels 接任 CEO,2026-01-01 正式上任
    2025 全年 : 营收 £32.7B、专科药品 +17%、肿瘤 +43%
```
...
```mermaid
graph TD
    GSK["GSK plc<br/>FY2025 营收 £32.7B"]
    GSK --> SM["专科药品 Specialty Medicines<br/>£13.5B (+17%)"]
    GSK --> VAX["疫苗 Vaccines<br/>£9.2B (+2%)"]
    GSK --> GM["常规药品 General Medicines<br/>£10.0B (-1%)"]
    SM --> SM1["呼吸/免疫/炎症 RI&I<br/>£3.8B (+18%)"]
    SM --> SM2["肿瘤 Oncology<br/>£2.0B (+43%)"]
    SM --> SM3["HIV<br/>£7.7B (+11%)"]
    VAX --> VAX1["Shingrix 带状疱疹<br/>£3.6B (+8%)"]
    VAX --> VAX2["Arexvy RSV<br/>£0.6B (+2%)"]
    VAX --> VAX3["脑膜炎疫苗群<br/>£1.6B (+12%)"]
    GM --> GM1["Trelegy COPD/哮喘<br/>£3.0B (+13%)"]
    GM --> GM2["其他成熟产品<br/>£7.0B"]
    SM1 --> CHN["恒瑞 HRS-9821<br/>PDE3/4 COPD 注入"]
```
...
```mermaid
graph LR
    A["呼吸专长<br/>Ellipta 吸入器平台<br/>(Trelegy/Anoro/Incruse)"] --> B["RI&I 生物制剂<br/>Nucala/Benlysta/Depemokimab"]
    B --> C["恒瑞 HRS-9821<br/>PDE3/4 注入<br/>DPI 剂型"]
    A --> C
    D["疫苗佐剂技术<br/>AS01 平台"] --> E["Shingrix/Arexvy/RSV<br/>母婴 + 成人疫苗"]
    F["BCMA ADC 平台<br/>Blenrep DREAMM trials"] --> G["MM 联合用药<br/>+恒瑞 oncology BD"]
```
...
```mermaid
pie title FY2025 GSK 营收地理分布 (合并口径)
    "美国 US (~50%)" : 50
    "欧洲 (~25%)" : 25
    "国际 / 新兴市场 / 中国 (~25%)" : 25
```
...
```mermaid
xychart-beta
    title "中国生物科技 license-out 交易额 (USD billion)"
    x-axis ["2020", "2021", "2022", "2023", "2024", "2025E"]
    y-axis "Total deal value $B" 0 --> 70
    bar [10, 20, 25, 30, 45, 60]
```
