...
```mermaid
xychart-beta
    title "营业收入 (RMB 百万) FY2023-FY2025"
    x-axis [FY2023, FY2024, FY2025]
    y-axis "RMB 百万" 0 --> 800
    bar [401.8, 361.1, 684.6]
```

```mermaid
xychart-beta
    title "毛利率 gross margin (%) FY2023-FY2025"
    x-axis [FY2023, FY2024, FY2025]
    y-axis "%" 0 --> 50
    line [44.0, 30.7, 30.2]
```
...
```mermaid
timeline
    title 文远知行重大里程碑 (2017–2026)
    2017 : 韩旭与李岩在广州创立公司
         : 开曼控股公司注册成立
    2019 : 中国首个对公众收费的 Robotaxi 服务上线
         : 合资公司文远粤行 (Wenyuan Yuexing) 用于 Robotaxi 运营
    2021 : Robobus 实现商业化量产
         : Robovan 推出 (2021 年 9 月)
    2022 : 广州 Robobus 收费服务
         : 与博世 (Bosch) 建立战略合作 (Tier-2 ADAS)
         : 首批 Robosweeper 收费试点 (2022 年 4 月推出)
    2023 : Robovan 自动驾驶货运即服务 (Freight-as-a-Service) 上线
    2024 : 纳斯达克 IPO (2024 年 10 月 25 日, 代码 WRD)
         : 同步私募配售: 雷诺-日产-三菱"联盟创投"(Alliance Ventures) 与广汽 (GAC)
         : Robotaxi GXR 发布 (2024 年 10 月)
         : 与博世联合开发的单阶段端到端 ADAS 实现量产 (2024 年 3 月)
    2025 : GXR 进入规模化商业部署
         : 与 Uber 在阿布扎比、迪拜、利雅得启动合作
         : 阿布扎比: 美国境外全球首张完全无人驾驶商业化 Robotaxi 牌照 (10 月)
         : 港股上市——代码 0800 (11 月 6 日); 净募集资金 23.146 亿港元
         : 瑞士 (FEDRO) 无人驾驶 Robotaxi 许可——欧洲首张 (11 月)
    2026 : 与 ELEVATE 在斯洛伐克开启商业化运营 (3 月)
         : 与 Grab 在新加坡榜鹅推出 Ai.R 服务 (4 月)
         : 与 Uber 在马德里启动欧洲首个商业化 Robotaxi 试点 (6 月)
         : 全球 Robotaxi 车队达约 1,300 辆 (4 月)
```
...
```mermaid
pie title FY2025 营业收入按客户地域 (合并口径)
    "中国大陆 China" : 484.8
    "海外 Overseas" : 199.8
```
...
```mermaid
quadrantChart
    title L4 Robotaxi 定位——全球布局 vs. 乘车量规模
    x-axis "地理布局狭窄" --> "多国布局广泛"
    y-axis "日乘车量低" --> "日乘车量高"
    quadrant-1 "规模化多国"
    quadrant-2 "规模化本地"
    quadrant-3 "亚规模本地"
