...
```mermaid
timeline
    title NRG Energy 历史里程碑
    1989 : Northern States Power 旗下分立<br/>非管制独立发电业务
    2000 : IPO 上市
    2003 : 破产重组完成<br/>以新主体重新上市
    2006 : 收购 Texas Genco<br/>取得德州大规模发电资产
    2009 : 收购 Reliant Energy 零售业务<br/>切入 ERCOT 零售
    2012 : 与 GenOn 合并<br/>东部煤电资产扩张
    2018-2019 : "Transformation Plan"<br/>2019-02-04 出售 South Central Portfolio
    2021 : 收购 Direct Energy<br/>~$3.6 bn — 扩张至东部 + 加拿大零售
    2023-03-10 : 收购 Vivint Smart Home<br/>$2.62 bn 现金 — 加入 smart home 平台
    2023-11-01 : 出售 STP 44% 核电权益<br/>$1.75 bn 出售予 Constellation
    2024-09-16 : 出售 Airtron HVAC<br/>$500 mn — 聚焦核心
    2025-04-10 : 收购 Rockland 738 MW<br/>Texas Generation Portfolio
    2025-05-12 : 宣布收购 LS Power 13 GW + CPower<br/>EV $12.0 bn — 翻倍发电装机
    2025-02-13 : 与 GE Vernova + Kiewit TIC 签订<br/>5.4 GW CCGT 联合开发协议
    2026-01-30 : LS Power 交易交割完成<br/>装机达 25 GW
    2026-04-30 : Lawrence Coben 退任 CEO<br/>Robert Gaudette（25 年老兵）接任
```
...
```mermaid
graph TD
    NRG[NRG Energy 25 GW IPP + 8M 零售/智能家居客户]
    NRG --> Texas[Texas 分部<br/>ERCOT 一体化]
    NRG --> East[East 分部<br/>PJM/NYISO/ISO-NE 零售]
    NRG --> West[West/Other 分部<br/>California + Canada]
    NRG --> Vivint[Vivint Smart Home<br/>2.42M 订户]

    Texas --> TR[NRG Home + Reliant + GME<br/>住宅零售电力 / 燃气]
    Texas --> TB[NRG Business<br/>C&I + 数据中心 + 批发]
    Texas --> TG[12 GW 自有燃气<br/>+ LS Power Texas 增量]

    East --> ER[NRG Home + Direct Energy<br/>住宅零售]
    East --> EB[NRG Business<br/>含 CPower 6 GW VPP]
    East --> EG[LS Power 东北资产<br/>~13 GW gas, 9 州]

    West --> WR[Green Mountain Energy<br/>加州 CCA + 零售]
    West --> WG[Ivanpah 太阳能塔<br/>54.5% 权益]

    Vivint --> VH[硬件: 摄像头/锁/<br/>恒温器/传感器]
    Vivint --> VS[订阅: 监控/<br/>自动化/能源管理]
```
...
```mermaid
pie title NRG 2025 数据中心管道 (MW, segment-level disclosure, 不构成 consolidated 10% 客户)
    "已签 295 MW DC 协议 (TX 两站)" : 295
    "目标扩展至 500 MW" : 205
    "长期路径至 1 GW (额外站点)" : 500
    "LOI 储备 4 GW (管理层警示不会全部转化)" : 4000
```
...
```mermaid
quadrantChart
    title NRG 与主要 IPP 对手定位 (2026-06)
    x-axis "纯发电 IPP" --> "零售+发电一体化"
    y-axis "热电/燃气主导" --> "核电/低碳主导"
    quadrant-1 "Nuclear PPA 议价方"
    quadrant-2 "传统 baseload"
    quadrant-3 "Merchant gas IPP"
    quadrant-4 "Retail + Gas integrated"
    "CEG (Constellation)": [0.25, 0.92]
    "TLN (Talen)": [0.20, 0.88]
    "VST (Vistra)": [0.55, 0.68]
    "NRG": [0.85, 0.25]
    "ETR (Entergy)": [0.30, 0.62]
```
...
```mermaid
xychart-beta
    title "NRG Texas 新建项目装机增量 (MW, 累计)"
    x-axis ["2026", "2027", "2028", "2029", "2030"]
    y-axis "累计 MW" 0 --> 8000
    bar [415, 415, 1547, 1547, 6947]
```
