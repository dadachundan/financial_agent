...
```mermaid
timeline
    title 信达生物大事记 (2011–2026)
    2011 : 俞德超博士在苏州工业园创立 信达生物
    2015 : Eli Lilly 战略合作 (USD 5,600 万首付 / 总额 >USD 4 亿)
    2018 : 港交所 Chapter 18A 上市 (募资 HK$38 亿)
    2018 : Tyvyt (sintilimab) 国家药监局 (NMPA) 获批 — 中国首个 NRDL 收录的 PD-1
    2020 : Tyvyt 与 Eli Lilly 海外授权 (USD 2 亿首付 / 总额 USD 10.25 亿)
    2022 : FDA 拒绝 sintilimab BLA — 单一中国数据集不足
    2022 : Sanofi 战略投资 EUR 3 亿 股权 + 引进 Cyramza/Retsevmo 中国权利
    2024 : 公司层面 Non-IFRS 利润 / EBITDA 首次转正 (RMB 9.42 bn 收入)
    2025 : Mazdutide (GCG/GLP-1 双激动剂) NMPA 获批 — 中国首个国产 GLP-1 类减重药
    2025 : Takeda 全球 BD (首付 USD 12 亿 / 总额 USD 114 亿) — IBI363/343/3001
    2025 : 入选 Hang Seng Index 成分股
    2026 : Pfizer 12 项肿瘤项目合作 (首付 USD 6.5 亿 / 总额 USD 105 亿)
```
...
```mermaid
graph TD
    A[Innovent Biologics 信达生物] --> B[Oncology 肿瘤]
    A --> C[CVM 心血管代谢]
    A --> D[Autoimmune 自身免疫]
    A --> E[Ophthalmology 眼科]
    B --> B1[Tyvyt / 达伯舒 — sintilimab PD-1]
    B --> B2[Halpryza / 达伯华 — rituximab]
    B --> B3[Byvasda / 达攸同 — bevacizumab]
    B --> B4[Sulinno / 苏立信 — adalimumab]
    B --> B5[Cyramza — ramucirumab in-license Lilly]
    B --> B6[Retsevmo — selpercatinib in-license Lilly]
    B --> B7[Tyvyt + 化疗 8 个适应症]
    B --> B8[Dovbleron — taletrectinib ROS1]
    B --> B9[Limertinib — 3rd-gen EGFR TKI]
    B --> B10[Jaypirca — pirtobrutinib BTK in-license Lilly]
    C --> C1[Mazdutide — GCG/GLP-1 dual 中国首个]
    C --> C2[SINTBILO — tafolecimab PCSK-9]
    D --> D1[Picankibart — IL-23p19 PsO pending NMPA]
    E --> E1[SYCUME — teprotumumab N01 anti-IGF-1R]
    A --> P[Pipeline 研发管线]
    P --> P1[IBI363 PD-1/IL-2α-bias → Takeda BD]
    P --> P2[IBI343 CLDN18.2 ADC → Takeda BD]
    P --> P3[IBI3001 EGFR/B7H3 BsAb ADC → Takeda option]
    P --> P4[IBI3009 DLL3 ADC → Roche BD]
    P --> P5[IBI324 → Ollin Ophthalmology BD]
    P --> P6[12 早期项目 → Pfizer BD]
```
...
```mermaid
pie title 2024 年收入构成 (RMB 94.22 亿)
    "产品销售 (Product Sales) 87.3%" : 82.28
    "授权与里程碑 (License & Milestone) 12.7%" : 11.94
```
