...
```mermaid
xychart-beta
    title "Moderna — 历年总收入趋势 FY2021–FY2025 (US$M)"
    x-axis [FY2021, FY2022, FY2023, FY2024, FY2025]
    y-axis "收入 ($M)" 0 --> 20000
    bar [18471, 19263, 6848, 3236, 1944]
```
...
```mermaid
timeline
    title Moderna 关键里程碑 2010 → 2026
    2010 : Flagship Pioneering 创立 Moderna
    2018 : 更名为 Moderna, Inc.; Nasdaq IPO 12月 2018（募集 6.04 亿美元）
    2020 : Spikevax / mRNA-1273 获 EUA 紧急使用授权（12月 2020）—— 首款商业产品
    2021 : FY2021 收入 184.7 亿美元，净利 122 亿美元（COVID 高峰）
    2022 : FY2022 收入 192.6 亿美元，净利 84 亿美元
    2023 : COVID 需求崩塌；FY2023 收入 68.4 亿美元（-65% YoY）
    2024 : mRESVIA（RSV）2024 年 5 月获 FDA 批准；12月 全资购入 MTC 工厂
    2025 : mNEXSPIKE（下一代 COVID）5月 FDA 批准，Q3 商业化上市
    2026 : Q1 2026 业绩—— Arbutus 和解 / intismeran 5 年期 Phase 2b 数据
```
...
```mermaid
graph TD
    A[Moderna mRNA 平台] --> B[已获批的呼吸道疫苗业务]
    A --> C[肿瘤 / 个体化新抗原]
    A --> D[罕见病 / 代谢病]
    A --> E[联合疫苗 + 未来感染病]
    B --> B1[Spikevax / mRNA-1273]
    B --> B2[mNEXSPIKE / mRNA-1283]
    B --> B3[mRESVIA / mRNA-1345]
    C --> C1[Intismeran autogene / mRNA-4157 + KEYTRUDA<br/>Phase 3 黑色素瘤 2026]
    C --> C2[mRNA-4359 癌抗原疗法]
    D --> D1[mRNA-3927 PA — Recordati 合作 2026]
    D --> D2[mRNA-3705 MMA]
    D --> D3[mRNA-1647 CMV]
    E --> E1[mRNA-1083 flu+COVID 联合]
    E --> E2[mRNA-1010 季节性流感]
    E --> E3[mRNA-1018 大流行流感 与 CEPI 合作]
```
...
```mermaid
pie title "FY2025 命名客户集中度（占合并总收入比例）"
    "FFF Enterprises（美国私营分销商）" : 15
    "加拿大政府（公共服务部）" : 13
    "Cardinal Health（美国分销巨头）" : 11
    "其他客户合计" : 61
```
...
```mermaid
xychart-beta
    title "美国成人呼吸道疫苗市场估算规模 FY2019–FY2025E (US$B)"
    x-axis [FY2019, FY2020, FY2021, FY2022, FY2023, FY2024, FY2025E]
    y-axis "市场规模 ($B)" 0 --> 50
    bar [4.5, 8.0, 35.0, 32.0, 18.0, 14.0, 12.0]
```
...
quadrantChart
    ...
    "Pfizer (PFE)": [0.9, 0.95]
    "GSK": [0.85, 0.80]
    "Sanofi (SNY)": [0.85, 0.85]
    "Merck (MRK)": [0.9, 0.9]
    "Moderna (MRNA)": [0.7, 0.35]
    "BioNTech (BNTX)": [0.65, 0.35]
    "Novavax (NVAX)": [0.2, 0.10]
```
...
```mermaid
xychart-beta
    title "同业 TTM P/S — MRNA 相对疫苗同业的溢价（2026-06-03）"
    x-axis [MRNA, BNTX, NVAX, PFE, GSK, SNY]
    y-axis "P/S (×)" 0 --> 10
    bar [8.14, 6.97, 2.82, 2.30, 2.26, 1.88]
```
