...
timeline
    ...
    1938 : 李秉喆 创立 三星集团
    1969 : 三星电子 在水原 独立注册
    1974 : 收购韩国半导体 (DRAM 入场)
    1983 : 东京宣言 — 全押存储
    1984 : 首款 64K DRAM 出货
    1992 : DRAM 全球第一
    1993 : 李健熙 推动 New Management 改革
    2002 : NAND Flash 全球第一
    2010 : 首款 Galaxy S 智能手机 (GT-I9000, 2010 年 6 月发布)
    2011 : 智能手机全球第一 (超越诺基亚)
    2012 : 拆分 Samsung Display Corporation
    2017 : USD 8.0 bn 收购 Harman International
    2022 : 李在镕 出任执行董事长;3-nm GAA 代工首批芯片
    2024 : 实施 Co-CEO 双 CEO 体制 (DS 全永鉉 + DX 韩鍾熙)
    2025 : 3 月 韩鍾熙 因心源性猝死去世;7 月 李在镕 获韩国最高法院完全无罪释放
    2026 : 首批 HBM4 量产出货给 NVIDIA;Exynos 2600 (业界首款 2-nm 移动 AP)
```
...
```mermaid
graph TD
    SEC[三星电子 Samsung Electronics]
    SEC --> DS[Device Solutions DS 半导体]
    SEC --> DX[Device eXperience DX 设备体验]
    SEC --> SDC[Samsung Display 三星显示]
    SEC --> HARMAN[Harman 哈曼国际]

    DS --> MEM[Memory: DRAM / NAND / HBM]
    DS --> FND[Foundry: 2nm/3nm/4nm/5nm + legacy]
    DS --> LSI[System LSI: Exynos AP / 图像传感器 / 调制解调器 / PMIC]

    DX --> MX[Mobile: Galaxy S/Z/A/Tab/Watch/Buds]
    DX --> VD[Visual Display: Neo QLED / OLED / MicroLED / The Frame / soundbar]
    DX --> DA[Digital Appliances: 冰箱 洗衣机 空调 Bespoke AI]
    DX --> NET[Networks: 5G/6G RAN / Open RAN]

    SDC --> SMOLED[中小尺寸 OLED: iPhone / Galaxy / 折叠 / 车载]
    SDC --> QDOLED[QD-OLED: 电视 / 游戏显示器]

    HARMAN --> AUTO[车载电子: 智能座舱/ADAS/车联网]
    HARMAN --> AUDIO[消费音响: JBL/Harman Kardon/AKG/Mark Levinson]
    HARMAN --> PRO[专业 / 企业级音响]
```
...
quadrantChart
    ...
    quadrant-3 低规模
    quadrant-4 走量低毛利
    "DRAM (vs SK 海力士 / 美光)": [0.85, 0.75]
    "HBM (vs SK 海力士 / 美光)": [0.55, 0.70]
    "NAND (vs SK 海力士 / Kioxia)": [0.80, 0.55]
    "Foundry (vs 台积电)": [0.30, 0.30]
    "MX Galaxy (vs 苹果 / 小米)": [0.90, 0.45]
    "TV (vs LG / TCL / 海信)": [0.92, 0.40]
    "OLED 面板 (vs LGD / BOE)": [0.88, 0.55]
...
![FY2025 营收按部门分布](charts/samsung_segment_mix.png)
来源:三星电子 FY2025 Q4 业绩公告与 Harman FY25 披露(已在上文引用)。DS 与 DX 数字为分部毛额,集团合并 KRW 333.6 万亿为内部抵销后口径。

![HBM 市占 — 三星 vs SK 海力士 vs 美光](charts/samsung_hbm_share.png)
...
![代工市占 — 台积电 vs 三星](charts/samsung_foundry_share.png)
来源:[TrendForce via BigGo Finance, 2025](https://finance.biggo.com/news/Akg74pwBga3fZL9MGf-A)。

![前瞻 PE — 存储与代工同业](charts/samsung_peer_pe.png)
...
![三星年度资本开支](charts/samsung_capex.png)
