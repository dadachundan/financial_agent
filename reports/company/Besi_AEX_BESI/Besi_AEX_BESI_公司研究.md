...
![Besi 2021-2025 营业收入与毛利率走势](charts/01_revenue_gross_margin.png)
...
timeline
    ...
    1995 : 依据荷兰法律注册成立 (5 月)
         : 阿姆斯特丹证券交易所 IPO (12 月)
         : Richard W. Blickman 出任 CEO
    2002 : 收购 RD Automation (美国) — 倒装芯片 (flip-chip) 平台
    2005 : 收购 Laurier (美国) — 智能晶粒分选
    2005 : 收购 Datacon (奥地利) — 倒装芯片 + 晶粒键合机龙头; 现为 Besi 销售混合键合机所使用的品牌
    2009 : 收购 Esec (瑞士) — 主流环氧晶粒键合机, 拓宽可服务市场
    2015 : 纳入 AEX 指数 (泛欧阿姆斯特丹交易所蓝筹指数)
    2020 : 与应用材料签署混合键合集成解决方案联合研发协议
    2024 : 发行 3.5 亿欧元 4.500% 优先票据 (TISE 上市)
    2025 : 应用材料 4 月获取 9% 战略股权, 成为最大股东
         : 累计混合键合设备订单达 150+ 套, 覆盖 18 家客户
         : 完成首台 50 nm 贴装精度混合键合原型机
         : 长期收入目标由 10 亿欧元+++ 上调至 15-19 亿欧元
    2026 : 2026 年 Q1 订单 2.697 亿欧元 (同比 +104.5%) — 混合键合拐点
```
...
```mermaid
graph TD
    A[加工后晶圆<br/>来自台积电 / 三星] --> B[切割<br/>非 Besi: Disco/Accretech]
    B --> C{晶圆级<br/>组装?}
    C -->|是 — AI/HBM| D[混合键合机<br/>Datacon 8800 Cheetah]
    C -->|是 — HBM/光子学| E[TC Next]
    C -->|否 — 主流| F[倒装芯片 / 多模块<br/>晶粒键合机]
    C -->|主流消费| G[环氧 / 软焊<br/>晶粒键合机 — Esec]
    D --> H[晶圆级模塑<br/>Besi 封装组]
    E --> H
    F --> I[修切成形<br/>Besi 封装]
    G --> I
    H --> J[切割单粒化<br/>Besi 封装]
    I --> J
    J --> K[成品封装<br/>至 PCB 组装]
    L[电镀系统<br/>Besi 电镀组] -.-> F
    L -.-> G
```
...
![Besi 研发投入走势](charts/06_rd_trend.png)
...
![2023-2025 终端市场收入结构](charts/03_end_market_mix.png)
...
![先进封装市场轨迹](charts/07_advanced_packaging_market.png)
...
![晶粒贴装市场份额走势](charts/04_market_share.png)
...
![累计混合键合订单](charts/08_hybrid_bonding_cumulative.png)
