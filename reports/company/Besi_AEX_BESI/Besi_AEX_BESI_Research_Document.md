...
![Besi revenue and gross margin trend 2021-2025](charts/01_revenue_gross_margin.png)
...
```mermaid
timeline
    title Besi corporate history
    1995 : Incorporated under Dutch law (May)
         : IPO on Amsterdam Stock Exchange (December)
         : Richard W. Blickman appointed CEO
    2002 : Acquired RD Automation (USA) — flip-chip platform
    2005 : Acquired Laurier (USA) — intelligent die sorting
    2005 : Acquired Datacon (Austria) — flip-chip + die bonder leader; now the brand under which Besi sells hybrid bonders
    2009 : Acquired Esec (Switzerland) — mainstream epoxy die bonders, broadens addressable market
    2015 : Listed in AEX Index (Euronext Amsterdam's blue-chip index)
    2020 : Joint development agreement signed with Applied Materials on integrated hybrid bonding solution
    2024 : Issued €350 mn 4.500% Senior Notes (TISE-listed)
    2025 : Applied Materials acquired 9% strategic equity stake (April), becoming the largest shareholder
         : Cumulative hybrid-bonder orders reach 150+ systems across 18 customers
         : First 50-nm placement-accuracy hybrid-bonding prototype completed
         : Long-term revenue target raised from €1B+++ to €1.5–1.9B
    2026 : Q1-26 orders €269.7 mn (+104.5% YoY) — hybrid bonding inflection
```
...
```mermaid
graph TD
    A[Processed wafer<br/>from TSMC/Samsung] --> B[Dicing<br/>not Besi: Disco/Accretech]
    B --> C{Wafer-level<br/>assembly?}
    C -->|Yes — AI/HBM| D[Hybrid bonder<br/>Datacon 8800 Cheetah]
    C -->|Yes — HBM/photonics| E[TC Next]
    C -->|No — mainstream| F[Flip-chip/multi-module<br/>die bonder]
    C -->|Mainstream consumer| G[Epoxy/soft-solder<br/>die bonder — Esec]
    D --> H[Wafer-level molding<br/>Besi Packaging group]
    E --> H
    F --> I[Trim & form<br/>Besi Packaging]
    G --> I
    H --> J[Singulation<br/>Besi Packaging]
    I --> J
    J --> K[Finished package<br/>to PCB assembly]
    L[Plating systems<br/>Besi Plating group] -.-> F
    L -.-> G
```
...
![Besi R&D investment trend](charts/06_rd_trend.png)
...
```mermaid
pie title FY2025 revenue by customer geography
    "Asia" : 76
    "Europe / Rest of World" : 24
```
...
The 2024-2025 shift toward foundries/OSATs (55% of orders in both years) is the signature of the TSMC SoIC / Asian OSAT advanced-packaging buildout. As Nomura's 21-May-2026 Greater China Semi report independently projects, TSMC SoIC capacity moves from ~10 kwpm at end-2025 toward 15 kwpm in 2026 and 30 kwpm in 2027 — and Besi is the hybrid-bonder of record at that account ([Nomura "Greater China Semi: A guide to Semi renaissance in 2026~30F," 2026-05-21, p. 44, accessible via the local zsxq library](http://xs-macbook-air.local:5001/zsxq); cited via the [zsxq summary](http://localhost:8080/) for record-keeping).

![Orders vs Revenue with book-to-bill ratios](charts/02_orders_vs_revenue.png)
...
![End-market revenue mix 2023-2025](charts/03_end_market_mix.png)
...
![Advanced packaging market trajectory](charts/07_advanced_packaging_market.png)
...
![Die attach market share trend](charts/04_market_share.png)
...
**Shibaura Mechatronics (6590 JP)** — Japanese supplier of various semiconductor processing equipment. Per industry research firm assessments, Shibaura is "trying to expand presence in the hybrid bonding market" but has limited installed base in advanced die placement ([Nomura "Greater China Semi" report, p. 46-47](http://xs-macbook-air.local:5001/zsxq)). *Analyst view:* Shibaura is the most credible Japan-side hybrid-bonding entrant but is several quarters behind Besi.
...
![Peer P/E comparison](charts/05_peer_pe.png)
...
![Cumulative hybrid bonding orders](charts/08_hybrid_bonding_cumulative.png)
...
**Risk 5 — Competitive entry from front-end semicap (severity: medium-high, probability: low-medium)**. TEL and ASML have been mentioned by industry research as potential entrants into chip-to-wafer hybrid bonding ([Nomura "Greater China Semi" 2026, p. 46](http://xs-macbook-air.local:5001/zsxq)). Both have deep TSMC and Intel relationships. The April 2025 Applied Materials strategic equity stake and joint development agreement is implicitly designed to lock in front-end / back-end integration with one of the three large US semicap players, but TEL or ASML could conceivably build or acquire a competing platform. Mitigation: 5+ years of advanced R&D lead; sub-micron placement accuracy is genuinely hard.
...
- **[Nomura — Greater China Semi: A guide to Semi renaissance in 2026~30F](http://xs-macbook-air.local:5001/zsxq)**, Anchor Report, 2026-05-21, 139 pages. Cited for the Besi-specific recommendation (Buy maintained, TP EUR 340), the TSMC SoIC capacity trajectory (10k → 30k wpm 2025-2027), 2026F HB order forecast of 70+ units, 2026F order mix (50% AMD / 25% COUPE / 15% HBM / 10% other), and competitive landscape (Shibaura entry, TEL/ASML potential entry). Accessible locally via [the zsxq library](http://xs-macbook-air.local:5001/zsxq) at file_id 184121852855252.
...
**URL check** — all URLs in this report HTTP-checked 2026-05-24; primary filing URLs (besi.com/fileadmin/...), Applied Materials IR page, and Yahoo Finance / Macrotrends / GuruFocus / CompaniesMarketCap quote pages all resolve to 200. The Nomura Greater China Semi report cited is local-only (zsxq.db file_id 184121852855252) and is accessed via `xs-macbook-air.local:5001/zsxq` — this is intentional, not a public URL.
