...
```mermaid
timeline
    title Agnico Eagle 大事记 / Key Milestones 1957–2026
    1957 : Paul Penna 整合 Cobalt-Comet + Eagle Gold 成立 Agnico Eagle
    1972 : 公司正式合并并更名 Agnico-Eagle Mines Limited
    1983 : 首次派发现金股息（开启 43 年连续派息纪录）
    1988 : LaRonde 矿（Abitibi/QC）投产 — 旗舰长寿命矿山
    1998 : Sean Boyd 出任总裁兼 CEO（任期 1998-2022）
    2007 : 收购 Cumberland Resources 获 Meadowbank/Amaruq (Nunavut)
    2010 : 收购 Comaplex Minerals — Meliadine (Nunavut)
    2014 : 与 Yamana 合资收购 Osisko Mining — 入股 Canadian Malartic 50%
    2022 : Kirkland Lake 反向并购完成 — 加入 Detour Lake / Macassa / Fosterville；Al-Joundi 出任 CEO
    2023 : 收购 Yamana 剩余 50% Canadian Malartic + Wasamac；与 Teck 50/50 合资 San Nicolás (墨西哥铜锌)
    2024 : O3 Mining 收购完成（Marban 资产，邻近 Canadian Malartic）
    2025 : 创纪录 FCF $4.4 bn；首次 17 周年可持续发展报告
    2026 : 宣布 Rupert + Aurion + B2Gold (Fingold) 三笔交易合并芬兰 CLGB → 50 万盎司/年芬兰平台
```
...
```mermaid
graph TD
    A[AEM 集团 Production 3.3-3.5 Moz/yr]
    A --> B[加拿大 ~75% — Abitibi/Ontario/Nunavut]
    A --> C[澳大利亚 ~5% — Fosterville Victoria]
    A --> D[芬兰 ~6% — Kittila Lapland]
    A --> E[墨西哥 ~4% — Pinos Altos Chihuahua]
    B --> B1[Abitibi QC: LaRonde + Canadian Malartic + Goldex + LZ5 ~ 1.1 Moz]
    B --> B2[Ontario: Detour Lake + Macassa ~ 0.95 Moz]
    B --> B3[Nunavut: Meadowbank + Meliadine + Hope Bay ~ 0.87 Moz]
    A --> F[新增长: Odyssey + Detour UG + Upper Beaver + Hope Bay + CLGB Finland]
    F --> G[2030s 目标 4+ Moz/yr]
```
...
```mermaid
xychart-beta
    title "AEM 单位成本 vs. 同业 (FY25 AISC US$/oz)"
    x-axis ["AEM", "Gold Fields (GFI)", "Newmont (NEM)", "Barrick (B)"]
    y-axis "AISC US$/oz" 1000 --> 1800
    bar [1339, 1565, 1620, 1650]
```
...
```mermaid
pie title AEM FY2025 黄金产量地理分布 (basis: production oz)
    "加拿大 Abitibi (LaRonde+CM+Goldex)" : 1112
    "加拿大 Ontario (Detour+Macassa)" : 942
    "加拿大 Nunavut (Meadowbank+Meliadine)" : 869
    "芬兰 (Kittila)" : 217
    "澳大利亚 (Fosterville)" : 160
    "墨西哥 (Pinos Altos)" : 147
```
...
```mermaid
xychart-beta
    title "AEM 长期增长路径 (Annual gold production, Moz)"
    x-axis ["2024A", "2025A", "2026E", "2027E", "2028E", "2030E", "2032E (target)"]
    y-axis "Moz Au" 2.5 --> 4.5
    line [3.49, 3.45, 3.40, 3.45, 3.45, 3.80, 4.20]
```
