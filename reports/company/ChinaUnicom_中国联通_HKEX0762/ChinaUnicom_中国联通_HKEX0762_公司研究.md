...
```mermaid
xychart-beta
    title "China Unicom 2025 年收入结构 (RMB bn)"
    x-axis ["服务收入", "通信产品", "总收入"]
    y-axis "RMB bn" 0 --> 420
    bar [347.7, 44.5, 392.2]
```
...
```mermaid
timeline
    title 中国联通 1994-2026 关键里程碑
    1994 : 1994-07-19 中国联合通信有限公司成立 — 由原电子工业部、电力工业部、铁道部联合发起, 国务院 1993 年 12 月批准, 打破邮电部垄断
    1995 : 国内首张 GSM 数字蜂窝网在京津沪穗投入运营 — 中国第二张移动通信网
    2000 : 2000-06-22 香港红筹股 0762.HK 在港交所上市 (China Unicom (Hong Kong) Limited)
    2002 : A 股 600050 在上海证券交易所上市 (China United Telecommunications Corp)
    2008 : 国务院电信业重组方案 — CDMA 网络及用户以 RMB 110 bn 出售给中国电信
    2009 : 合并中国网通 (China Netcom) 完成股份换股 (US$56.3 bn share-swap); WCDMA 3G 牌照获颁, 5 月 17 日在主要城市开通 UMTS
    2014 : 4G TD-LTE / FDD-LTE 牌照获颁, 启动 4G 网络建设
    2017 : 混合所有制改革 (mixed-ownership reform) 完成 — 14 家战略投资者认购 RMB 78 bn (~88 bn HKD), 包括腾讯 5.18%、百度 3.3%、阿里、京东等, 集团股权由 62.7% 降至 36.67%
    2019 : 与中国电信签订 5G 网络共建共享协议 — 联合建网降低 capex
    2021 : 2021-08 在 A 股上市的中国电信 (SSE:601728) IPO 完成, 三大运营商完成 H+A 双重上市闭环
    2023 : "数字中国" 战略落地, 启动 "东数西算" 跨区域算力网建设, 联通云政企客户突破 30 万家
    2024 : AI+ 战略提出, 联通云开始向 "AI 云" 转型, 与百度文心、阿里通义、腾讯混元等多个大模型展开 MaaS 协作
    2026 : 2026-01-14 董昕由中国电信副总经理 (原任) 调入中国联通任 Chairman & CEO (一肩挑); 2026 capex 指引 RMB 50 bn, 算力占比 >35%
```
...
```mermaid
graph LR
    A[底层连接 Connectivity<br/>5G / 5G-A / 固网 / IoT / Satellite] --> B[云 + 算力 Computing Power<br/>Unicom Cloud / AIDC / 45 EFLOPS]
    B --> C[业务服务 Service<br/>政企数字化 / Digital Government / IoV]
    C --> D[安全保障 Security<br/>联通盾 / 安全专线 / 安全项目]
    D -.支撑回路.-> A
```
...
```mermaid
graph TD
    A[1.2bn 连接用户] -->|流量 + 数据| B[Unicom Cloud<br/>44 万政企客户]
    B -->|算力服务| C[5G+工业互联网<br/>5.3 万项目]
    C -->|结合 D2D 卫星| D[车联网 95mn+ 车<br/>+ 数字政务]
    D -->|安全保障| E[Unicom Shield<br/>46.8 万安全大客户]
    
    F[腾讯/阿里/百度/京东 BAT 战投] -.业务协同.-> B
    G[BAT 大模型] -.MaaS 集成.-> B
    H[国资委政策导向] -.算力 capex>35%.-> B
```
...
```mermaid
pie title 中国联通 2025 服务收入结构 (analyst-estimated)
    "连接 (移动 + 固网 + IoT)" : 70
    "算力 (Unicom Cloud + IDC + AIDC)" : 15.4
    "其他服务 (车联网 + 工业互联网 + 国际 + 政务)" : 12
    "安全" : 2.6
```
...
```mermaid
graph TD
    A[国务院国资委 SASAC] -->|100%| B[中国联通集团 / China Unicom Group<br/>非上市]
    B -->|约 55% 直接 + 间接| C[中国联合网络通信集团有限公司<br/>BVI 控股公司]
    C -->|约 70%+| D[A 股 SSE:600050<br/>中国联合网络通信股份有限公司]
    D -->|82.1%| E[H 股 HKEX:0762<br/>中国联合网络通信香港股份有限公司]
    F[腾讯 5.18% / 百度 3.3% / 阿里 / 京东 / 中车 / 中国人寿 等 14 家 SI] -->|2017 混改持股| D
    G[公众流通股] -->|17.9%| E
```
...
```mermaid
xychart-beta
    title "中国公有云 IaaS 市场份额估算 2025 (%)"
    x-axis ["阿里云", "天翼云", "华为云", "移动云", "腾讯云", "联通云", "其他"]
    y-axis "Market share %" 0 --> 35
    bar [30, 17, 12, 9, 9, 4, 19]
```
...
```mermaid
quadrantChart
    title "中国三大运营商 + 主要云厂商 2025 — capex 规模 vs. 算力 / AI 收入占比"
    x-axis "Capex 规模 (RMB bn)" --> "更大"
    y-axis "算力 / AI 收入占比" --> "更高"
    quadrant-1 "高 capex + 高算力占比"
...
```mermaid
xychart-beta
    title "中国 AI 算力需求 — 推动联通算力增长的主要变量 (2024-2028 估算)"
    x-axis ["2024", "2025", "2026E", "2027E", "2028E"]
    y-axis "RMB bn" 0 --> 100
    bar [18, 28.1, 38, 50, 65]
```
