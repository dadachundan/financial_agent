...
```mermaid
xychart-beta
    title "HPE 营收与毛利率 — FY23-FY25 实际 + FY26E (10-K 与最新 8-K 指引)"
    x-axis ["FY23", "FY24", "FY25", "FY26E (中值)"]
    y-axis "美元 (十亿)" 0 --> 50
...
timeline
    title HPE 关键历史节点
    1939 : Bill Hewlett 与 Dave Packard 于 Palo Alto 创立 Hewlett-Packard 合伙公司
    2015 : 11月 1日 — HPE 从 HP Inc. 分拆挂牌
    2017 : 出售软件业务予 Micro Focus
    2018 : 2月 1日 — Antonio Neri 出任总裁兼 CEO
    2019 : 完成 Cray Inc. 约 13 亿美元收购，奠定 HPC/AI 超算根基
    2020 : 发布 HPE GreenLake 按用量付费私有云平台品牌
    2022 : 完成 Pensando 收购，获得 DPU (data processing unit / 数据处理单元) 能力
    2024 : 1月 9日 — 宣布拟以 $40.00/股、约 140 亿美元股权价值收购 Juniper Networks
    2024 : 9月 4日 — H3C 30% 股权第一步出售确认 $7.33 亿美元投资收益
    2025 : 1月 — DOJ 起诉拟阻止 Juniper 交易；6月 28日和解，附 Mist AI 许可证回授
    2025 : 7月 2日 — Juniper Networks 收购正式完成 (总对价 $136 亿)
    2025 : 12月 — 宣布拟将 Telco 业务出售予 HCLTech (待监管批准)
    2026 : Q1/Q2 FY26 业绩驱动指引上调；HPE 比 FY28 长期计划"提前两年"
```
...
```mermaid
graph TD
    HPE[HPE 三大分部<br/>FY26 起]
    HPE --> N[Networking 网络]
    HPE --> CA[Cloud & AI 云与 AI]
    HPE --> CI[Corp Inv & Other 企业投资与其他]
    N --> N1[园区与分支<br/>Aruba CX / Wi-Fi APs]
    N --> N2[数据中心网络<br/>QFX / Apstra / Mist DC]
    N --> N3[路由 Routing<br/>MX / PTX]
    N --> N4[安全 / SASE<br/>SRX / Session Smart]
    N --> N5[AIOps / 软件<br/>Aruba Central / Mist AI / EdgeConnect]
    CA --> CA1[服务器 Server<br/>ProLiant / Synergy / Cray EX/XD / NonStop / Edgeline]
    CA --> CA2[存储 Storage<br/>Alletra MP / Alletra Storage / Zerto]
    CA --> CA3[私有云 Private Cloud<br/>GreenLake / Private Cloud AI / Morpheus VM Essentials]
    CA --> CA4[基础架构软件<br/>OpsRamp / Ezmeral / InfoSight]
    CA --> CA5[金融服务 FS<br/>Leasing / Asset Mgmt / TRC]
    CI --> CI1[咨询与专业服务]
    CI --> CI2[HP Labs / 研发]
    CI --> CI3[Telco / Instant On<br/>待 HCLTech 剥离]
```
...
```mermaid
pie title HPE FY25 营收地理分布 ($343 亿合并；10-K Note 2)
    "美国 ($134 亿)" : 39.1
    "美洲除美国 ($24 亿)" : 7.1
    "EMEA ($115 亿)" : 33.6
    "亚太及日本 ($69 亿)" : 20.2
...
```mermaid
xychart-beta
    title "AI 服务器市场轨迹 — IDC TAM (美元 / 十亿)"
...
```mermaid
xychart-beta
    title "TTM P/E 同行对比 (2026-06-03; Yahoo Finance)"
    x-axis ["HPE", "DELL", "CSCO", "ANET", "NTAP", "PSTG", "SMCI"]
...
```mermaid
xychart-beta
    title "HPE 可寻址市场 — FY24-FY28 ($ 十亿; IDC 与 HPE SAM 2025)"
...
```mermaid
graph LR
    R1[公司特有] --> A[Juniper 整合]
    R1 --> B[Hybrid Cloud 商誉]
    R1 --> C[单源供应商]
    R1 --> D[分销商 10% 集中]
    R2[行业/市场] --> E[AI 需求波动]
    R2 --> F[算力价格竞争]
