...
```mermaid
xychart-beta
    title "HPE Net Revenue and Gross Margin — FY23-FY25 actual + FY26E (10-K plus latest 8-K guide)"
    x-axis ["FY23", "FY24", "FY25", "FY26E (mid)"]
    y-axis "USD billions" 0 --> 50
    bar [29.135, 30.127, 34.296, 44.4]
    line [33.6, 32.9, 30.3, 36.0]
```
...
```mermaid
xychart-beta
    title "Forward P/E vs Peers — 2026-06-03"
    x-axis ["HPE", "DELL", "CSCO", "ANET", "NTAP", "PSTG", "SMCI"]
    y-axis "Forward P/E" 0 --> 45
    bar [13.9, 20.4, 26.8, 39.4, 17.8, 23.9, 15.5]
```
...
```mermaid
timeline
    title HPE history milestones
    1939 : Hewlett-Packard partnership founded by Bill Hewlett and Dave Packard in Palo Alto
    2015 : November 1 — HPE spun off from HP Inc. as standalone enterprise-IT company
    2017 : Sale of Software Business to Micro Focus; Mark Hurd-era PC/print separation legacy resolved
    2018 : Antonio Neri appointed President & CEO (Feb 1)
    2019 : Acquires Cray Inc. for ~$1.3 bn; foundation of HPC/AI supercomputing portfolio
    2020 : Launches HPE GreenLake consumption-based cloud platform brand
    2022 : Acquires Pensando; data-processing-unit (DPU) capability
    2024 : January 9 — agrees to acquire Juniper Networks for $40.00/share, ~$14 bn equity value
    2024 : September 4 — H3C divestiture of 30% (Step 1) recognises $733 m gain
    2025 : January — DOJ files suit to block Juniper deal; June 28 — settlement reached with Mist-AI license-back remedy
    2025 : July 2 — Juniper Networks merger closes ($13.6 bn total consideration)
    2025 : December — announces planned divestiture of Telco business to HCLTech (subject to regulatory approvals)
    2026 : Q1/Q2 FY26 prints drive guide-up; HPE "two years ahead" of its FY28 long-term plan
```
...
```mermaid
graph TD
    HPE[HPE - 3 segments<br/>FY26 onward]
    HPE --> N[Networking]
    HPE --> CA[Cloud & AI]
    HPE --> CI[Corporate Investments & Other]
    N --> N1[Campus & Branch<br/>Aruba CX / Wi-Fi APs]
    N --> N2[Data Center Networking<br/>QFX / Apstra / Mist DC]
    N --> N3[Routing<br/>MX / PTX]
    N --> N4[Security / SASE<br/>SRX / Session Smart]
    N --> N5[AIOps / Software<br/>Aruba Central / Mist AI / EdgeConnect]
    CA --> CA1[Server<br/>ProLiant / Synergy / Cray EX / Cray XD / NonStop / Edgeline]
    CA --> CA2[Storage<br/>Alletra MP / Alletra Storage / Zerto]
    CA --> CA3[Private Cloud<br/>GreenLake / Private Cloud AI / Morpheus VM Essentials]
    CA --> CA4[Infrastructure Software<br/>OpsRamp / Ezmeral / InfoSight]
    CA --> CA5[Financial Services<br/>Leasing / Asset Mgmt / TRC]
    CI --> CI1[Advisory & Professional Services]
    CI --> CI2[Hewlett Packard Labs / R&D]
    CI --> CI3[Telco / Instant On<br/>pending HCLTech divestiture]
```
...
```mermaid
pie title HPE FY25 net revenue by geography ($34.3 bn consolidated; 10-K Note 2)
    "U.S. ($13.4 bn)" : 39.1
    "Americas ex-U.S. ($2.4 bn)" : 7.1
    "EMEA ($11.5 bn)" : 33.6
    "Asia-Pacific & Japan ($6.9 bn)" : 20.2
```
...
```mermaid
xychart-beta
    title "AI server market trajectory — IDC TAM (USD bn)"
    x-axis ["2024", "2025E", "2026E", "2027E", "2028E"]
    y-axis "USD billions" 0 --> 300
    bar [124, 158, 197, 233, 269]
```
...
```mermaid
xychart-beta
    title "TTM P/E vs peers (2026-06-03; Yahoo Finance)"
    x-axis ["HPE", "DELL", "CSCO", "ANET", "NTAP", "PSTG", "SMCI"]
    y-axis "TTM P/E" 0 --> 130
    bar [52.5, 50.3, 42.7, 60.3, 27.6, 123.3, 26.4]
```
...
quadrantChart
    ...
    Arista: [0.95, 0.05]
    NetApp: [0.10, 0.75]
    Pure Storage: [0.10, 0.80]
    Supermicro: [0.05, 0.95]
    NVIDIA: [0.30, 0.80]
```
...
```mermaid
xychart-beta
    title "HPE addressable market — FY24-FY28 ($ bn; IDC and HPE SAM 2025)"
    x-axis ["FY24", "FY25", "FY26E", "FY27E", "FY28E"]
    y-axis "USD billions" 0 --> 320
    bar [165, 184, 197, 210, 215]
```
...
```mermaid
graph LR
    R1[Company-specific] --> A[Juniper integration]
    R1 --> B[Hybrid Cloud goodwill]
    R1 --> C[Single-source suppliers]
    R1 --> D[Distributor 10% concentration]
    R2[Industry/Market] --> E[AI demand lumpiness]
    R2 --> F[Compute price competition]
    R2 --> G[Tariffs / geopolitics]
    R3[Financial] --> H[Debt load $17.8B]
    R3 --> I[FY25 GAAP loss]
    R3 --> J[Pension obligations]
    R4[Legal/Regulatory] --> K[Cybersecurity / data breach]
```
