...
|---|---|---|---|---|---|
| **1/10** | **Morgan Stanley** — *Where are we trading now: entering 2Q earnings* | 15 · 26-07-23 | no PT — Overweight (since 03/20/2023); no price target; coverage price $645.85 (07/20/26) | no PT row | [download](http://xs-macbook-air.local:5001/zsxq/pdf/584281555254814/Morgan%20Stanley-Internet%EF%BC%9AWhere%20Are%20We%20Trading%20Now%EF%BC%9A%20Entering%202Q%20Earnings-260721.pdf) |
| **1/10** | **Bernstein** — *Digital ads 2Q26: AI identity crisis (PDF corrupt at source)* | n/a · 26-07-22 | no PT — Not readable from this file — the PDF is truncated at source (no xref, no `%%EOF`; the zsxq server re-download | no PT row | [download](http://xs-macbook-air.local:5001/zsxq/pdf/814518284545142/Bernstein-U.S.%20Internet%EF%BC%9ADigital%20Ads%202Q26%EF%BC%9A%20AI%20Identity%20crisis-260721.pdf) |
| **1/10** | **Morgan Stanley** — *Where are we trading now: AI hardware vs AI software flow* | 15 · 26-06-10 | no PT — Overweight, held since 03/20/2023 | no PT row | [download](http://xs-macbook-air.local:5001/zsxq/pdf/181245828524552/Morgan%20Stanley-Internet%EF%BC%9AWhere%20Are%20We%20Trading%20Now%EF%BC%9A%20As%20AI%20Hardware%20vs%20AI%20Software%20Flow%20Debates%20Continue-260609.pdf) |
| **1/10** | **Morgan Stanley** — *Where are we trading now: into the summer of AI* | 15 · 26-06-05 | no PT — Overweight (since 03/20/2023); no price target disclosed, coverage-list price $597.63 (06/02/26) | no PT row | [download](http://xs-macbook-air.local:5001/zsxq/pdf/415288428281848/Morgan%20Stanley-Internet%EF%BC%9AWhere%20Are%20We%20Trading%20Now%EF%BC%9A%20Into%20the%20Summer%20of%20AI-260603.pdf) |
| **2/10** | **Morgan Stanley** — *Where are we trading now: heading into EPS, focused on AI ROIC* | 15 · 26-07-16 | no PT — Overweight (since 03/20/2023); no price target; coverage price $669.21 (07/10/26) | no PT row | [download](http://xs-macbook-air.local:5001/zsxq/pdf/412414588854248/Morgan%20Stanley-Where%20Are%20We%20Trading%20Now%EF%BC%9A%20Heading%20into%20EPS%EF%BC%8C%20Focused%20on%20AI%20ROIC-260714.pdf) |
...
| **4/10** | **Morgan Stanley** — *Where are we trading now: Micro vs AI vs Macro* | 16 · 26-07-29 | no PT — None — META carries no rating or price target in the body | no PT row | [download](http://xs-macbook-air.local:5001/zsxq/pdf/214512248122521/Morgan%20Stanley-Internet%EF%BC%9AWhere%20Are%20We%20Trading%20Now%EF%BC%9AMicro%20vs%20AI%20vs%20Macro-260728.pdf) |
...
### 1/10 — Morgan Stanley, 26-07-23 · *Where are we trading now: entering 2Q earnings* (15 pp)
...
### 1/10 — Bernstein, 26-07-22 · *Digital ads 2Q26: AI identity crisis (PDF corrupt at source)* (no local PDF)
...
### 1/10 — Morgan Stanley, 26-06-10 · *Where are we trading now: AI hardware vs AI software flow* (15 pp)
...
### 1/10 — Morgan Stanley, 26-06-05 · *Where are we trading now: into the summer of AI* (15 pp)
...
### 2/10 — Morgan Stanley, 26-07-16 · *Where are we trading now: heading into EPS, focused on AI ROIC* (15 pp)
...
### 4/10 — Morgan Stanley, 26-07-29 · *Where are we trading now: Micro vs AI vs Macro* (16 pp)
...
### 6/10 — Morgan Stanley, 26-05-19 · *How much capacity will $2tn of hyperscaler capex bring by '27?* (58 pp)
...
> ⚠️ **Nobody is a bear.** Every one of the 50 persisted calls is Buy / Overweight / Outperform, and the lowest PT on the most recent date ($725) still implies +11.9% from $648.03. That is a one-sided ratings distribution against a stock that fell from ~$800 to ~$540 between January and July.
...
- **2026-07-29** — Morgan Stanley — *Where are we trading now: Micro vs AI vs Macro* (4/10) — *no PT row*
- **2026-07-23** — Morgan Stanley — *Where are we trading now: entering 2Q earnings* (1/10) — *no PT row*
- **2026-07-22** — Bernstein — *Digital ads 2Q26: AI identity crisis (PDF corrupt at source)* (1/10) — *no PT row*
- **2026-07-16** — Morgan Stanley — *Where are we trading now: heading into EPS, focused on AI ROIC* (2/10) — *no PT row*
- **2026-06-10** — Morgan Stanley — *Where are we trading now: AI hardware vs AI software flow* (1/10) — *no PT row*
- **2026-06-05** — Morgan Stanley — *Where are we trading now: into the summer of AI* (1/10) — *no PT row*
...
- **2026-05-19** — Morgan Stanley — *How much capacity will $2tn of hyperscaler capex bring by '27?* (6/10) — *no PT row*
